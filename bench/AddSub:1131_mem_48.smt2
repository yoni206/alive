...
(assert
 ...
 (and (= (bvand |ana_computeKnownZeroBits(%Y)| %Y) (_ bv0 50)) (= u_%LHS (_ bv1 8)) $x1639 (= (bvor C2 |ana_computeKnownZeroBits(%Y)|) (_ bv1125899906842623 50)) (and (distinct mem0 mem0) true))))
(check-sat)
