...
(assert
 ...
 (let ((?x5157 (bvsub (bvsub (_ bv41 41) (ite (and (distinct ((_ extract 40 21) C1) (_ bv0 20)) true) ?x5220 ?x8093)) (_ bv1 41))))
 (let (($x6691 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x5157) ?x5157)) true)))
 ...
 (and (=> $x7990 (= (bvand %Y ?x2196) (_ bv0 41))) (= C2 (bvneg C1)) (and (and (distinct C1 (_ bv0 41)) true) (= (bvand C1 (bvsub C1 (_ bv1 41))) (_ bv0 41))) $x7990 $x6691)))))))))))))))))))))))))
(check-sat)
