...
(assert
 ...
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 50)) true) (= (bvand C2 (bvsub C2 (_ bv1 50))) (_ bv0 50))) (not (= (bvand C2 (bvshl (_ bv1125899906842623 50) ?x1502)) (_ bv0 50))) (and (distinct mem0 mem0) true)))))))))))))))))))))))))
(check-sat)
