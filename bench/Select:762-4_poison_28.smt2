...
(assert
 ...
 (and (and (and (distinct C (_ bv0 33)) true) (= (bvand C (bvsub C (_ bv1 33))) (_ bv0 33))) $x4256 (bvslt (ite (and (distinct ((_ extract 32 17) C) (_ bv0 16)) true) ?x7908 ?x4948) (_ bv11 32)) false))))))))))))))
(check-sat)
