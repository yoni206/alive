...
(assert
 ...
 (let ((?x8429 (bvsub (_ bv19 19) (bvsub (bvsub (_ bv19 19) ?x8066) (_ bv1 19)))))
 (let (($x9423 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x8429) ?x8429)) true)))
 (let (($x9266 (not (= (bvand C2 (bvshl (_ bv524287 19) ?x8429)) (_ bv0 19)))))
 (let (($x9167 (and (and (distinct C2 (_ bv0 19)) true) (= (bvand C2 (bvsub C2 (_ bv1 19))) (_ bv0 19)))))
 (let (($x8940 (= C1 (bvneg C2))))
 (and $x8940 $x9167 $x9266 $x9423)))))))))))))))
(check-sat)
