...
(assert
 ...
 (let ((?x28796 (bvsub (_ bv63 63) (bvsub (bvsub (_ bv63 63) ?x27094) (_ bv1 63)))))
 (let (($x27825 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x28796) ?x28796)) true)))
 (let (($x23861 (not (= (bvand C2 (bvshl (_ bv9223372036854775807 63) ?x28796)) (_ bv0 63)))))
 (let (($x24238 (and (and (distinct C2 (_ bv0 63)) true) (= (bvand C2 (bvsub C2 (_ bv1 63))) (_ bv0 63)))))
 (let (($x28748 (= C1 (bvneg C2))))
 (and $x28748 $x24238 $x23861 $x27825))))))))))))))))))))))))))))
(check-sat)
