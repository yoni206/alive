...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 48)) true) (= (bvand C1 (bvsub C1 (_ bv1 48))) (_ bv0 48))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x3442 ?x16379) (not (bvult ?x11798 (_ bv48 48))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
