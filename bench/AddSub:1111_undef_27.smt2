...
(assert
 ...
 (let (($x455 (bvult ?x4201 (_ bv33 33))))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 33)) true) (= (bvand C2 (bvsub C2 (_ bv1 33))) (_ bv0 33))) (not (= (bvand C2 (bvshl (_ bv8589934591 33) ?x4201)) (_ bv0 33))) (not (and $x455 $x455))))))))))))))))))
(check-sat)
