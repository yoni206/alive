...
(assert
 ...
 (let (($x7205 (bvult ?x3691 (_ bv42 42))))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 42)) true) (= (bvand C2 (bvsub C2 (_ bv1 42))) (_ bv0 42))) (not (= (bvand C2 (bvshl (_ bv4398046511103 42) ?x3691)) (_ bv0 42))) (not (and $x7205 $x7205)))))))))))))))))))))))))))
(check-sat)
