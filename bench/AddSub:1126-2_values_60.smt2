...
(assert
 ...
 (let (($x11686 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x6960) ?x6960)) true)))
 ...
 (and (=> $x8289 (= (bvand %Y ?x8981) (_ bv0 8))) (= C2 (bvneg C1)) (and (and (distinct C2 (_ bv0 8)) true) (= (bvand C2 (bvsub C2 (_ bv1 8))) (_ bv0 8))) $x8289 $x11686))))))))
(check-sat)
