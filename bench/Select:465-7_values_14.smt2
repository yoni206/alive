...
(assert
 ...
 (let ((?x16823 (bvand %X C1)))
 (let (($x9910 (and (distinct (ite (= (ite (= ?x16823 (_ bv0 19)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) (bvor %Y C2) %Y) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x16823 ?x18104)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 19)) true) (= (bvand C1 (bvsub C1 (_ bv1 19))) (_ bv0 19))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x12466 ?x2973) $x9910)))))))))))))))))))))))))))))))
(check-sat)
