...
(assert
 ...
 (let ((?x3370 (bvand %X C1)))
 (let ((?x2952 (bvor %Y C2)))
 (let (($x2663 (and (distinct (ite (= (ite (and (distinct ?x3370 (_ bv0 59)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) ?x2952 %Y) (bvor ((_ extract 10 0) (bvlshr ?x3370 ?x6414)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 59)) true) (= (bvand C1 (bvsub C1 (_ bv1 59))) (_ bv0 59))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x3937 ?x2340) $x2663))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
