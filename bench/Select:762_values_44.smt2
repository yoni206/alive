...
(assert
 ...
 (let ((?x765 (ite (and (distinct ((_ extract 2 2) ?x9439) (_ bv0 1)) true) (_ bv2 11) (ite (and (distinct ((_ extract 1 1) ?x9439) (_ bv0 1)) true) (_ bv1 11) (_ bv0 11)))))
 (let ((?x4368 (ite (and (distinct ((_ extract 5 5) ?x9439) (_ bv0 1)) true) (_ bv5 11) (ite (and (distinct ((_ extract 4 4) ?x9439) (_ bv0 1)) true) (_ bv4 11) (_ bv3 11)))))
 (let ((?x3485 (ite (and (distinct ((_ extract 8 8) ?x9439) (_ bv0 1)) true) (_ bv8 11) (ite (and (distinct ((_ extract 7 7) ?x9439) (_ bv0 1)) true) (_ bv7 11) (_ bv6 11)))))
 (let ((?x8731 (ite (and (distinct ((_ extract 10 9) ?x9439) (_ bv0 2)) true) (ite (and (distinct ((_ extract 10 10) ?x9439) (_ bv0 1)) true) (_ bv10 11) (_ bv9 11)) ?x3485)))
 (let ((?x13545 (ite (and (distinct ((_ extract 10 6) ?x9439) (_ bv0 5)) true) ?x8731 (ite (and (distinct ((_ extract 5 3) ?x9439) (_ bv0 3)) true) ?x4368 ?x765))))
 ...
 (let ((?x17717 (bvadd (bvxor (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x5453) ?x320) ?x9439) C3)))
 (let (($x18722 (and (distinct (ite (= (ite (= (bvand %Op C) (_ bv0 48)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3) ?x17717) true)))
 ...
 (and (and (and (distinct C (_ bv0 48)) true) (= (bvand C (bvsub C (_ bv1 48))) (_ bv0 48))) (and (and (distinct ?x9439 (_ bv0 11)) true) (= (bvand ?x9439 (bvsub ?x9439 (_ bv1 11))) (_ bv0 11))) (bvslt ?x22326 (_ bv11 32)) $x18722))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
