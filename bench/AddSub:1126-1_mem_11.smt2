...
(assert
 ...
 (and (=> $x851 (= (bvand %Y (bvshl (_ bv65535 16) (bvadd ?x1373 (_ bv1 16)))) (_ bv0 16))) (= C2 (bvneg C1)) (and (and (distinct C1 (_ bv0 16)) true) (= (bvand C1 (bvsub C1 (_ bv1 16))) (_ bv0 16))) $x851 (and (distinct mem0 mem0) true)))))))))
(check-sat)
