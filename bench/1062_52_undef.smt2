...
(assert
 ...
 (and $x218779 (or (and (distinct %Op0 (_ bv9007199254740992 54)) true) (and (distinct %Op1 (_ bv18014398509481983 54)) true)) $x154119 $x169689 $x129530 $x127386 (not $x218779))))))))
(check-sat)
