...
(assert
 ...
 (let (($x2587 (bvult ?x4020 (_ bv11 11))))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (not (= (bvand C2 (bvshl (_ bv2047 11) ?x4020)) (_ bv0 11))) (not (and $x2587 $x2587)))))))))))
(check-sat)
