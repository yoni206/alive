...
(assert
 ...
 (and (and (and (distinct C (_ bv0 7)) true) (= (bvand C (bvsub C (_ bv1 7))) (_ bv0 7))) $x12346 (bvslt (ite (and (distinct ((_ extract 6 4) C) (_ bv0 3)) true) ?x20901 ?x11158) (_ bv11 32)) (and (distinct mem0 mem0) true))))))
(check-sat)
