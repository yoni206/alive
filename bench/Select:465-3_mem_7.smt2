...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 7)) true) (= (bvand C1 (bvsub C1 (_ bv1 7))) (_ bv0 7))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x5276 (ite (and (distinct ((_ extract 6 4) C1) (_ bv0 3)) true) ?x3095 ?x4557)) (and (distinct mem0 mem0) true))))))))))
(check-sat)
