...
(assert
 ...
 (let ((?x1604 (bvand %X C1)))
 (let (($x4657 (and (distinct (ite (= (ite (= ?x1604 (_ bv0 51)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) (bvor %Y C2) %Y) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x1604 ?x6262)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 51)) true) (= (bvand C1 (bvsub C1 (_ bv1 51))) (_ bv0 51))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x5516 ?x2197) $x4657)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
