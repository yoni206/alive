...
(assert
 ...
 (let ((?x5001 (bvand %X C1)))
 (let ((?x3362 (bvor %Y C2)))
 (let (($x3724 (and (distinct (ite (= (ite (and (distinct ?x5001 (_ bv0 54)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) ?x3362 %Y) (bvor ((_ extract 10 0) (bvlshr ?x5001 ?x3670)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 54)) true) (= (bvand C1 (bvsub C1 (_ bv1 54))) (_ bv0 54))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x1216 ?x4902) $x3724))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
