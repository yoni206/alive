...
(assert
 ...
 (and (=> $x10777 (= (bvand %Y (bvshl (_ bv4611686018427387903 62) (bvadd ?x2702 (_ bv1 62)))) (_ bv0 62))) (= C2 (bvneg C1)) (and (and (distinct C1 (_ bv0 62)) true) (= (bvand C1 (bvsub C1 (_ bv1 62))) (_ bv0 62))) $x10777 false))))))))))))))))))))))))
(check-sat)
