...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 31)) true) (= (bvand C1 (bvsub C1 (_ bv1 31))) (_ bv0 31))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x24101 (ite (and (distinct ((_ extract 30 16) C1) (_ bv0 15)) true) ?x6186 ?x16971)) false)))))))))))))))))
(check-sat)
