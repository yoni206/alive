...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 43)) true) (= (bvand C1 (bvsub C1 (_ bv1 43))) (_ bv0 43))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x5543 ?x17499) (not (bvult ?x3025 (_ bv43 43))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
