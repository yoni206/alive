...
(assert
 ...
 (let ((?x18668 (bvsub (bvsub (_ bv27 27) (ite (and (distinct ((_ extract 26 14) C1) (_ bv0 13)) true) ?x3234 ?x21650)) (_ bv1 27))))
 ...
 (and $x12768 $x1750 $x18777 $x462 (and (distinct ?x12130 (bvashr (bvshl %Y ?x18668) ?x18668)) true)))))))))))))))))))))
(check-sat)
