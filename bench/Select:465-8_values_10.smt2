...
(assert
 ...
 (let ((?x11996 (bvand %X C1)))
 (let ((?x8850 (bvor %Y C2)))
 (let (($x667 (and (distinct (ite (= (ite (and (distinct ?x11996 (_ bv0 12)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) ?x8850 %Y) (bvor ((_ extract 10 0) (bvlshr ?x11996 ?x9319)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 12)) true) (= (bvand C1 (bvsub C1 (_ bv1 12))) (_ bv0 12))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x20626 ?x1328) $x667))))))))))))))))))))))))))
(check-sat)
