...
(assert
 ...
 (let ((?x534 (bvand %X C1)))
 (let (($x17372 (and (distinct (ite (= (ite (= ?x534 (_ bv0 21)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y (bvor %Y C2)) (bvor ((_ extract 10 0) (bvlshr ?x534 ?x19348)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 21)) true) (= (bvand C1 (bvsub C1 (_ bv1 21))) (_ bv0 21))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x11476 ?x10199) $x17372)))))))))))))))))))))))))))))))))))
(check-sat)
