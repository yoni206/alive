...
(assert
 ...
 (let ((?x18579 (bvsub (bvsub (_ bv42 42) (ite (and (distinct ((_ extract 41 21) C2) (_ bv0 21)) true) ?x17692 ?x18630)) (_ bv1 42))))
 (let ((?x16523 (bvsub (_ bv42 42) ?x18579)))
 (let (($x18234 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x16523) ?x16523)) true)))
 (let (($x10621 (not (= (bvand C2 (bvshl (_ bv4398046511103 42) ?x16523)) (_ bv0 42)))))
 (let (($x12103 (and (and (distinct C2 (_ bv0 42)) true) (= (bvand C2 (bvsub C2 (_ bv1 42))) (_ bv0 42)))))
 (let (($x18024 (= C1 (bvneg C2))))
 (and $x18024 $x12103 $x10621 $x18234))))))))))))))))))))))))))))
(check-sat)
