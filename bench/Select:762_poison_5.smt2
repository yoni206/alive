...
(assert
 ...
 (and (and (and (distinct C (_ bv0 9)) true) (= (bvand C (bvsub C (_ bv1 9))) (_ bv0 9))) $x6072 (bvslt (ite (and (distinct ((_ extract 8 5) C) (_ bv0 4)) true) ?x8001 ?x4581) (_ bv11 32)) false))))))
(check-sat)
