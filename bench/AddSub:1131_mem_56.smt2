...
(assert
 ...
 (and (= (bvand |ana_computeKnownZeroBits(%Y)| %Y) (_ bv0 58)) (= u_%LHS (_ bv1 8)) $x943 (= (bvor C2 |ana_computeKnownZeroBits(%Y)|) (_ bv288230376151711743 58)) (and (distinct mem0 mem0) true))))
(check-sat)
