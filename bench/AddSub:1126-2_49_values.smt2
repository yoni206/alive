...
(assert
 ...
 (let ((?x18309 (bvsub (bvsub (_ bv54 54) ?x23313) (_ bv1 54))))
 ...
 (let (($x35456 (=> $x4990 (= (bvand %Y (bvshl (_ bv18014398509481983 54) (bvadd ?x23313 (_ bv1 54)))) (_ bv0 54)))))
 (and $x35456 $x30268 $x23341 $x4990 (and (distinct ?x18604 (bvashr (bvshl %Y ?x18309) ?x18309)) true)))))))))))))))))))))))))))))))
(check-sat)
