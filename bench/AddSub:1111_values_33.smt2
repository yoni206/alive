...
(assert
 ...
 (let (($x7026 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x3725) ?x3725)) true)))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 39)) true) (= (bvand C2 (bvsub C2 (_ bv1 39))) (_ bv0 39))) (not (= (bvand C2 (bvshl (_ bv549755813887 39) ?x3725)) (_ bv0 39))) $x7026))))))))))))))))))))))
(check-sat)
