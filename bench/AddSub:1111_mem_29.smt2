...
(assert
 ...
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 35)) true) (= (bvand C2 (bvsub C2 (_ bv1 35))) (_ bv0 35))) (not (= (bvand C2 (bvshl (_ bv34359738367 35) ?x5159)) (_ bv0 35))) (and (distinct mem0 mem0) true))))))))))))))))))
(check-sat)
