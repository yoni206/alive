...
(assert
 ...
 (let ((?x5829 (bvand %X C1)))
 (let ((?x6071 (bvor %Y C2)))
 (let (($x4449 (and (distinct (ite (= (ite (and (distinct ?x5829 (_ bv0 40)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) ?x6071 %Y) (bvor ((_ extract 10 0) (bvlshr ?x5829 ?x2267)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 40)) true) (= (bvand C1 (bvsub C1 (_ bv1 40))) (_ bv0 40))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x3158 (ite (and (distinct ((_ extract 39 20) C1) (_ bv0 20)) true) ?x4747 ?x2412)) $x4449))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
