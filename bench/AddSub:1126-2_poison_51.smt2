...
(assert
 ...
 (and (=> $x3052 (= (bvand %Y (bvshl (_ bv72057594037927935 56) (bvadd ?x10111 (_ bv1 56)))) (_ bv0 56))) (= C2 (bvneg C1)) (and (and (distinct C2 (_ bv0 56)) true) (= (bvand C2 (bvsub C2 (_ bv1 56))) (_ bv0 56))) $x3052 false))))))))))))))))))))))))
(check-sat)
