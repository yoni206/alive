...
(assert
 ...
 (let ((?x13205 (bvsub (_ bv48 48) (bvsub (bvsub (_ bv48 48) ?x20857) (_ bv1 48)))))
 (let (($x20445 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x13205) ?x13205)) true)))
 (let (($x14938 (not (= (bvand C2 (bvshl (_ bv281474976710655 48) ?x13205)) (_ bv0 48)))))
 (let (($x20774 (and (and (distinct C2 (_ bv0 48)) true) (= (bvand C2 (bvsub C2 (_ bv1 48))) (_ bv0 48)))))
 (let (($x17275 (= C1 (bvneg C2))))
 (and $x17275 $x20774 $x14938 $x20445))))))))))))))))))))))))))))
(check-sat)
