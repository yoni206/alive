...
(assert
 ...
 (let ((?x11861 (bvsub (bvsub (_ bv28 28) (ite (and (distinct ((_ extract 27 14) C2) (_ bv0 14)) true) ?x10414 ?x12781)) (_ bv1 28))))
 (let ((?x11731 (bvsub (_ bv28 28) ?x11861)))
 (let (($x12776 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x11731) ?x11731)) true)))
 (let (($x10807 (not (= (bvand C2 (bvshl (_ bv268435455 28) ?x11731)) (_ bv0 28)))))
 (let (($x10537 (and (and (distinct C2 (_ bv0 28)) true) (= (bvand C2 (bvsub C2 (_ bv1 28))) (_ bv0 28)))))
 (let (($x12887 (= C1 (bvneg C2))))
 (and $x12887 $x10537 $x10807 $x12776))))))))))))))))))
(check-sat)
