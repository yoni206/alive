...
(assert
 ...
 (let ((?x13959 (bvsub (_ bv51 51) (bvsub (bvsub (_ bv51 51) ?x22085) (_ bv1 51)))))
 (let (($x21533 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x13959) ?x13959)) true)))
 (let (($x21569 (not (= (bvand C2 (bvshl (_ bv2251799813685247 51) ?x13959)) (_ bv0 51)))))
 (let (($x21404 (and (and (distinct C2 (_ bv0 51)) true) (= (bvand C2 (bvsub C2 (_ bv1 51))) (_ bv0 51)))))
 (let (($x22236 (= C1 (bvneg C2))))
 (and $x22236 $x21404 $x21569 $x21533))))))))))))))))))))))))))))
(check-sat)
