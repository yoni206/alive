...
(assert
 ...
 (let ((?x4542 (bvand %X C1)))
 (let ((?x3032 (bvor %Y C2)))
 (let (($x3061 (and (distinct (ite (= (ite (and (distinct ?x4542 (_ bv0 15)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y ?x3032) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x4542 ?x1774)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 15)) true) (= (bvand C1 (bvsub C1 (_ bv1 15))) (_ bv0 15))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x5210 ?x1317) $x3061))))))))))))))))))))))))))
(check-sat)
