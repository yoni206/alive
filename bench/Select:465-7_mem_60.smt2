...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 8)) true) (= (bvand C1 (bvsub C1 (_ bv1 8))) (_ bv0 8))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x13990 (ite (and (distinct ((_ extract 7 4) C1) (_ bv0 4)) true) ?x8560 ?x1313)) (and (distinct mem0 mem0) true))))))))))
(check-sat)
