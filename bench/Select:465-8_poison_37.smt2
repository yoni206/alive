...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 39)) true) (= (bvand C1 (bvsub C1 (_ bv1 39))) (_ bv0 39))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x12705 (ite (and (distinct ((_ extract 38 20) C1) (_ bv0 19)) true) ?x16544 ?x10022)) false))))))))))))))))))))))))
(check-sat)
