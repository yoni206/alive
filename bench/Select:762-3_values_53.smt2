...
(assert
 ...
 (let (($x15754 (and (distinct (ite (= (ite (= (bvand %Op C) (_ bv0 57)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3) (bvadd (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x12053) ?x23425) C2)) true)))
 ...
 (and (and (and (distinct C (_ bv0 57)) true) (= (bvand C (bvsub C (_ bv1 57))) (_ bv0 57))) $x6720 (bvslt ?x19882 (_ bv11 32)) $x15754)))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
