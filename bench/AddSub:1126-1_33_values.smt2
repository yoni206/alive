...
(assert
 ...
 (let ((?x3616 (bvsub (bvsub (_ bv38 38) (ite (and (distinct ((_ extract 37 19) C1) (_ bv0 19)) true) ?x13696 ?x27356)) (_ bv1 38))))
 ...
 (and $x18480 $x14301 $x19956 $x462 (and (distinct ?x16815 (bvashr (bvshl %Y ?x3616) ?x3616)) true)))))))))))))))))))))))))))
(check-sat)
