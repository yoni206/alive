...
(assert
 ...
 (let (($x168007 (=> $x153692 (= (bvand %Op1 (bvshl (_ bv1 46) (bvsub (_ bv46 46) (_ bv1 46)))) (_ bv0 46)))))
 ...
 (and $x189546 $x147878 $x168007 $x141329 $x153692 $x129530 (and (distinct (bvsrem %Op0 %Op1) (bvurem %Op0 %Op1)) true)))))))))
(check-sat)
