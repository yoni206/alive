...
(assert
 ...
 (let ((?x9467 (bvsub (bvsub (_ bv63 63) ?x5337) (_ bv1 63))))
 (let (($x8637 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x9467) ?x9467)) true)))
 (let (($x3027 (= |ana_MaskedValueIsZero(%Y, (-1 << (log2(C2) + 1)))| (_ bv1 1))))
 (and (=> $x3027 (= (bvand %Y (bvshl (_ bv9223372036854775807 63) (bvadd ?x5337 (_ bv1 63)))) (_ bv0 63))) (= C2 (bvneg C1)) (and (and (distinct C2 (_ bv0 63)) true) (= (bvand C2 (bvsub C2 (_ bv1 63))) (_ bv0 63))) $x3027 $x8637))))))))))))))))))))))))))
(check-sat)
