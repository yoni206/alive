...
(assert
 ...
 (and (and (and (distinct C (_ bv0 38)) true) (= (bvand C (bvsub C (_ bv1 38))) (_ bv0 38))) $x7492 (bvslt (ite (and (distinct ((_ extract 37 19) C) (_ bv0 19)) true) ?x2935 ?x6441) (_ bv11 32)) (not (and (bvult ?x6261 (_ bv11 11)) (bvult ?x5650 (_ bv11 11))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
