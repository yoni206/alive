...
(assert
 ...
 (let ((?x2953 (bvand %X C1)))
 (let (($x2843 (and (distinct (ite (= (ite (= ?x2953 (_ bv0 21)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) (bvor %Y C2) %Y) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x2953 ?x5946)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 21)) true) (= (bvand C1 (bvsub C1 (_ bv1 21))) (_ bv0 21))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x4125 ?x3037) $x2843)))))))))))))))))))))))))))))))))))
(check-sat)
