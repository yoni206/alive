...
(assert
 ...
 (and (and (and (distinct C (_ bv0 35)) true) (= (bvand C (bvsub C (_ bv1 35))) (_ bv0 35))) $x9444 (bvslt (ite (and (distinct ((_ extract 34 18) C) (_ bv0 17)) true) ?x534 ?x13098) (_ bv11 32)) false))))))))))))))))
(check-sat)
