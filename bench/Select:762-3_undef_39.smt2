...
(assert
 ...
 (and (and (and (distinct C (_ bv0 43)) true) (= (bvand C (bvsub C (_ bv1 43))) (_ bv0 43))) $x2851 (bvslt ?x7849 (_ bv11 32)) (not (and (bvult ?x4825 (_ bv11 11)) (bvult ?x7208 (_ bv11 11))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
