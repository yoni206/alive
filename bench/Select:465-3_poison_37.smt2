...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 38)) true) (= (bvand C1 (bvsub C1 (_ bv1 38))) (_ bv0 38))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x4439 (ite (and (distinct ((_ extract 37 19) C1) (_ bv0 19)) true) ?x3545 ?x5334)) false)))))))))))))))))))))))
(check-sat)
