...
(assert
 ...
 (let (($x9867 (bvult ?x2776 (_ bv57 57))))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 57)) true) (= (bvand C2 (bvsub C2 (_ bv1 57))) (_ bv0 57))) (not (= (bvand C2 (bvshl (_ bv144115188075855871 57) ?x2776)) (_ bv0 57))) (not (and $x9867 $x9867)))))))))))))))))))))))))))
(check-sat)
