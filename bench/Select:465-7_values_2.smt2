...
(assert
 ...
 (let ((?x1486 (bvand %X C1)))
 (let (($x6310 (and (distinct (ite (= (ite (= ?x1486 (_ bv0 10)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) (bvor %Y C2) %Y) (bvor (bvxor ((_ zero_extend 1) (bvlshr ?x1486 ?x2560)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 10)) true) (= (bvand C1 (bvsub C1 (_ bv1 10))) (_ bv0 10))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x4972 (ite (and (distinct ((_ extract 9 5) C1) (_ bv0 5)) true) ?x2649 ?x1203)) $x6310)))))))))))))))))))))))
(check-sat)
