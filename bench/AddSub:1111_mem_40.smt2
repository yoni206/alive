...
(assert
 ...
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 46)) true) (= (bvand C2 (bvsub C2 (_ bv1 46))) (_ bv0 46))) (not (= (bvand C2 (bvshl (_ bv70368744177663 46) ?x442)) (_ bv0 46))) (and (distinct mem0 mem0) true)))))))))))))))))))))))))
(check-sat)
