...
(assert
 ...
 (let ((?x23606 (bvand %X C1)))
 (let ((?x8911 (bvor %Y C2)))
 (let (($x1948 (and (distinct (ite (= (ite (and (distinct ?x23606 (_ bv0 8)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y ?x8911) (bvor (bvxor ((_ zero_extend 3) (bvlshr ?x23606 ?x724)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 8)) true) (= (bvand C1 (bvsub C1 (_ bv1 8))) (_ bv0 8))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x7566 (ite (and (distinct ((_ extract 7 4) C1) (_ bv0 4)) true) ?x12022 ?x3762)) $x1948))))))))))))))))))))
(check-sat)
