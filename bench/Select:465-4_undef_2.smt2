...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 6)) true) (= (bvand C1 (bvsub C1 (_ bv1 6))) (_ bv0 6))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x5208 (ite (and (distinct ((_ extract 5 3) C1) (_ bv0 3)) true) ?x19802 ?x23473)) (not (bvult ?x20831 (_ bv6 6))))))))))))))))))))
(check-sat)
