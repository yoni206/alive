...
(assert
 ...
 (let ((?x25083 (bvsub (bvsub (_ bv57 57) ?x23980) (_ bv1 57))))
 (let (($x26174 (bvult ?x25083 (_ bv57 57))))
 ...
 (let (($x30870 (=> $x4990 (= (bvand %Y (bvshl (_ bv144115188075855871 57) (bvadd ?x23980 (_ bv1 57)))) (_ bv0 57)))))
 (and $x30870 $x30921 $x20118 $x4990 (not (and $x26174 $x26174)))))))))))))))))))))))))))))))
(check-sat)
