...
(assert
 ...
 (and (and (and (distinct C (_ bv0 32)) true) (= (bvand C (bvsub C (_ bv1 32))) (_ bv0 32))) $x20220 (bvslt (ite (and (distinct ((_ extract 31 16) C) (_ bv0 16)) true) ?x15855 ?x9271) (_ bv11 32)) false)))))))))))))
(check-sat)
