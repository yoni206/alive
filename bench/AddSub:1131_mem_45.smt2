...
(assert
 ...
 (and (= (bvand |ana_computeKnownZeroBits(%Y)| %Y) (_ bv0 47)) (= u_%LHS (_ bv1 8)) $x11533 (= (bvor C2 |ana_computeKnownZeroBits(%Y)|) (_ bv140737488355327 47)) (and (distinct mem0 mem0) true))))
(check-sat)
