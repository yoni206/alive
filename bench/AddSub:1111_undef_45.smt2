...
(assert
 ...
 (let (($x8875 (bvult ?x1502 (_ bv51 51))))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 51)) true) (= (bvand C2 (bvsub C2 (_ bv1 51))) (_ bv0 51))) (not (= (bvand C2 (bvshl (_ bv2251799813685247 51) ?x1502)) (_ bv0 51))) (not (and $x8875 $x8875)))))))))))))))))))))))))))
(check-sat)
