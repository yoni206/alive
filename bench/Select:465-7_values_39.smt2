...
(assert
 ...
 (let ((?x10076 (bvand %X C1)))
 (let (($x16255 (and (distinct (ite (= (ite (= ?x10076 (_ bv0 44)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) (bvor %Y C2) %Y) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x10076 ?x16538)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 44)) true) (= (bvand C1 (bvsub C1 (_ bv1 44))) (_ bv0 44))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x9911 ?x1025) $x16255)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
