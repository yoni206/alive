...
(assert
 ...
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 61)) true) (= (bvand C2 (bvsub C2 (_ bv1 61))) (_ bv0 61))) (not (= (bvand C2 (bvshl (_ bv2305843009213693951 61) ?x4722)) (_ bv0 61))) false))))))))))))))))))))))))
(check-sat)
