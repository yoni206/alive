...
(assert
 ...
 (and (and (and (distinct C (_ bv0 8)) true) (= (bvand C (bvsub C (_ bv1 8))) (_ bv0 8))) $x1126 (bvslt (ite (and (distinct ((_ extract 7 4) C) (_ bv0 4)) true) ?x6586 ?x1471) (_ bv11 32)) (and (distinct mem0 mem0) true))))))
(check-sat)
