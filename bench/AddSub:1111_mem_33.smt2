...
(assert
 ...
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 39)) true) (= (bvand C2 (bvsub C2 (_ bv1 39))) (_ bv0 39))) (not (= (bvand C2 (bvshl (_ bv549755813887 39) ?x3725)) (_ bv0 39))) (and (distinct mem0 mem0) true))))))))))))))))))))))
(check-sat)
