...
(assert
 ...
 (and (and (and (distinct C (_ bv0 37)) true) (= (bvand C (bvsub C (_ bv1 37))) (_ bv0 37))) $x4193 (bvslt (ite (and (distinct ((_ extract 36 19) C) (_ bv0 18)) true) ?x7828 ?x6394) (_ bv11 32)) false))))))))))))))))))
(check-sat)
