...
(assert
 ...
 (let ((?x13902 (bvand %X C1)))
 (let ((?x15322 (bvor %Y C2)))
 (let (($x1948 (and (distinct (ite (= (ite (and (distinct ?x13902 (_ bv0 62)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y ?x15322) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x13902 ?x4053)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 62)) true) (= (bvand C1 (bvsub C1 (_ bv1 62))) (_ bv0 62))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x6158 ?x14946) $x1948))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
