...
(assert
 ...
 (let ((?x5514 (bvand %X C1)))
 (let (($x2214 (and (distinct (ite (= (ite (= ?x5514 (_ bv0 51)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y (bvor %Y C2)) (bvor ((_ extract 10 0) (bvlshr ?x5514 ?x5466)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 51)) true) (= (bvand C1 (bvsub C1 (_ bv1 51))) (_ bv0 51))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x1141 ?x1861) $x2214)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
