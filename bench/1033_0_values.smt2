...
(assert
 ...
 (let ((?x119874 (bvashr %Op0 ?x156666)))
 (let ((?x164038 (bvsdiv %Op0 C)))
 ...
 (let (($x132074 (= (bvmul ?x164038 C) %Op0)))
 (let (($x147109 (or (and (distinct %Op0 (_ bv4294967296 33)) true) (and (distinct C (_ bv8589934591 33)) true))))
 (and $x118643 $x147109 $x132074 $x114898 $x136115 (and (distinct ?x164038 ?x119874) true))))))))))))))))))))))
(check-sat)
