...
(assert
 ...
 (let ((?x20386 (bvand %X C1)))
 (let ((?x11703 (bvor %Y C2)))
 (let (($x11071 (and (distinct (ite (= (ite (and (distinct ?x20386 (_ bv0 24)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) ?x11703 %Y) (bvor ((_ extract 10 0) (bvlshr ?x20386 ?x13426)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 24)) true) (= (bvand C1 (bvsub C1 (_ bv1 24))) (_ bv0 24))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x14461 (ite (and (distinct ((_ extract 23 12) C1) (_ bv0 12)) true) ?x5297 ?x12719)) $x11071))))))))))))))))))))))))))))))))))))
(check-sat)
