...
(assert
 ...
 (let ((?x12340 (bvsub (_ bv27 27) ?x11802)))
 (let (($x12439 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x12340) ?x12340)) true)))
 (let (($x11964 (not (= (bvand C2 (bvshl (_ bv134217727 27) ?x12340)) (_ bv0 27)))))
 (let (($x12475 (and (and (distinct C2 (_ bv0 27)) true) (= (bvand C2 (bvsub C2 (_ bv1 27))) (_ bv0 27)))))
 (let (($x9092 (= C1 (bvneg C2))))
 (and $x9092 $x12475 $x11964 $x12439))))))))))))))))))
(check-sat)
