...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 22)) true) (= (bvand C1 (bvsub C1 (_ bv1 22))) (_ bv0 22))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x9017 (ite (and (distinct ((_ extract 21 11) C1) (_ bv0 11)) true) ?x5747 ?x13928)) (not (bvult ?x7042 (_ bv22 22))))))))))))))))))))))))))))))))))))
(check-sat)
