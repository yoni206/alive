...
(assert
 ...
 (let ((?x5245 (bvsub (_ bv16 16) (bvsub (bvsub (_ bv16 16) ?x3979) (_ bv1 16)))))
 (let (($x3575 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x5245) ?x5245)) true)))
 (let (($x7222 (not (= (bvand C2 (bvshl (_ bv65535 16) ?x5245)) (_ bv0 16)))))
 (let (($x6560 (and (and (distinct C2 (_ bv0 16)) true) (= (bvand C2 (bvsub C2 (_ bv1 16))) (_ bv0 16)))))
 (let (($x6300 (= C1 (bvneg C2))))
 (and $x6300 $x6560 $x7222 $x3575))))))))))))
(check-sat)
