...
(assert
 ...
 (let ((?x11024 (bvand %X C1)))
 (let ((?x11007 (bvor %Y C2)))
 (let (($x6752 (and (distinct (ite (= (ite (and (distinct ?x11024 (_ bv0 50)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y ?x11007) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x11024 ?x5279)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 50)) true) (= (bvand C1 (bvsub C1 (_ bv1 50))) (_ bv0 50))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x18337 ?x3149) $x6752))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
