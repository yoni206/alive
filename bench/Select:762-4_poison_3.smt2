...
(assert
 ...
 (and (and (and (distinct C (_ bv0 7)) true) (= (bvand C (bvsub C (_ bv1 7))) (_ bv0 7))) $x6521 (bvslt (ite (and (distinct ((_ extract 6 4) C) (_ bv0 3)) true) ?x8369 ?x5241) (_ bv11 32)) false)))))
(check-sat)
