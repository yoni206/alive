...
(assert
 ...
 (let ((?x15784 (bvand %X C1)))
 (let ((?x9755 (bvor %Y C2)))
 (let (($x11069 (and (distinct (ite (= (ite (and (distinct ?x15784 (_ bv0 10)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) ?x9755 %Y) (bvor ((_ zero_extend 1) (bvlshr ?x15784 ?x5747)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 10)) true) (= (bvand C1 (bvsub C1 (_ bv1 10))) (_ bv0 10))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x14416 (ite (and (distinct ((_ extract 9 5) C1) (_ bv0 5)) true) ?x23442 ?x21829)) $x11069))))))))))))))))))))))))
(check-sat)
