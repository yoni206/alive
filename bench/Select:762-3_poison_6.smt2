...
(assert
 ...
 (and (and (and (distinct C (_ bv0 10)) true) (= (bvand C (bvsub C (_ bv1 10))) (_ bv0 10))) $x13285 (bvslt (ite (and (distinct ((_ extract 9 5) C) (_ bv0 5)) true) ?x9378 ?x9730) (_ bv11 32)) false)))))))
(check-sat)
