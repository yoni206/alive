...
(assert
 ...
 (let ((?x25143 (bvand %X C1)))
 (let ((?x11038 (bvor %Y C2)))
 (let (($x19802 (and (distinct (ite (= (ite (and (distinct ?x25143 (_ bv0 35)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y ?x11038) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x25143 ?x24264)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 35)) true) (= (bvand C1 (bvsub C1 (_ bv1 35))) (_ bv0 35))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x6226 (ite (and (distinct ((_ extract 34 18) C1) (_ bv0 17)) true) ?x10525 ?x10603)) $x19802))))))))))))))))))))))))))))))))))))))))))
(check-sat)
