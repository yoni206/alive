...
(assert
 ...
 (and (and (and (distinct C (_ bv0 39)) true) (= (bvand C (bvsub C (_ bv1 39))) (_ bv0 39))) $x3053 (bvslt (ite (and (distinct ((_ extract 38 20) C) (_ bv0 19)) true) ?x2579 ?x5925) (_ bv11 32)) false))))))))))))))))))))
(check-sat)
