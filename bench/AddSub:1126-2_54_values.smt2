...
(assert
 ...
 (let ((?x18310 (bvsub (bvsub (_ bv59 59) ?x24260) (_ bv1 59))))
 ...
 (let (($x31492 (=> $x4990 (= (bvand %Y (bvshl (_ bv576460752303423487 59) (bvadd ?x24260 (_ bv1 59)))) (_ bv0 59)))))
 (and $x31492 $x32183 $x19937 $x4990 (and (distinct ?x20838 (bvashr (bvshl %Y ?x18310) ?x18310)) true)))))))))))))))))))))))))))))))
(check-sat)
