...
(assert
 ...
 (let (($x16017 (and (distinct (ite (= (ite (= (bvand %Op C) (_ bv0 60)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3) (bvadd (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x4881) ?x16530) C2)) true)))
 ...
 (and (and (and (distinct C (_ bv0 60)) true) (= (bvand C (bvsub C (_ bv1 60))) (_ bv0 60))) $x11958 (bvslt ?x10991 (_ bv11 32)) $x16017)))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
