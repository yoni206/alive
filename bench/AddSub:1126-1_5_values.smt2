...
(assert
 ...
 (let ((?x20974 (bvsub (bvsub (_ bv10 10) (ite (and (distinct ((_ extract 9 5) C1) (_ bv0 5)) true) ?x11252 ?x18206)) (_ bv1 10))))
 ...
 (and $x12028 $x22697 $x21851 $x462 (and (distinct ?x1338 (bvashr (bvshl %Y ?x20974) ?x20974)) true)))))))))))))))
(check-sat)
