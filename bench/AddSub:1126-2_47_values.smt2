...
(assert
 ...
 (let ((?x19807 (bvsub (bvsub (_ bv52 52) ?x13953) (_ bv1 52))))
 ...
 (let (($x22108 (=> $x4990 (= (bvand %Y (bvshl (_ bv4503599627370495 52) (bvadd ?x13953 (_ bv1 52)))) (_ bv0 52)))))
 (and $x22108 $x22100 $x14267 $x4990 (and (distinct ?x21888 (bvashr (bvshl %Y ?x19807) ?x19807)) true)))))))))))))))))))))))))))))))
(check-sat)
