...
(assert
 ...
 (let (($x5079 (bvult ?x3924 (_ bv16 16))))
 (let (($x851 (= |ana_MaskedValueIsZero(%Y, (-1 << (log2(C1) + 1)))| (_ bv1 1))))
 (and (=> $x851 (= (bvand %Y (bvshl (_ bv65535 16) (bvadd ?x1373 (_ bv1 16)))) (_ bv0 16))) (= C2 (bvneg C1)) (and (and (distinct C1 (_ bv0 16)) true) (= (bvand C1 (bvsub C1 (_ bv1 16))) (_ bv0 16))) $x851 (not (and $x5079 $x5079))))))))))))
(check-sat)
