...
(assert
 ...
 (and (and (and (distinct C (_ bv0 62)) true) (= (bvand C (bvsub C (_ bv1 62))) (_ bv0 62))) $x1207 (bvslt ?x1856 (_ bv11 32)) (not (and (bvult ?x3211 (_ bv11 11)) (bvult ?x4519 (_ bv11 11))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
