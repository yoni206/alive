...
(assert
 ...
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 41)) true) (= (bvand C2 (bvsub C2 (_ bv1 41))) (_ bv0 41))) (not (= (bvand C2 (bvshl (_ bv2199023255551 41) ?x1734)) (_ bv0 41))) (and (distinct mem0 mem0) true))))))))))))))))))))))))
(check-sat)
