...
(assert
 ...
 (let (($x4666 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x3394) ?x3394)) true)))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 14)) true) (= (bvand C2 (bvsub C2 (_ bv1 14))) (_ bv0 14))) (not (= (bvand C2 (bvshl (_ bv16383 14) ?x3394)) (_ bv0 14))) $x4666)))))))))
(check-sat)
