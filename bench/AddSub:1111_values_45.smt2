...
(assert
 ...
 (let (($x8654 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x1502) ?x1502)) true)))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 51)) true) (= (bvand C2 (bvsub C2 (_ bv1 51))) (_ bv0 51))) (not (= (bvand C2 (bvshl (_ bv2251799813685247 51) ?x1502)) (_ bv0 51))) $x8654)))))))))))))))))))))))))
(check-sat)
