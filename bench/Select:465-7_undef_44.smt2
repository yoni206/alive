...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 49)) true) (= (bvand C1 (bvsub C1 (_ bv1 49))) (_ bv0 49))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x2148 ?x1063) (not (bvult ?x15742 (_ bv49 49))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
