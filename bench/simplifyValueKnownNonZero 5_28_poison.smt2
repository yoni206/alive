...
(assert
 (let (($x128513 (not (= (bvshl (bvlshr %A %B) %B) %A))))
 ...
 (let (($x140527 (or $x341 (and (distinct (bvlshr %A %B) (_ bv8589934591 33)) true))))
 (let ((?x128143 (bvlshr %A %B)))
 (let (($x121492 (and (distinct ?x128143 (_ bv0 33)) true)))
 (and $x131 $x121492 $x140527 $x121462 $x131 $x107336 $x118 $x128513)))))))))))
(check-sat)
