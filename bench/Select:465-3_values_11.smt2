...
(assert
 ...
 (let ((?x19547 (bvand %X C1)))
 (let (($x11059 (and (distinct (ite (= (ite (= ?x19547 (_ bv0 13)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y (bvor %Y C2)) (bvor ((_ extract 10 0) (bvlshr ?x19547 ?x8440)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 13)) true) (= (bvand C1 (bvsub C1 (_ bv1 13))) (_ bv0 13))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x893 ?x993) $x11059)))))))))))))))))))))))))
(check-sat)
