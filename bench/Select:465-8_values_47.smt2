...
(assert
 ...
 (let ((?x21998 (bvand %X C1)))
 (let ((?x766 (bvor %Y C2)))
 (let (($x17731 (and (distinct (ite (= (ite (and (distinct ?x21998 (_ bv0 49)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) ?x766 %Y) (bvor ((_ extract 10 0) (bvlshr ?x21998 ?x3962)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 49)) true) (= (bvand C1 (bvsub C1 (_ bv1 49))) (_ bv0 49))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x680 ?x216) $x17731))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
