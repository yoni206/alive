...
(assert
 ...
 (and (and (and (distinct C (_ bv0 38)) true) (= (bvand C (bvsub C (_ bv1 38))) (_ bv0 38))) $x3060 (bvslt (ite (and (distinct ((_ extract 37 19) C) (_ bv0 19)) true) ?x711 ?x15773) (_ bv11 32)) (and (distinct mem0 mem0) true))))))))))))))))))))
(check-sat)
