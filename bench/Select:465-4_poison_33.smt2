...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 41)) true) (= (bvand C1 (bvsub C1 (_ bv1 41))) (_ bv0 41))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x6120 (ite (and (distinct ((_ extract 40 21) C1) (_ bv0 20)) true) ?x3535 ?x4537)) false))))))))))))))))))))))))))
(check-sat)
