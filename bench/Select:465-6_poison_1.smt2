...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 9)) true) (= (bvand C1 (bvsub C1 (_ bv1 9))) (_ bv0 9))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvsge ?x6443 (ite (and (distinct ((_ extract 8 5) C1) (_ bv0 4)) true) ?x1205 ?x1445)) false))))))))))
(check-sat)
