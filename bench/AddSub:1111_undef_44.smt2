...
(assert
 ...
 (let (($x8530 (bvult ?x1502 (_ bv50 50))))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 50)) true) (= (bvand C2 (bvsub C2 (_ bv1 50))) (_ bv0 50))) (not (= (bvand C2 (bvshl (_ bv1125899906842623 50) ?x1502)) (_ bv0 50))) (not (and $x8530 $x8530)))))))))))))))))))))))))))
(check-sat)
