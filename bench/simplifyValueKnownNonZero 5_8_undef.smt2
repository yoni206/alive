...
(assert
 (let (($x139350 (or (and (distinct %X (_ bv4096 13)) true) (and (distinct (bvlshr %A %B) (_ bv8191 13)) true))))
 ...
 (and $x120812 $x127581 $x139350 $x120895 $x120812 $x107336 $x118 (not (and $x120812 $x127581 $x139350)))))))))))
(check-sat)
