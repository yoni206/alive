...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 29)) true) (= (bvand C1 (bvsub C1 (_ bv1 29))) (_ bv0 29))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x2217 (ite (and (distinct ((_ extract 28 15) C1) (_ bv0 14)) true) ?x1917 ?x4177)) (and (distinct mem0 mem0) true))))))))))))))))))
(check-sat)
