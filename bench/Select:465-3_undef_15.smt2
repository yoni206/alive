...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 17)) true) (= (bvand C1 (bvsub C1 (_ bv1 17))) (_ bv0 17))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x8850 ?x2832) (not (bvult ?x14917 (_ bv17 17))))))))))))))))))))))))))))
(check-sat)
