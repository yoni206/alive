...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 30)) true) (= (bvand C1 (bvsub C1 (_ bv1 30))) (_ bv0 30))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x21033 (ite (and (distinct ((_ extract 29 15) C1) (_ bv0 15)) true) ?x12719 ?x15724)) false)))))))))))))))))
(check-sat)
