...
(assert
 ...
 (let ((?x29456 (bvsub (bvsub (_ bv40 40) (ite (and (distinct ((_ extract 39 20) C1) (_ bv0 20)) true) ?x14731 ?x7305)) (_ bv1 40))))
 ...
 (and $x9351 $x7846 $x8358 $x462 (and (distinct ?x17972 (bvashr (bvshl %Y ?x29456) ?x29456)) true)))))))))))))))))))))))))))))
(check-sat)
