...
(assert
 ...
 (and (and (and (distinct C (_ bv0 60)) true) (= (bvand C (bvsub C (_ bv1 60))) (_ bv0 60))) $x5691 (bvslt ?x1308 (_ bv11 32)) (not (and (bvult ?x4345 (_ bv11 11)) (bvult ?x5532 (_ bv11 11))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
