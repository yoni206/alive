...
(assert
 ...
 (let ((?x23086 (bvsub (_ bv62 62) (bvsub (bvsub (_ bv62 62) ?x23118) (_ bv1 62)))))
 (let (($x27563 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x23086) ?x23086)) true)))
 (let (($x25758 (not (= (bvand C2 (bvshl (_ bv4611686018427387903 62) ?x23086)) (_ bv0 62)))))
 (let (($x27762 (and (and (distinct C2 (_ bv0 62)) true) (= (bvand C2 (bvsub C2 (_ bv1 62))) (_ bv0 62)))))
 (let (($x26800 (= C1 (bvneg C2))))
 (and $x26800 $x27762 $x25758 $x27563))))))))))))))))))))))))))))
(check-sat)
