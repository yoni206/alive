...
(assert
 ...
 (let (($x18198 (and (distinct (ite (= (ite (= (bvand %Op C) (_ bv0 38)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3) (bvadd (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x21607) ?x13561) C2)) true)))
 ...
 (and (and (and (distinct C (_ bv0 38)) true) (= (bvand C (bvsub C (_ bv1 38))) (_ bv0 38))) $x3060 (bvslt (ite (and (distinct ((_ extract 37 19) C) (_ bv0 19)) true) ?x711 ?x15773) (_ bv11 32)) $x18198)))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
