...
(assert
 ...
 (let ((?x9080 (bvor %Y C2)))
 (let ((?x19079 (ite (= (ite (and (distinct (bvand %X C1) (_ bv0 45)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y ?x9080)))
 (let (($x12383 (and (distinct ?x19079 (bvor (bvxor (bvshl ((_ extract 10 0) (bvand %X C1)) ?x20802) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 45)) true) (= (bvand C1 (bvsub C1 (_ bv1 45))) (_ bv0 45))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvsge ?x2492 ?x19228) $x12383))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
