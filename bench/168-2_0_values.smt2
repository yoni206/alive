...
(assert
 ...
 (let ((?x141777 (bvshl %x ?x7375)))
 (let (($x106855 (and (distinct (bvmul %x C1) ?x141777) true)))
 (let (($x11022 (and (and (distinct C1 (_ bv0 11)) true) (= (bvand C1 (bvsub C1 (_ bv1 11))) (_ bv0 11)))))
 (let (($x116499 (= ((_ extract 21 11) (bvmul ((_ zero_extend 11) %x) ((_ zero_extend 11) C1))) (_ bv0 11))))
 (and $x116499 $x11022 $x106855)))))))))))
(check-sat)
