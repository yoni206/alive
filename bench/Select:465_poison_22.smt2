...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 23)) true) (= (bvand C1 (bvsub C1 (_ bv1 23))) (_ bv0 23))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvsge ?x15791 (ite (and (distinct ((_ extract 22 12) C1) (_ bv0 11)) true) ?x2398 ?x7326)) false)))))))))))))))))
(check-sat)
