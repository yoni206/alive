...
(assert
 ...
 (let ((?x24382 (bvand %X C1)))
 (let (($x4888 (and (distinct (ite (= (ite (= ?x24382 (_ bv0 39)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y (bvor %Y C2)) (bvor ((_ extract 10 0) (bvlshr ?x24382 ?x20872)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 39)) true) (= (bvand C1 (bvsub C1 (_ bv1 39))) (_ bv0 39))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x15665 (ite (and (distinct ((_ extract 38 20) C1) (_ bv0 19)) true) ?x10017 ?x7099)) $x4888)))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
