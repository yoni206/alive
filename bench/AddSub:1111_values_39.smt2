...
(assert
 ...
 (let (($x8043 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x2879) ?x2879)) true)))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 45)) true) (= (bvand C2 (bvsub C2 (_ bv1 45))) (_ bv0 45))) (not (= (bvand C2 (bvshl (_ bv35184372088831 45) ?x2879)) (_ bv0 45))) $x8043)))))))))))))))))))))))))
(check-sat)
