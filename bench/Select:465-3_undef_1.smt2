...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 8)) true) (= (bvand C1 (bvsub C1 (_ bv1 8))) (_ bv0 8))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x5065 (ite (and (distinct ((_ extract 7 4) C1) (_ bv0 4)) true) ?x1121 ?x3367)) (not (bvult ?x4280 (_ bv8 8))))))))))))))))))))
(check-sat)
