...
(assert
 ...
 (let ((?x10047 (bvand %X C1)))
 (let ((?x10041 (bvor %Y C2)))
 (let (($x3689 (and (distinct (ite (= (ite (and (distinct ?x10047 (_ bv0 53)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) ?x10041 %Y) (bvor ((_ extract 10 0) (bvlshr ?x10047 ?x3216)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 53)) true) (= (bvand C1 (bvsub C1 (_ bv1 53))) (_ bv0 53))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x3881 ?x4138) $x3689))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
