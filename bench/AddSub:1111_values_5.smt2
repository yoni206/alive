...
(assert
 ...
 (let (($x4650 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x4020) ?x4020)) true)))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (not (= (bvand C2 (bvshl (_ bv2047 11) ?x4020)) (_ bv0 11))) $x4650)))))))))
(check-sat)
