...
(assert
 ...
 (let (($x5053 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x468) ?x468)) true)))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 20)) true) (= (bvand C2 (bvsub C2 (_ bv1 20))) (_ bv0 20))) (not (= (bvand C2 (bvshl (_ bv1048575 20) ?x468)) (_ bv0 20))) $x5053)))))))))))))
(check-sat)
