...
(assert
 (let (($x101745 (or (and (distinct %X (_ bv2048 12)) true) (and (distinct (bvshl %A %B) (_ bv4095 12)) true))))
 ...
 (and $x127678 $x121458 $x101745 $x120998 $x127678 $x107336 $x118 (not (and $x127678 $x121458 $x101745)))))))))))
(check-sat)
