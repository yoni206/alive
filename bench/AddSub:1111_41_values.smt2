...
(assert
 ...
 (let ((?x15826 (bvsub (_ bv44 44) (bvsub (bvsub (_ bv44 44) ?x18642) (_ bv1 44)))))
 (let (($x18411 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x15826) ?x15826)) true)))
 (let (($x18874 (not (= (bvand C2 (bvshl (_ bv17592186044415 44) ?x15826)) (_ bv0 44)))))
 (let (($x16918 (and (and (distinct C2 (_ bv0 44)) true) (= (bvand C2 (bvsub C2 (_ bv1 44))) (_ bv0 44)))))
 (let (($x16885 (= C1 (bvneg C2))))
 (and $x16885 $x16918 $x18874 $x18411))))))))))))))))))))))))))))
(check-sat)
