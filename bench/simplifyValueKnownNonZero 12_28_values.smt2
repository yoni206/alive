...
(assert
 ...
 (let (($x140212 (or $x341 (and (distinct ?x129518 (_ bv8589934591 33)) true))))
 (let (($x122572 (and (distinct ?x129518 (_ bv0 33)) true)))
 (and $x131 $x122572 $x140212 $x121462 $x131 $x107336 $x118 (and (distinct ?x115670 ?x115670) true))))))))))))
(check-sat)
