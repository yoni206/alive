...
(assert
 ...
 (let ((?x4946 (bvand %X C1)))
 (let (($x2980 (and (distinct (ite (= (ite (= ?x4946 (_ bv0 55)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) (bvor %Y C2) %Y) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x4946 ?x2064)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 55)) true) (= (bvand C1 (bvsub C1 (_ bv1 55))) (_ bv0 55))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x3105 ?x5646) $x2980)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
