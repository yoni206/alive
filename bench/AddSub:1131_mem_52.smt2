...
(assert
 ...
 (and (= (bvand |ana_computeKnownZeroBits(%Y)| %Y) (_ bv0 54)) (= u_%LHS (_ bv1 8)) $x5516 (= (bvor C2 |ana_computeKnownZeroBits(%Y)|) (_ bv18014398509481983 54)) (and (distinct mem0 mem0) true))))
(check-sat)
