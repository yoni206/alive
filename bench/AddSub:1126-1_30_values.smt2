...
(assert
 ...
 (let ((?x12726 (bvsub (bvsub (_ bv35 35) (ite (and (distinct ((_ extract 34 18) C1) (_ bv0 17)) true) ?x6534 ?x10812)) (_ bv1 35))))
 ...
 (and $x14361 $x8646 $x9394 $x462 (and (distinct ?x14660 (bvashr (bvshl %Y ?x12726) ?x12726)) true))))))))))))))))))))))))
(check-sat)
