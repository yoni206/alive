...
(assert
 ...
 (and $x203404 (or (and (distinct %Op0 (_ bv2251799813685248 52)) true) (and (distinct %Op1 (_ bv4503599627370495 52)) true)) $x203245 $x203133 $x129530 $x127386 (not $x203404))))))))
(check-sat)
