...
(assert
 ...
 (let (($x4135 (and (distinct (ite (= (ite (= ?x2899 (_ bv0 43)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) (bvor %Y C2) %Y) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x2899 ?x4618)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 43)) true) (= (bvand C1 (bvsub C1 (_ bv1 43))) (_ bv0 43))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x6692 ?x3063) $x4135)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
