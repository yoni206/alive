...
(assert
 ...
 (let (($x150909 (=> $x127386 (= (bvand %Op1 (bvshl (_ bv1 17) (bvsub (_ bv17 17) (_ bv1 17)))) (_ bv0 17)))))
 (let (($x96391 (=> $x129530 (= (bvand %Op0 (bvshl (_ bv1 17) (bvsub (_ bv17 17) (_ bv1 17)))) (_ bv0 17)))))
 (let (($x110840 (and (distinct %Op1 (_ bv0 17)) true)))
 (and $x110840 (or (and (distinct %Op0 (_ bv65536 17)) true) (and (distinct %Op1 (_ bv131071 17)) true)) $x96391 $x150909 $x129530 $x127386 (not $x110840))))))))
(check-sat)
