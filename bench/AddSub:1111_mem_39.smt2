...
(assert
 ...
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 45)) true) (= (bvand C2 (bvsub C2 (_ bv1 45))) (_ bv0 45))) (not (= (bvand C2 (bvshl (_ bv35184372088831 45) ?x2879)) (_ bv0 45))) (and (distinct mem0 mem0) true)))))))))))))))))))))))))
(check-sat)
