...
(assert
 ...
 (let ((?x21794 (bvand %X C1)))
 (let (($x7410 (and (distinct (ite (= (ite (= ?x21794 (_ bv0 37)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y (bvor %Y C2)) (bvor ((_ extract 10 0) (bvlshr ?x21794 ?x4996)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 37)) true) (= (bvand C1 (bvsub C1 (_ bv1 37))) (_ bv0 37))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x4820 (ite (and (distinct ((_ extract 36 19) C1) (_ bv0 18)) true) ?x9238 ?x11703)) $x7410)))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
