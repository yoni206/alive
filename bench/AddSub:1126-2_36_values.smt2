...
(assert
 ...
 (let ((?x1091 (bvshl (_ bv2199023255551 41) (bvadd (ite (and (distinct ((_ extract 40 21) C2) (_ bv0 20)) true) ?x16922 ?x16660) (_ bv1 41)))))
 (let (($x21896 (=> $x4990 (= (bvand %Y ?x1091) (_ bv0 41)))))
 (and $x21896 $x17086 $x13186 $x4990 (and (distinct ?x18115 (bvashr (bvshl %Y ?x18389) ?x18389)) true))))))))))))))))))))))))))))))
(check-sat)
