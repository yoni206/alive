...
(assert
 ...
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 14)) true) (= (bvand C2 (bvsub C2 (_ bv1 14))) (_ bv0 14))) (not (= (bvand C2 (bvshl (_ bv16383 14) ?x3394)) (_ bv0 14))) (and (distinct mem0 mem0) true)))))))))
(check-sat)
