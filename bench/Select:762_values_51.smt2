...
(assert
 ...
 (let ((?x4961 (ite (and (distinct ((_ extract 2 2) ?x7757) (_ bv0 1)) true) (_ bv2 11) (ite (and (distinct ((_ extract 1 1) ?x7757) (_ bv0 1)) true) (_ bv1 11) (_ bv0 11)))))
 (let ((?x3505 (ite (and (distinct ((_ extract 5 5) ?x7757) (_ bv0 1)) true) (_ bv5 11) (ite (and (distinct ((_ extract 4 4) ?x7757) (_ bv0 1)) true) (_ bv4 11) (_ bv3 11)))))
 (let ((?x8075 (ite (and (distinct ((_ extract 8 8) ?x7757) (_ bv0 1)) true) (_ bv8 11) (ite (and (distinct ((_ extract 7 7) ?x7757) (_ bv0 1)) true) (_ bv7 11) (_ bv6 11)))))
 (let ((?x3083 (ite (and (distinct ((_ extract 10 9) ?x7757) (_ bv0 2)) true) (ite (and (distinct ((_ extract 10 10) ?x7757) (_ bv0 1)) true) (_ bv10 11) (_ bv9 11)) ?x8075)))
 (let ((?x7089 (ite (and (distinct ((_ extract 10 6) ?x7757) (_ bv0 5)) true) ?x3083 (ite (and (distinct ((_ extract 5 3) ?x7757) (_ bv0 3)) true) ?x3505 ?x4961))))
 ...
 (let ((?x6837 (bvadd (bvxor (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x5107) ?x5508) ?x7757) C3)))
 (let (($x8371 (and (distinct (ite (= (ite (= (bvand %Op C) (_ bv0 55)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3) ?x6837) true)))
 ...
 (and (and (and (distinct C (_ bv0 55)) true) (= (bvand C (bvsub C (_ bv1 55))) (_ bv0 55))) (and (and (distinct ?x7757 (_ bv0 11)) true) (= (bvand ?x7757 (bvsub ?x7757 (_ bv1 11))) (_ bv0 11))) (bvslt ?x1575 (_ bv11 32)) $x8371))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
