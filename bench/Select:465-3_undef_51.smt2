...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 52)) true) (= (bvand C1 (bvsub C1 (_ bv1 52))) (_ bv0 52))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x5681 ?x5667) (not (bvult ?x1996 (_ bv52 52))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
