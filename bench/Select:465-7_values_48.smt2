...
(assert
 ...
 (let ((?x18521 (bvand %X C1)))
 (let (($x23939 (and (distinct (ite (= (ite (= ?x18521 (_ bv0 53)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) (bvor %Y C2) %Y) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x18521 ?x15398)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 53)) true) (= (bvand C1 (bvsub C1 (_ bv1 53))) (_ bv0 53))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x15491 ?x16448) $x23939)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
