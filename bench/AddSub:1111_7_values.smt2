...
(assert
 ...
 (let ((?x6028 (bvsub (bvsub (_ bv10 10) (ite (and (distinct ((_ extract 9 5) C2) (_ bv0 5)) true) ?x3968 ?x2105)) (_ bv1 10))))
 (let ((?x5794 (bvsub (_ bv10 10) ?x6028)))
 (let (($x7397 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x5794) ?x5794)) true)))
 (let (($x1165 (not (= (bvand C2 (bvshl (_ bv1023 10) ?x5794)) (_ bv0 10)))))
 (let (($x1994 (and (and (distinct C2 (_ bv0 10)) true) (= (bvand C2 (bvsub C2 (_ bv1 10))) (_ bv0 10)))))
 (let (($x1172 (= C1 (bvneg C2))))
 (and $x1172 $x1994 $x1165 $x7397))))))))))))
(check-sat)
