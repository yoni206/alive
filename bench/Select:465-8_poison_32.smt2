...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 33)) true) (= (bvand C1 (bvsub C1 (_ bv1 33))) (_ bv0 33))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x1465 (ite (and (distinct ((_ extract 32 17) C1) (_ bv0 16)) true) ?x3246 ?x5692)) false))))))))))))))))))
(check-sat)
