...
(assert
 ...
 (let (($x141332 (=> $x127386 (= (bvand %Op1 (bvshl (_ bv1 30) (bvsub (_ bv30 30) (_ bv1 30)))) (_ bv0 30)))))
 (let (($x134927 (=> $x129530 (= (bvand %Op0 (bvshl (_ bv1 30) (bvsub (_ bv30 30) (_ bv1 30)))) (_ bv0 30)))))
 (let (($x153288 (and (distinct %Op1 (_ bv0 30)) true)))
 (and $x153288 (or (and (distinct %Op0 (_ bv536870912 30)) true) (and (distinct %Op1 (_ bv1073741823 30)) true)) $x134927 $x141332 $x129530 $x127386 (not $x153288))))))))
(check-sat)
