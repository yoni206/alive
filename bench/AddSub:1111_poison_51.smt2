...
(assert
 ...
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 57)) true) (= (bvand C2 (bvsub C2 (_ bv1 57))) (_ bv0 57))) (not (= (bvand C2 (bvshl (_ bv144115188075855871 57) ?x2776)) (_ bv0 57))) false))))))))))))))))))))))))
(check-sat)
