...
(assert
 ...
 (and (and (and (distinct C (_ bv0 40)) true) (= (bvand C (bvsub C (_ bv1 40))) (_ bv0 40))) $x4082 (bvslt (ite (and (distinct ((_ extract 39 20) C) (_ bv0 20)) true) ?x20185 ?x17007) (_ bv11 32)) (and (distinct mem0 mem0) true))))))))))))))))))))))
(check-sat)
