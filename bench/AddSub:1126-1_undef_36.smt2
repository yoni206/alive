...
(assert
 ...
 (let (($x1341 (bvult ?x5157 (_ bv41 41))))
 ...
 (and (=> $x7990 (= (bvand %Y ?x2196) (_ bv0 41))) (= C2 (bvneg C1)) (and (and (distinct C1 (_ bv0 41)) true) (= (bvand C1 (bvsub C1 (_ bv1 41))) (_ bv0 41))) $x7990 (not (and $x1341 $x1341)))))))))))))))))))))))))))
(check-sat)
