...
(assert
 ...
 (let ((?x9193 (bvsub (bvsub (_ bv64 64) ?x8596) (_ bv1 64))))
 (let (($x2751 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x9193) ?x9193)) true)))
 (let (($x5588 (= |ana_MaskedValueIsZero(%Y, (-1 << (log2(C2) + 1)))| (_ bv1 1))))
 (and (=> $x5588 (= (bvand %Y (bvshl (_ bv18446744073709551615 64) (bvadd ?x8596 (_ bv1 64)))) (_ bv0 64))) (= C2 (bvneg C1)) (and (and (distinct C2 (_ bv0 64)) true) (= (bvand C2 (bvsub C2 (_ bv1 64))) (_ bv0 64))) $x5588 $x2751))))))))))))))))))))))))))
(check-sat)
