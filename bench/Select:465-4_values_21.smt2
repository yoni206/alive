...
(assert
 ...
 (let ((?x14154 (bvand %X C1)))
 (let ((?x22904 (bvor %Y C2)))
 (let (($x16203 (and (distinct (ite (= (ite (and (distinct ?x14154 (_ bv0 26)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y ?x22904) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x14154 ?x22369)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 26)) true) (= (bvand C1 (bvsub C1 (_ bv1 26))) (_ bv0 26))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x3560 (ite (and (distinct ((_ extract 25 13) C1) (_ bv0 13)) true) ?x5997 ?x14806)) $x16203))))))))))))))))))))))))))))))))))))
(check-sat)
