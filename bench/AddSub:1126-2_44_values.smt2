...
(assert
 ...
 (let ((?x20181 (bvsub (bvsub (_ bv49 49) ?x17911) (_ bv1 49))))
 ...
 (let (($x28210 (=> $x4990 (= (bvand %Y (bvshl (_ bv562949953421311 49) (bvadd ?x17911 (_ bv1 49)))) (_ bv0 49)))))
 (and $x28210 $x29889 $x18316 $x4990 (and (distinct ?x13896 (bvashr (bvshl %Y ?x20181) ?x20181)) true)))))))))))))))))))))))))))))))
(check-sat)
