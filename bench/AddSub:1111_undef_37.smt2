...
(assert
 ...
 (let (($x7530 (bvult ?x3691 (_ bv43 43))))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 43)) true) (= (bvand C2 (bvsub C2 (_ bv1 43))) (_ bv0 43))) (not (= (bvand C2 (bvshl (_ bv8796093022207 43) ?x3691)) (_ bv0 43))) (not (and $x7530 $x7530)))))))))))))))))))))))))))
(check-sat)
