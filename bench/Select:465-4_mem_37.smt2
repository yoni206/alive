...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 42)) true) (= (bvand C1 (bvsub C1 (_ bv1 42))) (_ bv0 42))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x12719 (ite (and (distinct ((_ extract 41 21) C1) (_ bv0 21)) true) ?x2676 ?x19292)) (and (distinct mem0 mem0) true))))))))))))))))))))))))))))
(check-sat)
