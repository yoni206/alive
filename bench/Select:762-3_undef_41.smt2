...
(assert
 ...
 (and (and (and (distinct C (_ bv0 45)) true) (= (bvand C (bvsub C (_ bv1 45))) (_ bv0 45))) $x8366 (bvslt ?x20731 (_ bv11 32)) (not (and (bvult ?x7480 (_ bv11 11)) (bvult ?x18006 (_ bv11 11))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
