...
(assert
 ...
 (let ((?x4708 (bvand %X C1)))
 (let ((?x4960 (bvor %Y C2)))
 (let (($x2980 (and (distinct (ite (= (ite (and (distinct ?x4708 (_ bv0 17)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) ?x4960 %Y) (bvor ((_ extract 10 0) (bvlshr ?x4708 ?x6194)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 17)) true) (= (bvand C1 (bvsub C1 (_ bv1 17))) (_ bv0 17))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x2061 ?x1756) $x2980))))))))))))))))))))))))))))
(check-sat)
