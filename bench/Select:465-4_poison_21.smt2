...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 26)) true) (= (bvand C1 (bvsub C1 (_ bv1 26))) (_ bv0 26))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x3560 (ite (and (distinct ((_ extract 25 13) C1) (_ bv0 13)) true) ?x5997 ?x14806)) false)))))))))))))))))
(check-sat)
