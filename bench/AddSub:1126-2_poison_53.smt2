...
(assert
 ...
 (and (=> $x8100 (= (bvand %Y (bvshl (_ bv288230376151711743 58) (bvadd ?x10760 (_ bv1 58)))) (_ bv0 58))) (= C2 (bvneg C1)) (and (and (distinct C2 (_ bv0 58)) true) (= (bvand C2 (bvsub C2 (_ bv1 58))) (_ bv0 58))) $x8100 false))))))))))))))))))))))))
(check-sat)
