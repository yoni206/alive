...
(assert
 ...
 (let ((?x3391 (bvor %Y C2)))
 (let (($x4669 (and (distinct (ite (= (ite (and (distinct ?x3475 (_ bv0 44)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y ?x3391) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x3475 ?x5598)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 44)) true) (= (bvand C1 (bvsub C1 (_ bv1 44))) (_ bv0 44))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x3233 ?x5063) $x4669))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
