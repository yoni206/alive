...
(assert
 ...
 (let ((?x195 (bvor %Y C2)))
 (let ((?x4429 (ite (= (ite (and (distinct (bvand %X C1) (_ bv0 52)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) ?x195 %Y)))
 ...
 (and (and (and (distinct C1 (_ bv0 52)) true) (= (bvand C1 (bvsub C1 (_ bv1 52))) (_ bv0 52))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvsge ?x2889 ?x8771) (and (distinct ?x4429 (bvor (bvshl ((_ extract 10 0) (bvand %X C1)) ?x22696) %Y)) true))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
