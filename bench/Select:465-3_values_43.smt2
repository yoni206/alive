...
(assert
 ...
 (let ((?x1238 (bvand %X C1)))
 (let (($x1354 (and (distinct (ite (= (ite (= ?x1238 (_ bv0 44)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y (bvor %Y C2)) (bvor ((_ extract 10 0) (bvlshr ?x1238 ?x5412)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 44)) true) (= (bvand C1 (bvsub C1 (_ bv1 44))) (_ bv0 44))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x1301 ?x3762) $x1354)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
