...
(assert
 ...
 (let ((?x2693 (bvand %X C1)))
 (let ((?x19512 (bvor %Y C2)))
 (let (($x17564 (and (distinct (ite (= (ite (and (distinct ?x2693 (_ bv0 40)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) ?x19512 %Y) (bvor ((_ extract 10 0) (bvlshr ?x2693 ?x10022)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 40)) true) (= (bvand C1 (bvsub C1 (_ bv1 40))) (_ bv0 40))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x10770 (ite (and (distinct ((_ extract 39 20) C1) (_ bv0 20)) true) ?x14580 ?x3057)) $x17564))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
