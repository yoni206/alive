...
(assert
 ...
 (let (($x145429 (=> $x127386 (= (bvand %Op1 (bvshl (_ bv1 34) (bvsub (_ bv34 34) (_ bv1 34)))) (_ bv0 34)))))
 (let (($x164102 (=> $x129530 (= (bvand %Op0 (bvshl (_ bv1 34) (bvsub (_ bv34 34) (_ bv1 34)))) (_ bv0 34)))))
 (let (($x133745 (and (distinct %Op1 (_ bv0 34)) true)))
 (and $x133745 (or (and (distinct %Op0 (_ bv8589934592 34)) true) (and (distinct %Op1 (_ bv17179869183 34)) true)) $x164102 $x145429 $x129530 $x127386 (not $x133745))))))))
(check-sat)
