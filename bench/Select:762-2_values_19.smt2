...
(assert
 ...
 (let ((?x5829 (ite (= (ite (and (distinct (bvand %Op C) (_ bv0 23)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3)))
 (let (($x7648 (and (distinct ?x5829 (bvadd (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x18367) ?x24069) C3)) true)))
 ...
 (and (and (and (distinct C (_ bv0 23)) true) (= (bvand C (bvsub C (_ bv1 23))) (_ bv0 23))) $x4641 (bvslt (ite (and (distinct ((_ extract 22 12) C) (_ bv0 11)) true) ?x2593 ?x5396) (_ bv11 32)) $x7648))))))))))))))))))))))))))))))))))
(check-sat)
