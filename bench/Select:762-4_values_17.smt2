...
(assert
 ...
 (let ((?x4322 (ite (and (distinct ((_ extract 2 2) ?x5589) (_ bv0 1)) true) (_ bv2 11) (ite (and (distinct ((_ extract 1 1) ?x5589) (_ bv0 1)) true) (_ bv1 11) (_ bv0 11)))))
 (let ((?x5621 (ite (and (distinct ((_ extract 5 5) ?x5589) (_ bv0 1)) true) (_ bv5 11) (ite (and (distinct ((_ extract 4 4) ?x5589) (_ bv0 1)) true) (_ bv4 11) (_ bv3 11)))))
 (let ((?x7495 (ite (and (distinct ((_ extract 8 8) ?x5589) (_ bv0 1)) true) (_ bv8 11) (ite (and (distinct ((_ extract 7 7) ?x5589) (_ bv0 1)) true) (_ bv7 11) (_ bv6 11)))))
 (let ((?x2370 (ite (and (distinct ((_ extract 10 9) ?x5589) (_ bv0 2)) true) (ite (and (distinct ((_ extract 10 10) ?x5589) (_ bv0 1)) true) (_ bv10 11) (_ bv9 11)) ?x7495)))
 (let ((?x3765 (ite (and (distinct ((_ extract 10 6) ?x5589) (_ bv0 5)) true) ?x2370 (ite (and (distinct ((_ extract 5 3) ?x5589) (_ bv0 3)) true) ?x5621 ?x4322))))
 ...
 (let ((?x4122 (bvadd (bvxor (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x5081) ?x4168) ?x5589) C2)))
 (let ((?x1960 (ite (= (ite (and (distinct (bvand %Op C) (_ bv0 22)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3)))
 ...
 (and (and (and (distinct C (_ bv0 22)) true) (= (bvand C (bvsub C (_ bv1 22))) (_ bv0 22))) (and (and (distinct ?x5589 (_ bv0 11)) true) (= (bvand ?x5589 (bvsub ?x5589 (_ bv1 11))) (_ bv0 11))) (bvslt (ite (and (distinct ((_ extract 21 11) C) (_ bv0 11)) true) ?x3299 ?x2266) (_ bv11 32)) (and (distinct ?x1960 ?x4122) true)))))))))))))))))))))))))))))))))))
(check-sat)
