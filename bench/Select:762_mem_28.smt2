...
(assert
 ...
 (and (and (and (distinct C (_ bv0 32)) true) (= (bvand C (bvsub C (_ bv1 32))) (_ bv0 32))) $x1830 (bvslt (ite (and (distinct ((_ extract 31 16) C) (_ bv0 16)) true) ?x6687 ?x3413) (_ bv11 32)) (and (distinct mem0 mem0) true))))))))))))))
(check-sat)
