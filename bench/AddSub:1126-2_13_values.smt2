...
(assert
 ...
 (let ((?x7711 (bvsub (bvsub (_ bv18 18) ?x6582) (_ bv1 18))))
 ...
 (let (($x13375 (=> $x4990 (= (bvand %Y (bvshl (_ bv262143 18) (bvadd ?x6582 (_ bv1 18)))) (_ bv0 18)))))
 (and $x13375 $x8369 $x8195 $x4990 (and (distinct ?x7847 (bvashr (bvshl %Y ?x7711) ?x7711)) true)))))))))))))))))
(check-sat)
