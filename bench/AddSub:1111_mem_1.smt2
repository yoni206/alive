...
(assert
 ...
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 3)) true) (= (bvand C2 (bvsub C2 (_ bv1 3))) (_ bv0 3))) (not (= (bvand C2 (bvshl (_ bv7 3) ?x599)) (_ bv0 3))) (and (distinct mem0 mem0) true)))))
(check-sat)
