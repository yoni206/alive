...
(assert
 ...
 (let ((?x833 (bvsub (bvsub (_ bv34 34) (ite (and (distinct ((_ extract 33 17) C1) (_ bv0 17)) true) ?x4150 ?x1862)) (_ bv1 34))))
 ...
 (and $x13083 $x12959 $x23538 $x462 (and (distinct ?x12994 (bvashr (bvshl %Y ?x833) ?x833)) true)))))))))))))))))))))))
(check-sat)
