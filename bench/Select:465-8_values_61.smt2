...
(assert
 ...
 (let ((?x7356 (bvand %X C1)))
 (let ((?x7306 (bvor %Y C2)))
 (let (($x2699 (and (distinct (ite (= (ite (and (distinct ?x7356 (_ bv0 63)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) ?x7306 %Y) (bvor ((_ extract 10 0) (bvlshr ?x7356 ?x13902)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 63)) true) (= (bvand C1 (bvsub C1 (_ bv1 63))) (_ bv0 63))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x3551 ?x20831) $x2699))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
