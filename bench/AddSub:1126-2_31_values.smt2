...
(assert
 ...
 (let ((?x25776 (bvshl (_ bv68719476735 36) (bvadd (ite (and (distinct ((_ extract 35 18) C2) (_ bv0 18)) true) ?x14609 ?x9918) (_ bv1 36)))))
 (let (($x29021 (=> $x4990 (= (bvand %Y ?x25776) (_ bv0 36)))))
 (and $x29021 $x10184 $x13074 $x4990 (and (distinct ?x12798 (bvashr (bvshl %Y ?x12148) ?x12148)) true)))))))))))))))))))))))))
(check-sat)
