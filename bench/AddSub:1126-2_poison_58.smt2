...
(assert
 ...
 (and (=> $x3027 (= (bvand %Y (bvshl (_ bv9223372036854775807 63) (bvadd ?x5337 (_ bv1 63)))) (_ bv0 63))) (= C2 (bvneg C1)) (and (and (distinct C2 (_ bv0 63)) true) (= (bvand C2 (bvsub C2 (_ bv1 63))) (_ bv0 63))) $x3027 false))))))))))))))))))))))))
(check-sat)
