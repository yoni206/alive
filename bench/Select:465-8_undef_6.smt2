...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 7)) true) (= (bvand C1 (bvsub C1 (_ bv1 7))) (_ bv0 7))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x11995 (ite (and (distinct ((_ extract 6 4) C1) (_ bv0 3)) true) ?x18532 ?x7055)) (not (bvult ?x9035 (_ bv7 7))))))))))))))))))))
(check-sat)
