...
(assert
 ...
 (let (($x198301 (=> $x153692 (= (bvand %Op1 (bvshl (_ bv1 42) (bvsub (_ bv42 42) (_ bv1 42)))) (_ bv0 42)))))
 ...
 (and $x142655 $x149209 $x198301 $x169285 $x153692 $x129530 (and (distinct (bvsrem %Op0 %Op1) (bvurem %Op0 %Op1)) true)))))))))
(check-sat)
