...
(assert
 ...
 (and $x118643 (or (and (distinct %Op0 (_ bv4294967296 33)) true) (and (distinct C (_ bv8589934591 33)) true)) (= (bvmul (bvsdiv %Op0 C) C) %Op0) $x114898 $x136115 (not (bvult ?x156666 (_ bv33 33))))))))))))))))))))
(check-sat)
