...
(assert
 ...
 (let (($x7197 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x1734) ?x1734)) true)))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 40)) true) (= (bvand C2 (bvsub C2 (_ bv1 40))) (_ bv0 40))) (not (= (bvand C2 (bvshl (_ bv1099511627775 40) ?x1734)) (_ bv0 40))) $x7197)))))))))))))))))))))))
(check-sat)
