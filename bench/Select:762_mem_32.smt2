...
(assert
 ...
 (and (and (and (distinct C (_ bv0 36)) true) (= (bvand C (bvsub C (_ bv1 36))) (_ bv0 36))) $x7627 (bvslt (ite (and (distinct ((_ extract 35 18) C) (_ bv0 18)) true) ?x6495 ?x5024) (_ bv11 32)) (and (distinct mem0 mem0) true))))))))))))))))))
(check-sat)
