...
(assert
 ...
 (let (($x7037 (bvult ?x1734 (_ bv40 40))))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 40)) true) (= (bvand C2 (bvsub C2 (_ bv1 40))) (_ bv0 40))) (not (= (bvand C2 (bvshl (_ bv1099511627775 40) ?x1734)) (_ bv0 40))) (not (and $x7037 $x7037)))))))))))))))))))))))))
(check-sat)
