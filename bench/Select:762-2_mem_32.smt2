...
(assert
 ...
 (and (and (and (distinct C (_ bv0 36)) true) (= (bvand C (bvsub C (_ bv1 36))) (_ bv0 36))) $x3105 (bvslt (ite (and (distinct ((_ extract 35 18) C) (_ bv0 18)) true) ?x1568 ?x5983) (_ bv11 32)) (and (distinct mem0 mem0) true))))))))))))))))))
(check-sat)
