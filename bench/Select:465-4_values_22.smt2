...
(assert
 ...
 (let ((?x3550 (bvand %X C1)))
 (let ((?x1865 (bvor %Y C2)))
 (let (($x2914 (and (distinct (ite (= (ite (and (distinct ?x3550 (_ bv0 30)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y ?x1865) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x3550 ?x2018)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 30)) true) (= (bvand C1 (bvsub C1 (_ bv1 30))) (_ bv0 30))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x1574 (ite (and (distinct ((_ extract 29 15) C1) (_ bv0 15)) true) ?x2797 ?x4621)) $x2914))))))))))))))))))))))))))))))))))))
(check-sat)
