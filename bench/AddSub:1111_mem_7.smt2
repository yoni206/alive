...
(assert
 ...
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 13)) true) (= (bvand C2 (bvsub C2 (_ bv1 13))) (_ bv0 13))) (not (= (bvand C2 (bvshl (_ bv8191 13) ?x5099)) (_ bv0 13))) (and (distinct mem0 mem0) true)))))))))
(check-sat)
