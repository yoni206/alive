...
(assert
 ...
 (let (($x7199 (bvult ?x1734 (_ bv41 41))))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 41)) true) (= (bvand C2 (bvsub C2 (_ bv1 41))) (_ bv0 41))) (not (= (bvand C2 (bvshl (_ bv2199023255551 41) ?x1734)) (_ bv0 41))) (not (and $x7199 $x7199))))))))))))))))))))))))))
(check-sat)
