...
(assert
 ...
 (let ((?x475 (bvand %X C1)))
 (let (($x14769 (and (distinct (ite (= (ite (= ?x475 (_ bv0 56)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y (bvor %Y C2)) (bvor ((_ extract 10 0) (bvlshr ?x475 ?x7257)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 56)) true) (= (bvand C1 (bvsub C1 (_ bv1 56))) (_ bv0 56))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x23773 ?x11027) $x14769)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
