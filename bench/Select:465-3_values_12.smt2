...
(assert
 ...
 (let (($x1615 (and (distinct (ite (= (ite (= ?x1966 (_ bv0 13)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y (bvor %Y C2)) (bvor ((_ extract 10 0) (bvlshr ?x1966 ?x4293)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 13)) true) (= (bvand C1 (bvsub C1 (_ bv1 13))) (_ bv0 13))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x5651 ?x2343) $x1615)))))))))))))))))))))))))
(check-sat)
