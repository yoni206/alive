...
(assert
 ...
 (let ((?x18599 (bvand %X C1)))
 (let (($x3239 (and (distinct (ite (= (ite (= ?x18599 (_ bv0 14)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y (bvor %Y C2)) (bvor ((_ extract 10 0) (bvlshr ?x18599 ?x19758)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 14)) true) (= (bvand C1 (bvsub C1 (_ bv1 14))) (_ bv0 14))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x20270 ?x5593) $x3239)))))))))))))))))))))))))
(check-sat)
