...
(assert
 ...
 (let (($x5472 (bvult ?x8767 (_ bv58 58))))
 (let (($x8100 (= |ana_MaskedValueIsZero(%Y, (-1 << (log2(C2) + 1)))| (_ bv1 1))))
 (and (=> $x8100 (= (bvand %Y (bvshl (_ bv288230376151711743 58) (bvadd ?x10760 (_ bv1 58)))) (_ bv0 58))) (= C2 (bvneg C1)) (and (and (distinct C2 (_ bv0 58)) true) (= (bvand C2 (bvsub C2 (_ bv1 58))) (_ bv0 58))) $x8100 (not (and $x5472 $x5472))))))))))))))))))))))))))))
(check-sat)
