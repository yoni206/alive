...
(assert
 ...
 (let ((?x12721 (ite (and (distinct ((_ extract 2 2) ?x14748) (_ bv0 1)) true) (_ bv2 11) (ite (and (distinct ((_ extract 1 1) ?x14748) (_ bv0 1)) true) (_ bv1 11) (_ bv0 11)))))
 (let ((?x3319 (ite (and (distinct ((_ extract 5 5) ?x14748) (_ bv0 1)) true) (_ bv5 11) (ite (and (distinct ((_ extract 4 4) ?x14748) (_ bv0 1)) true) (_ bv4 11) (_ bv3 11)))))
 (let ((?x5634 (ite (and (distinct ((_ extract 8 8) ?x14748) (_ bv0 1)) true) (_ bv8 11) (ite (and (distinct ((_ extract 7 7) ?x14748) (_ bv0 1)) true) (_ bv7 11) (_ bv6 11)))))
 (let ((?x16399 (ite (and (distinct ((_ extract 10 9) ?x14748) (_ bv0 2)) true) (ite (and (distinct ((_ extract 10 10) ?x14748) (_ bv0 1)) true) (_ bv10 11) (_ bv9 11)) ?x5634)))
 (let ((?x13901 (ite (and (distinct ((_ extract 10 6) ?x14748) (_ bv0 5)) true) ?x16399 (ite (and (distinct ((_ extract 5 3) ?x14748) (_ bv0 3)) true) ?x3319 ?x12721))))
 ...
 (let ((?x3295 (bvadd (bvxor (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x25191) ?x22988) ?x14748) C3)))
 (let (($x1062 (and (distinct (ite (= (ite (= (bvand %Op C) (_ bv0 56)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3) ?x3295) true)))
 ...
 (and (and (and (distinct C (_ bv0 56)) true) (= (bvand C (bvsub C (_ bv1 56))) (_ bv0 56))) (and (and (distinct ?x14748 (_ bv0 11)) true) (= (bvand ?x14748 (bvsub ?x14748 (_ bv1 11))) (_ bv0 11))) (bvslt ?x21953 (_ bv11 32)) $x1062))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
