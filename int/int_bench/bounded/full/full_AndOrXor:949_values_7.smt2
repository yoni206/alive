...
(assert
(let ((?x1193 (ite (and (distinct %a C2) true) 1 0)))
(let ((?x2896 (ite (and (distinct %a C1) true) 1 0)))
(let (($x16256 (and (distinct (intand k ?x2896 ?x1193) (ite (> (intadd k %a (intneg k C1)) 1) 1 0)) true)))
(and (< C1 C2) (= C1 (intsub k C2 1)) $x16256)))))
(check-sat)