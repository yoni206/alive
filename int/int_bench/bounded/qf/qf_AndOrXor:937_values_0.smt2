...
(assert
(let ((?x14319 (ite (intslt k %a C2) 1 0)))
(let ((?x4897 (ite (and (distinct %a C1) true) 1 0)))
(and (intslt k C1 C2) (= C1 (intsub k C2 1)) (and (distinct (intand k ?x4897 ?x14319) (ite (intslt k %a C1) 1 0)) true)))))
(check-sat)