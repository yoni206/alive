...
(assert
(let ((?x17880 (ite (< %b C) 1 0)))
(let ((?x17183 (ite (< %a C) 1 0)))
(let (($x3241 (and (distinct (intand k ?x17183 ?x17880) (ite (< (intor k %a %b) C) 1 0)) true)))
(and (and (and (distinct C 0) true) (= (intand k C (intsub k C 1)) 0)) $x3241)))))
(check-sat)