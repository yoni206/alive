...
(assert
(let (($x8136 (and (distinct (intand k (intadd k (intor k %A C1) %B) C2) (intand k (intadd k %A %B) C2)) true)))
(and (= (intand k (intadd k C2 1) (intsub k (intadd k C2 1) 1)) 0) (= (intand k C1 C2) 0) $x8136)))
(check-sat)