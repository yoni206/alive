...
;choose version of properties for or
(define-fun xor_is_ok ((k Int)) Bool (xor_is_ok_partial k))
...
(declare-fun C4() Int)
(assert (in_range k C4))
(assert (everything_is_ok_for k C4))


(declare-fun C3() Int)
(assert (in_range k C3))
(assert (everything_is_ok_for k C3))


(declare-fun %V1() Int)
(assert (in_range k %V1))
(assert (everything_is_ok_for k %V1))
