...
(assert
(let (($x786 (and (distinct (intand k (intsub k (intxor k %A C1) %B) C2) (intand k (intsub k %A %B) C2)) true)))
(and (= (intand k (intadd k C2 1) (intsub k (intadd k C2 1) 1)) 0) (= (intand k C1 C2) 0) $x786)))
(check-sat)