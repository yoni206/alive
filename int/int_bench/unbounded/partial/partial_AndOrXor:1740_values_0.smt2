...
(assert
(let ((?x3529 (ite (= %X C2) 1 0)))
(let ((?x18444 (ite (< (intadd k %X C3) C1) 1 0)))
(let (($x5499 (and (distinct (intor k ?x18444 ?x3529) (ite (<= (intadd k %X C3) C1) 1 0)) true)))
(and (= (intadd k C2 C3) C1) $x5499)))))
(check-sat)