...
(assert
(let ((?x5409 (ite (and (distinct %B 0) true) 1 0)))
(let ((?x11384 (ite (and (distinct %A 0) true) 1 0)))
(and (distinct (intor k ?x11384 ?x5409) (ite (and (distinct (intor k %A %B) 0) true) 1 0)) true))))
(check-sat)