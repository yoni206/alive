...
(assert
(let ((?x102 (ite (and (distinct %a C2) true) 1 0)))
(let ((?x8999 (ite (intsgt k %a C1) 1 0)))
(and (intslt k C1 C2) (= C2 (intadd k C1 1)) (and (distinct (intand k ?x8999 ?x102) (ite (intsgt k %a C2) 1 0)) true)))))
(check-sat)