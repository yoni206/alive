...
(assert (and (= (intand k (intand k C1 C3) (intxor k C2 C4)) 0) (= (intand k C1 C2) C2) (= (intand k C3 C4) C4) (not (= (and (= (intand k %a C1) C2) (= (intand k %a C3) C4)) (= (intand k %a (intor k C1 C3)) (intor k C2 C4))))))
(assert true)
(check-sat)