...
#SBATCH --qos=normal
#SBATCH -t 00:00:300
#SBATCH -D /barrett/scratch/yoniz/git/alive/int/cluster_results/cvc4_fmf
...
solver="./cvc4"
solver_options="--fmf-fun-rlv"
benchmarks="/barrett/scratch/yoniz/git/alive/int/cluster_results/cvc4_fmf/benchmarks"
scrambler=""
...
# set stdout log file
log="/barrett/scratch/yoniz/git/alive/int/cluster_results/cvc4_fmf/${out}.log"
# set stderr log file
err="/barrett/scratch/yoniz/git/alive/int/cluster_results/cvc4_fmf/${out}.err"
