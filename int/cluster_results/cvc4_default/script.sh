...
# set stdout log file
log="/barrett/scratch/yoniz/git/alive/int/cluster_results/cvc4_default/${out}.log"
# set stderr log file
err="/barrett/scratch/yoniz/git/alive/int/cluster_results/cvc4_default/${out}.err"
