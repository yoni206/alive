...
#SBATCH --qos=normal
#SBATCH -t 00:00:300
#SBATCH -D /barrett/scratch/yoniz/git/alive/int/cluster_results/cvc4_tplanes
...
benchmarks="/barrett/scratch/yoniz/git/alive/int/cluster_results/cvc4_tplanes/benchmarks"
scrambler=""
...
# set stdout log file
log="/barrett/scratch/yoniz/git/alive/int/cluster_results/cvc4_tplanes/${out}.log"
# set stderr log file
err="/barrett/scratch/yoniz/git/alive/int/cluster_results/cvc4_tplanes/${out}.err"
