...
# set stdout log file
log="/barrett/scratch/yoniz/git/alive/int/cluster_results/cvc4_tplanes_saturate_no_e_matching/${out}.log"
# set stderr log file
err="/barrett/scratch/yoniz/git/alive/int/cluster_results/cvc4_tplanes_saturate_no_e_matching/${out}.err"
