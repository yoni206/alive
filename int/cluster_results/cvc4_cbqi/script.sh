...
#SBATCH --qos=normal
#SBATCH -t 00:00:300
#SBATCH -D /barrett/scratch/yoniz/git/alive/int/cluster_results/cvc4_cbqi
...
solver="./cvc4"
solver_options="--cbqi-all"
benchmarks="/barrett/scratch/yoniz/git/alive/int/cluster_results/cvc4_cbqi/benchmarks"
scrambler=""
...
# set stdout log file
log="/barrett/scratch/yoniz/git/alive/int/cluster_results/cvc4_cbqi/${out}.log"
# set stderr log file
err="/barrett/scratch/yoniz/git/alive/int/cluster_results/cvc4_cbqi/${out}.err"
