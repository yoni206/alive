...
#SBATCH --qos=normal
#SBATCH -t 00:00:1
#SBATCH -D /barrett/scratch/yoniz/git/alive/int/cluster_results/z3_default
...
solver="./z3"
solver_options=""
benchmarks="/barrett/scratch/yoniz/git/alive/int/cluster_results/z3_default/benchmarks"
scrambler=""
...
# set stdout log file
log="/barrett/scratch/yoniz/git/alive/int/cluster_results/z3_default/${out}.log"
# set stderr log file
err="/barrett/scratch/yoniz/git/alive/int/cluster_results/z3_default/${out}.err"
