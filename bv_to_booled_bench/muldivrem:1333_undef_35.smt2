...
(assert (let ((_let_0 (= |ana_MaskedValueIsZero(%Op0, (1 << (width(%Op0) - 1)))| (_ bv1 1)))) (let ((_let_1 (= |ana_MaskedValueIsZero(%Op1, (1 << (width(%Op1) - 1)))| (_ bv1 1)))) (let ((_let_2 (bvshl (_ bv1 39) (bvsub (_ bv39 39) (_ bv1 39))))) (let ((_let_3 (= %Op1 (_ bv0 39)))) (and (or (not (= %Op0 (_ bv274877906944 39))) (not (= %Op1 (_ bv549755813887 39)))) (=> _let_1 (= (bvand %Op1 _let_2) (_ bv0 39))) (=> _let_0 (= (bvand %Op0 _let_2) (_ bv0 39))) _let_1 _let_0 _let_3 (not _let_3)))))))
(assert true)
(check-sat)