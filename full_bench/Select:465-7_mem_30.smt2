...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 35)) true) (= (bvand C1 (bvsub C1 (_ bv1 35))) (_ bv0 35))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x12588 (ite (and (distinct ((_ extract 34 18) C1) (_ bv0 17)) true) ?x11186 ?x19349)) (and (distinct mem0 mem0) true)))))))))))))))))))))
(check-sat)
