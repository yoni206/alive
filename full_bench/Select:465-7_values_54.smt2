...
(assert
 ...
 (let ((?x2789 (bvand %X C1)))
 (let (($x4410 (and (distinct (ite (= (ite (= ?x2789 (_ bv0 62)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) (bvor %Y C2) %Y) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x2789 ?x3733)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 62)) true) (= (bvand C1 (bvsub C1 (_ bv1 62))) (_ bv0 62))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x4861 ?x1884) $x4410)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
