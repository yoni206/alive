...
(assert
 ...
 (and $x438031 (or (and (distinct %Op0 (_ bv72057594037927936 57)) true) (and (distinct %Op1 (_ bv144115188075855871 57)) true)) $x442669 $x414009 $x365594 $x472207 (not $x438031))))))))
(check-sat)
