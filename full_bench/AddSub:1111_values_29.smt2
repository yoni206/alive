...
(assert
 ...
 (let (($x6365 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x5159) ?x5159)) true)))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 35)) true) (= (bvand C2 (bvsub C2 (_ bv1 35))) (_ bv0 35))) (not (= (bvand C2 (bvshl (_ bv34359738367 35) ?x5159)) (_ bv0 35))) $x6365))))))))))))))))))
(check-sat)
