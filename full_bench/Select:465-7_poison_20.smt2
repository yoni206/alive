...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 28)) true) (= (bvand C1 (bvsub C1 (_ bv1 28))) (_ bv0 28))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x6313 (ite (and (distinct ((_ extract 27 14) C1) (_ bv0 14)) true) ?x1845 ?x3938)) false)))))))))))))))))
(check-sat)
