...
(assert
 ...
 (let ((?x16313 (bvsub (bvsub (_ bv19 19) ?x16122) (_ bv1 19))))
 ...
 (let (($x19702 (=> $x7212 (= (bvand %Y (bvshl (_ bv524287 19) (bvadd ?x16122 (_ bv1 19)))) (_ bv0 19)))))
 (and $x19702 $x20626 $x16353 $x7212 (and (distinct ?x15841 (bvashr (bvshl %Y ?x16313) ?x16313)) true))))))))))))))))))
(check-sat)
