...
(assert
 ...
 (let ((?x5021 (bvand %X C1)))
 (let ((?x2186 (bvor %Y C2)))
 (let (($x2849 (and (distinct (ite (= (ite (and (distinct ?x5021 (_ bv0 37)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y ?x2186) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x5021 ?x2314)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 37)) true) (= (bvand C1 (bvsub C1 (_ bv1 37))) (_ bv0 37))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x2881 (ite (and (distinct ((_ extract 36 19) C1) (_ bv0 18)) true) ?x3499 ?x6831)) $x2849))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
