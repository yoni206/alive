...
(assert
 ...
 (let ((?x23834 (bvsub (_ bv42 42) ?x23833)))
 (let (($x23757 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x23834) ?x23834)) true)))
 (let (($x23785 (not (= (bvand C2 (bvshl (_ bv4398046511103 42) ?x23834)) (_ bv0 42)))))
 (let (($x23797 (and (and (distinct C2 (_ bv0 42)) true) (= (bvand C2 (bvsub C2 (_ bv1 42))) (_ bv0 42)))))
 (let (($x23807 (= C1 (bvneg C2))))
 (and $x23807 $x23797 $x23785 $x23757))))))))))))))))))))))))))))
(check-sat)
