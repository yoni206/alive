...
(assert
 ...
 (let (($x5158 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x2618) ?x2618)) true)))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 17)) true) (= (bvand C2 (bvsub C2 (_ bv1 17))) (_ bv0 17))) (not (= (bvand C2 (bvshl (_ bv131071 17) ?x2618)) (_ bv0 17))) $x5158))))))))))
(check-sat)
