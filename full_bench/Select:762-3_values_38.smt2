...
(assert
 ...
 (let (($x8546 (and (distinct (ite (= (ite (= (bvand %Op C) (_ bv0 42)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3) (bvadd (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x1966) ?x4339) C2)) true)))
 ...
 (and (and (and (distinct C (_ bv0 42)) true) (= (bvand C (bvsub C (_ bv1 42))) (_ bv0 42))) $x5788 (bvslt (ite (and (distinct ((_ extract 41 21) C) (_ bv0 21)) true) ?x2982 ?x6933) (_ bv11 32)) $x8546)))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
