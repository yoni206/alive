...
(assert
 ...
 (let ((?x4991 (bvshl (_ bv68719476735 36) (bvadd (ite (and (distinct ((_ extract 35 18) C2) (_ bv0 18)) true) ?x21315 ?x20742) (_ bv1 36)))))
 (let (($x37587 (=> $x7212 (= (bvand %Y ?x4991) (_ bv0 36)))))
 (and $x37587 $x32870 $x21772 $x7212 (and (distinct ?x21370 (bvashr (bvshl %Y ?x21298) ?x21298)) true)))))))))))))))))))))))))
(check-sat)
