...
(assert
 ...
 (let ((?x4911 (ite (and (distinct ((_ extract 2 2) ?x4663) (_ bv0 1)) true) (_ bv2 11) (ite (and (distinct ((_ extract 1 1) ?x4663) (_ bv0 1)) true) (_ bv1 11) (_ bv0 11)))))
 (let ((?x3144 (ite (and (distinct ((_ extract 5 5) ?x4663) (_ bv0 1)) true) (_ bv5 11) (ite (and (distinct ((_ extract 4 4) ?x4663) (_ bv0 1)) true) (_ bv4 11) (_ bv3 11)))))
 (let ((?x6072 (ite (and (distinct ((_ extract 8 8) ?x4663) (_ bv0 1)) true) (_ bv8 11) (ite (and (distinct ((_ extract 7 7) ?x4663) (_ bv0 1)) true) (_ bv7 11) (_ bv6 11)))))
 (let ((?x4270 (ite (and (distinct ((_ extract 10 9) ?x4663) (_ bv0 2)) true) (ite (and (distinct ((_ extract 10 10) ?x4663) (_ bv0 1)) true) (_ bv10 11) (_ bv9 11)) ?x6072)))
 (let ((?x2265 (ite (and (distinct ((_ extract 10 6) ?x4663) (_ bv0 5)) true) ?x4270 (ite (and (distinct ((_ extract 5 3) ?x4663) (_ bv0 3)) true) ?x3144 ?x4911))))
 ...
 (let ((?x2838 (bvadd (bvxor (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x7509) ?x1206) ?x4663) C3)))
 (let (($x6442 (and (distinct (ite (= (ite (= (bvand %Op C) (_ bv0 42)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3) ?x2838) true)))
 ...
 (and (and (and (distinct C (_ bv0 42)) true) (= (bvand C (bvsub C (_ bv1 42))) (_ bv0 42))) (and (and (distinct ?x4663 (_ bv0 11)) true) (= (bvand ?x4663 (bvsub ?x4663 (_ bv1 11))) (_ bv0 11))) (bvslt (ite (and (distinct ((_ extract 41 21) C) (_ bv0 21)) true) ?x3013 ?x5818) (_ bv11 32)) $x6442))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
