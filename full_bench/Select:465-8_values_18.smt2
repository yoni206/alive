...
(assert
 ...
 (let ((?x16566 (bvand %X C1)))
 (let ((?x10803 (bvor %Y C2)))
 (let (($x12949 (and (distinct (ite (= (ite (and (distinct ?x16566 (_ bv0 20)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) ?x10803 %Y) (bvor ((_ extract 10 0) (bvlshr ?x16566 ?x7097)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 20)) true) (= (bvand C1 (bvsub C1 (_ bv1 20))) (_ bv0 20))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x16762 ?x7850) $x12949))))))))))))))))))))))))))))))))))
(check-sat)
