...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 15)) true) (= (bvand C1 (bvsub C1 (_ bv1 15))) (_ bv0 15))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x17709 ?x228) (not (bvult ?x2403 (_ bv15 15))))))))))))))))))))))))))
(check-sat)
