...
(assert
 (let (($x4070 (and (distinct (bvadd (bvxor (bvand %Z C2) C1) %RHS) (bvsub %RHS (bvor %Z (bvnot C2)))) true)))
 ...
 (and (= (ite (= ((_ extract 0 0) C1) (_ bv1 1)) (_ bv0 32) ?x2581) (_ bv0 32)) (= C1 (bvadd C2 (_ bv1 23))) $x4070))))))))))))))
(check-sat)
