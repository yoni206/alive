...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 10)) true) (= (bvand C1 (bvsub C1 (_ bv1 10))) (_ bv0 10))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x4881 (ite (and (distinct ((_ extract 9 5) C1) (_ bv0 5)) true) ?x2899 ?x4681)) (and (distinct mem0 mem0) true))))))))))))
(check-sat)
