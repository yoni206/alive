...
(assert
 (let ((?x207227 (ite (and (distinct (bvand %A (bvor %K1 %K2)) (bvor %K1 %K2)) true) (_ bv1 1) (_ bv0 1))))
 (let ((?x206040 (ite (= (bvand %A %K2) (_ bv0 5)) (_ bv1 1) (_ bv0 1))))
 (let ((?x259293 (ite (= (bvand %A %K1) (_ bv0 5)) (_ bv1 1) (_ bv0 1))))
 ...
 (and $x231802 $x223890 $x244068 $x207635 (and (distinct (bvor ?x259293 ?x206040) ?x207227) true))))))))))
(check-sat)
