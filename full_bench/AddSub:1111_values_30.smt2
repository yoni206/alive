...
(assert
 ...
 (let (($x6535 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x4072) ?x4072)) true)))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 36)) true) (= (bvand C2 (bvsub C2 (_ bv1 36))) (_ bv0 36))) (not (= (bvand C2 (bvshl (_ bv68719476735 36) ?x4072)) (_ bv0 36))) $x6535)))))))))))))))))))
(check-sat)
