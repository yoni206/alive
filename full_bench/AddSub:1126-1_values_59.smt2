...
(assert
 ...
 (let ((?x6246 (bvsub (bvsub (_ bv64 64) ?x870) (_ bv1 64))))
 (let (($x9597 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x6246) ?x6246)) true)))
 (let (($x9185 (= |ana_MaskedValueIsZero(%Y, (-1 << (log2(C1) + 1)))| (_ bv1 1))))
 (and (=> $x9185 (= (bvand %Y (bvshl (_ bv18446744073709551615 64) (bvadd ?x870 (_ bv1 64)))) (_ bv0 64))) (= C2 (bvneg C1)) (and (and (distinct C1 (_ bv0 64)) true) (= (bvand C1 (bvsub C1 (_ bv1 64))) (_ bv0 64))) $x9185 $x9597))))))))))))))))))))))))))
(check-sat)
