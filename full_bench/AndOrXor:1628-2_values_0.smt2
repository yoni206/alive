...
(assert
 (let ((?x244855 (bvadd (bvand %A (bvnot (bvxor C1 C2))) (ite (bvugt C1 C2) C1 C2))))
 (let ((?x271492 (ite (bvule (bvadd %A C2) C3) (_ bv1 1) (_ bv0 1))))
 (let ((?x265247 (ite (bvule (bvadd %A C1) C3) (_ bv1 1) (_ bv0 1))))
 ...
 (and $x250469 $x258418 $x253608 $x255408 $x272566 $x276061 $x219137 (and (distinct (bvor ?x265247 ?x271492) (ite (bvule ?x244855 C3) (_ bv1 1) (_ bv0 1))) true))))))))))))))))
(check-sat)
