...
(assert
 ...
 (let (($x2470 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x615) ?x615)) true)))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 23)) true) (= (bvand C2 (bvsub C2 (_ bv1 23))) (_ bv0 23))) (not (= (bvand C2 (bvshl (_ bv8388607 23) ?x615)) (_ bv0 23))) $x2470)))))))))))))))
(check-sat)
