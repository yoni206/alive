...
(assert
 ...
 (let ((?x37410 (bvshl (_ bv34359738367 35) (bvadd (ite (and (distinct ((_ extract 34 18) C2) (_ bv0 17)) true) ?x20990 ?x20665) (_ bv1 35)))))
 (let (($x37371 (=> $x7212 (= (bvand %Y ?x37410) (_ bv0 35)))))
 (and $x37371 $x16030 $x21449 $x7212 (and (distinct ?x21005 (bvashr (bvshl %Y ?x20486) ?x20486)) true))))))))))))))))))))))))
(check-sat)
