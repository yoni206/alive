...
(assert
 ...
 (let ((?x26751 (bvsub (_ bv50 50) (bvsub (bvsub (_ bv50 50) ?x26757) (_ bv1 50)))))
 (let (($x26674 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x26751) ?x26751)) true)))
 (let (($x26702 (not (= (bvand C2 (bvshl (_ bv1125899906842623 50) ?x26751)) (_ bv0 50)))))
 (let (($x26714 (and (and (distinct C2 (_ bv0 50)) true) (= (bvand C2 (bvsub C2 (_ bv1 50))) (_ bv0 50)))))
 (let (($x26724 (= C1 (bvneg C2))))
 (and $x26724 $x26714 $x26702 $x26674))))))))))))))))))))))))))))
(check-sat)
