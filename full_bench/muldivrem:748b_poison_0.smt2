...
(assert
 (let (($x375423 (not (= (bvmul (bvsdiv %X (bvsdiv C2 C1)) (bvsdiv C2 C1)) %X))))
 (let (($x412704 (= (bvsrem C2 C1) (_ bv0 7))))
 (let ((?x359060 (bvmul %X C1)))
 (let (($x406913 (= (bvmul (bvsdiv ?x359060 C2) C2) ?x359060)))
 ...
 (and $x32989 $x399566 $x383119 $x406913 $x412704 $x375423)))))))))
(check-sat)
