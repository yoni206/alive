...
(assert
 ...
 (let (($x17560 (and (distinct (ite (= (ite (= (bvand %Op C) (_ bv0 53)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3) (bvadd (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x7161) ?x11106) C2)) true)))
 ...
 (and (and (and (distinct C (_ bv0 53)) true) (= (bvand C (bvsub C (_ bv1 53))) (_ bv0 53))) $x6187 (bvslt ?x14642 (_ bv11 32)) $x17560)))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
