...
(assert
 ...
 (let ((?x3539 (bvsub (bvsub (_ bv14 14) ?x4153) (_ bv1 14))))
 ...
 (let (($x31973 (=> $x7212 (= (bvand %Y (bvshl (_ bv16383 14) (bvadd ?x4153 (_ bv1 14)))) (_ bv0 14)))))
 (and $x31973 $x18928 $x6676 $x7212 (and (distinct ?x4993 (bvashr (bvshl %Y ?x3539) ?x3539)) true)))))))))))))))
(check-sat)
