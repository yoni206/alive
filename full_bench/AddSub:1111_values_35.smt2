...
(assert
 ...
 (let (($x7363 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x1734) ?x1734)) true)))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 41)) true) (= (bvand C2 (bvsub C2 (_ bv1 41))) (_ bv0 41))) (not (= (bvand C2 (bvshl (_ bv2199023255551 41) ?x1734)) (_ bv0 41))) $x7363))))))))))))))))))))))))
(check-sat)
