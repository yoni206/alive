...
(assert
 ...
 (let ((?x5791 (bvand %X C1)))
 (let ((?x4326 (bvor %Y C2)))
 (let (($x5748 (and (distinct (ite (= (ite (and (distinct ?x5791 (_ bv0 40)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y ?x4326) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x5791 ?x3861)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 40)) true) (= (bvand C1 (bvsub C1 (_ bv1 40))) (_ bv0 40))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x3344 (ite (and (distinct ((_ extract 39 20) C1) (_ bv0 20)) true) ?x3154 ?x5112)) $x5748))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
