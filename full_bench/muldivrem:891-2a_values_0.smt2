...
(assert
 ...
 (and $x16486 (and (distinct (bvshl C %N) (_ bv0 13)) true) (and (and (distinct C (_ bv0 13)) true) (= (bvand C (bvsub C (_ bv1 13))) (_ bv0 13))) (and (distinct (bvudiv %x (bvshl C %N)) (bvlshr %x ?x11834)) true))))))))))
(check-sat)
