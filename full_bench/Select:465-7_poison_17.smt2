...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 25)) true) (= (bvand C1 (bvsub C1 (_ bv1 25))) (_ bv0 25))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x4072 (ite (and (distinct ((_ extract 24 13) C1) (_ bv0 12)) true) ?x2056 ?x3413)) false)))))))))))))))))
(check-sat)
