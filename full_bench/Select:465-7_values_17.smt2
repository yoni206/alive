...
(assert
 ...
 (let ((?x3460 (bvand %X C1)))
 (let (($x4208 (and (distinct (ite (= (ite (= ?x3460 (_ bv0 25)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) (bvor %Y C2) %Y) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x3460 ?x5063)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 25)) true) (= (bvand C1 (bvsub C1 (_ bv1 25))) (_ bv0 25))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x4072 (ite (and (distinct ((_ extract 24 13) C1) (_ bv0 12)) true) ?x2056 ?x3413)) $x4208)))))))))))))))))))))))))))))))))))
(check-sat)
