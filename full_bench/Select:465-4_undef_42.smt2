...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 50)) true) (= (bvand C1 (bvsub C1 (_ bv1 50))) (_ bv0 50))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x3891 ?x6247) (not (bvult ?x6163 (_ bv50 50))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
