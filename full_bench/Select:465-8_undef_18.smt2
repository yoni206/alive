...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 19)) true) (= (bvand C1 (bvsub C1 (_ bv1 19))) (_ bv0 19))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x6140 ?x3301) (not (bvult ?x5877 (_ bv19 19))))))))))))))))))))))))))))))))
(check-sat)
