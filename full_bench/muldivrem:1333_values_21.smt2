...
(assert
 ...
 (let (($x424876 (=> $x429777 (= (bvand %Op1 (bvshl (_ bv1 25) (bvsub (_ bv25 25) (_ bv1 25)))) (_ bv0 25)))))
 ...
 (and $x418691 $x463956 $x424876 $x470547 $x429777 $x365594 (and (distinct (bvsrem %Op0 %Op1) (bvurem %Op0 %Op1)) true)))))))))
(check-sat)
