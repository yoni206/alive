...
(assert
 ...
 (let (($x11207 (bvult ?x4491 (_ bv7 7))))
 ...
 (and (=> $x10515 (= (bvand %Y ?x11192) (_ bv0 7))) (= C2 (bvneg C1)) (and (and (distinct C1 (_ bv0 7)) true) (= (bvand C1 (bvsub C1 (_ bv1 7))) (_ bv0 7))) $x10515 (not (and $x11207 $x11207))))))))))
(check-sat)
