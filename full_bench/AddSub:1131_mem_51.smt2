...
(assert
 ...
 (and (= (bvand |ana_computeKnownZeroBits(%Y)| %Y) (_ bv0 53)) (= u_%LHS (_ bv1 8)) $x4239 (= (bvor C2 |ana_computeKnownZeroBits(%Y)|) (_ bv9007199254740991 53)) (and (distinct mem0 mem0) true))))
(check-sat)
