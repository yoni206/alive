...
(assert
 ...
 (let ((?x9387 (bvand %X C1)))
 (let ((?x21518 (bvor %Y C2)))
 (let (($x16551 (and (distinct (ite (= (ite (and (distinct ?x9387 (_ bv0 60)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y ?x21518) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x9387 ?x16980)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 60)) true) (= (bvand C1 (bvsub C1 (_ bv1 60))) (_ bv0 60))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x5323 ?x19361) $x16551))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
