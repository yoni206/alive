...
(assert
 ...
 (let ((?x1014 (bvand %X C1)))
 (let (($x11318 (and (distinct (ite (= (ite (= ?x1014 (_ bv0 36)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y (bvor %Y C2)) (bvor ((_ extract 10 0) (bvlshr ?x1014 ?x21127)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 36)) true) (= (bvand C1 (bvsub C1 (_ bv1 36))) (_ bv0 36))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x9110 (ite (and (distinct ((_ extract 35 18) C1) (_ bv0 18)) true) ?x4808 ?x21889)) $x11318)))))))))))))))))))))))))))))))))))))))))))
(check-sat)
