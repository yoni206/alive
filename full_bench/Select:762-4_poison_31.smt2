...
(assert
 ...
 (and (and (and (distinct C (_ bv0 36)) true) (= (bvand C (bvsub C (_ bv1 36))) (_ bv0 36))) $x2215 (bvslt (ite (and (distinct ((_ extract 35 18) C) (_ bv0 18)) true) ?x7755 ?x4929) (_ bv11 32)) false)))))))))))))))))
(check-sat)
