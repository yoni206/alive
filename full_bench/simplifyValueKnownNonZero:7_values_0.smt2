...
(assert
 (let (($x420538 (and (distinct (bvurem %X (bvlshr (bvshl (_ bv1 33) %A) %B)) (bvurem %X (bvshl (_ bv1 33) (bvsub %A %B)))) true)))
 ...
 (and $x126102 $x123723 $x127864 $x126102 $x123723 $x126099 $x420538)))))))))
(check-sat)
