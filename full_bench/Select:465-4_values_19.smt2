...
(assert
 ...
 (let ((?x4365 (bvand %X C1)))
 (let ((?x2692 (bvor %Y C2)))
 (let (($x3532 (and (distinct (ite (= (ite (and (distinct ?x4365 (_ bv0 27)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y ?x2692) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x4365 ?x6306)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 27)) true) (= (bvand C1 (bvsub C1 (_ bv1 27))) (_ bv0 27))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x4858 (ite (and (distinct ((_ extract 26 14) C1) (_ bv0 13)) true) ?x3705 ?x3710)) $x3532))))))))))))))))))))))))))))))))))))
(check-sat)
