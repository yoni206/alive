...
(assert
 ...
 (and (=> $x9185 (= (bvand %Y (bvshl (_ bv18446744073709551615 64) (bvadd ?x870 (_ bv1 64)))) (_ bv0 64))) (= C2 (bvneg C1)) (and (and (distinct C1 (_ bv0 64)) true) (= (bvand C1 (bvsub C1 (_ bv1 64))) (_ bv0 64))) $x9185 (and (distinct mem0 mem0) true)))))))))))))))))))))))))
(check-sat)
