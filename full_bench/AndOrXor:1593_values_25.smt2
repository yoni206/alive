...
(assert
 (let ((?x208793 (ite (and (distinct (bvand %A (bvor %K1 %K2)) (bvor %K1 %K2)) true) (_ bv1 1) (_ bv0 1))))
 (let ((?x256900 (ite (= (bvand %A %K2) (_ bv0 33)) (_ bv1 1) (_ bv0 1))))
 (let ((?x196424 (ite (= (bvand %A %K1) (_ bv0 33)) (_ bv1 1) (_ bv0 1))))
 ...
 (and $x203134 $x267743 $x244068 $x207635 (and (distinct (bvor ?x196424 ?x256900) ?x208793) true))))))))))
(check-sat)
