...
(assert
 ...
 (let ((?x1427 (ite (and (distinct ((_ extract 2 2) ?x8380) (_ bv0 1)) true) (_ bv2 11) (ite (and (distinct ((_ extract 1 1) ?x8380) (_ bv0 1)) true) (_ bv1 11) (_ bv0 11)))))
 (let ((?x2656 (ite (and (distinct ((_ extract 5 5) ?x8380) (_ bv0 1)) true) (_ bv5 11) (ite (and (distinct ((_ extract 4 4) ?x8380) (_ bv0 1)) true) (_ bv4 11) (_ bv3 11)))))
 (let ((?x6794 (ite (and (distinct ((_ extract 8 8) ?x8380) (_ bv0 1)) true) (_ bv8 11) (ite (and (distinct ((_ extract 7 7) ?x8380) (_ bv0 1)) true) (_ bv7 11) (_ bv6 11)))))
 (let ((?x3354 (ite (and (distinct ((_ extract 10 9) ?x8380) (_ bv0 2)) true) (ite (and (distinct ((_ extract 10 10) ?x8380) (_ bv0 1)) true) (_ bv10 11) (_ bv9 11)) ?x6794)))
 (let ((?x2715 (ite (and (distinct ((_ extract 10 6) ?x8380) (_ bv0 5)) true) ?x3354 (ite (and (distinct ((_ extract 5 3) ?x8380) (_ bv0 3)) true) ?x2656 ?x1427))))
 ...
 (let ((?x7120 (bvadd (bvxor (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x7143) ?x7439) ?x8380) C3)))
 (let (($x1928 (and (distinct (ite (= (ite (= (bvand %Op C) (_ bv0 22)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3) ?x7120) true)))
 ...
 (and (and (and (distinct C (_ bv0 22)) true) (= (bvand C (bvsub C (_ bv1 22))) (_ bv0 22))) (and (and (distinct ?x8380 (_ bv0 11)) true) (= (bvand ?x8380 (bvsub ?x8380 (_ bv1 11))) (_ bv0 11))) (bvslt (ite (and (distinct ((_ extract 21 11) C) (_ bv0 11)) true) ?x3363 ?x1279) (_ bv11 32)) $x1928))))))))))))))))))))))))))))))))))
(check-sat)
