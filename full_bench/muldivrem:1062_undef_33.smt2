...
(assert
 ...
 (let (($x454928 (=> $x472207 (= (bvand %Op1 (bvshl (_ bv1 35) (bvsub (_ bv35 35) (_ bv1 35)))) (_ bv0 35)))))
 (let (($x454868 (=> $x365594 (= (bvand %Op0 (bvshl (_ bv1 35) (bvsub (_ bv35 35) (_ bv1 35)))) (_ bv0 35)))))
 (let (($x466668 (and (distinct %Op1 (_ bv0 35)) true)))
 (and $x466668 (or (and (distinct %Op0 (_ bv17179869184 35)) true) (and (distinct %Op1 (_ bv34359738367 35)) true)) $x454868 $x454928 $x365594 $x472207 (not $x466668))))))))
(check-sat)
