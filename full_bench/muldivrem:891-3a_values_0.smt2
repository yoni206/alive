...
(assert
 ...
 (let (($x3682 (and (distinct (bvudiv %x ((_ zero_extend 9) (bvshl C %N))) (bvlshr %x ?x2455)) true)))
 (let (($x5514 (bvult %N (_ bv4 4))))
 (and $x5514 (and (distinct ((_ zero_extend 9) (bvshl C %N)) (_ bv0 13)) true) (and (and (distinct C (_ bv0 4)) true) (= (bvand C (bvsub C (_ bv1 4))) (_ bv0 4))) $x3682))))))
(check-sat)
