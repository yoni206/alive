...
(assert
 ...
 (let (($x1151 (and (distinct (ite (= (ite (= (bvand %Op C) (_ bv0 49)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3) (bvadd (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x1545) ?x7208) C2)) true)))
 ...
 (and (and (and (distinct C (_ bv0 49)) true) (= (bvand C (bvsub C (_ bv1 49))) (_ bv0 49))) $x2829 (bvslt ?x7118 (_ bv11 32)) $x1151)))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
