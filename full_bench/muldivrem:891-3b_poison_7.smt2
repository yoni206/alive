...
(assert
 ...
 (and $x13351 (and (distinct ?x12451 (_ bv0 13)) true) (= (bvmul (bvudiv %x ?x12451) ?x12451) %x) (and (and (distinct C (_ bv0 11)) true) (= (bvand C (bvsub C (_ bv1 11))) (_ bv0 11))) (not (= (bvshl (bvlshr %x ?x18505) ?x18505) %x)))))))))))))
(check-sat)
