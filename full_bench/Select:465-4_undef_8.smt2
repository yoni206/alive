...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 16)) true) (= (bvand C1 (bvsub C1 (_ bv1 16))) (_ bv0 16))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x2817 ?x2416) (not (bvult ?x1437 (_ bv16 16))))))))))))))))))))))))))
(check-sat)
