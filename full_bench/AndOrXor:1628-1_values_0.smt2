...
(assert
 ...
 (let ((?x269781 (ite (bvult (bvadd %A C2) C3) (_ bv1 1) (_ bv0 1))))
 (let ((?x228857 (ite (bvult (bvadd %A C1) C3) (_ bv1 1) (_ bv0 1))))
 ...
 (and $x250469 $x258418 $x253608 $x255408 $x272566 $x276061 $x219137 (and (distinct (bvor ?x228857 ?x269781) (ite (bvult ?x244855 C3) (_ bv1 1) (_ bv0 1))) true))))))))))))))))
(check-sat)
