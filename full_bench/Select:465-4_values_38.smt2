...
(assert
 ...
 (let ((?x6256 (bvand %X C1)))
 (let ((?x6245 (bvor %Y C2)))
 (let (($x6802 (and (distinct (ite (= (ite (and (distinct ?x6256 (_ bv0 46)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y ?x6245) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x6256 ?x2804)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 46)) true) (= (bvand C1 (bvsub C1 (_ bv1 46))) (_ bv0 46))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x1765 ?x6252) $x6802))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
