...
(assert
 ...
 (and (= (bvand |ana_computeKnownZeroBits(%Y)| %Y) (_ bv0 48)) (= u_%LHS (_ bv1 8)) $x9113 (= (bvor C2 |ana_computeKnownZeroBits(%Y)|) (_ bv281474976710655 48)) (and (distinct mem0 mem0) true))))
(check-sat)
