...
(assert
 ...
 (let (($x1821 (bvult ?x6246 (_ bv64 64))))
 (let (($x9185 (= |ana_MaskedValueIsZero(%Y, (-1 << (log2(C1) + 1)))| (_ bv1 1))))
 (and (=> $x9185 (= (bvand %Y (bvshl (_ bv18446744073709551615 64) (bvadd ?x870 (_ bv1 64)))) (_ bv0 64))) (= C2 (bvneg C1)) (and (and (distinct C1 (_ bv0 64)) true) (= (bvand C1 (bvsub C1 (_ bv1 64))) (_ bv0 64))) $x9185 (not (and $x1821 $x1821))))))))))))))))))))))))))))
(check-sat)
