...
(assert
 ...
 (and (= (bvand |ana_computeKnownZeroBits(%Y)| %Y) (_ bv0 44)) (= u_%LHS (_ bv1 8)) $x1871 (= (bvor C2 |ana_computeKnownZeroBits(%Y)|) (_ bv17592186044415 44)) (and (distinct mem0 mem0) true))))
(check-sat)
