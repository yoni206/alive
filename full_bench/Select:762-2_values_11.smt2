...
(assert
 ...
 (let ((?x2038 (ite (= (ite (and (distinct (bvand %Op C) (_ bv0 15)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3)))
 (let (($x2057 (and (distinct ?x2038 (bvadd (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x2457) ?x2924) C3)) true)))
 ...
 (and (and (and (distinct C (_ bv0 15)) true) (= (bvand C (bvsub C (_ bv1 15))) (_ bv0 15))) $x7034 (bvslt ?x7932 (_ bv11 32)) $x2057))))))))))))))))))))))))
(check-sat)
