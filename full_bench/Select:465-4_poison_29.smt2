...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 37)) true) (= (bvand C1 (bvsub C1 (_ bv1 37))) (_ bv0 37))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x2881 (ite (and (distinct ((_ extract 36 19) C1) (_ bv0 18)) true) ?x3499 ?x6831)) false))))))))))))))))))))))
(check-sat)
