...
(assert
 ...
 (let ((?x11131 (ite (and (distinct ((_ extract 2 2) ?x17843) (_ bv0 1)) true) (_ bv2 11) (ite (and (distinct ((_ extract 1 1) ?x17843) (_ bv0 1)) true) (_ bv1 11) (_ bv0 11)))))
 (let ((?x4615 (ite (and (distinct ((_ extract 5 5) ?x17843) (_ bv0 1)) true) (_ bv5 11) (ite (and (distinct ((_ extract 4 4) ?x17843) (_ bv0 1)) true) (_ bv4 11) (_ bv3 11)))))
 (let ((?x14076 (ite (and (distinct ((_ extract 8 8) ?x17843) (_ bv0 1)) true) (_ bv8 11) (ite (and (distinct ((_ extract 7 7) ?x17843) (_ bv0 1)) true) (_ bv7 11) (_ bv6 11)))))
 (let ((?x10369 (ite (and (distinct ((_ extract 10 9) ?x17843) (_ bv0 2)) true) (ite (and (distinct ((_ extract 10 10) ?x17843) (_ bv0 1)) true) (_ bv10 11) (_ bv9 11)) ?x14076)))
 (let ((?x4904 (ite (and (distinct ((_ extract 10 6) ?x17843) (_ bv0 5)) true) ?x10369 (ite (and (distinct ((_ extract 5 3) ?x17843) (_ bv0 3)) true) ?x4615 ?x11131))))
 ...
 (let ((?x13268 (bvadd (bvxor (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x14084) ?x10798) ?x17843) C2)))
 (let ((?x12589 (ite (= (ite (and (distinct (bvand %Op C) (_ bv0 44)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3)))
 ...
 (and (and (and (distinct C (_ bv0 44)) true) (= (bvand C (bvsub C (_ bv1 44))) (_ bv0 44))) (and (and (distinct ?x17843 (_ bv0 11)) true) (= (bvand ?x17843 (bvsub ?x17843 (_ bv1 11))) (_ bv0 11))) (bvslt ?x21031 (_ bv11 32)) (and (distinct ?x12589 ?x13268) true)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
