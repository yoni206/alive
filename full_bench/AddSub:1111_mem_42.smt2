...
(assert
 ...
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 48)) true) (= (bvand C2 (bvsub C2 (_ bv1 48))) (_ bv0 48))) (not (= (bvand C2 (bvshl (_ bv281474976710655 48) ?x5240)) (_ bv0 48))) (and (distinct mem0 mem0) true)))))))))))))))))))))))))
(check-sat)
