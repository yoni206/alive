...
(assert
 ...
 (let ((?x8185 (bvshl (_ bv134217727 27) (bvadd (ite (and (distinct ((_ extract 26 14) C2) (_ bv0 13)) true) ?x18573 ?x18943) (_ bv1 27)))))
 (let (($x14406 (=> $x7212 (= (bvand %Y ?x8185) (_ bv0 27)))))
 (and $x14406 $x23592 $x18844 $x7212 (and (distinct ?x18899 (bvashr (bvshl %Y ?x18929) ?x18929)) true)))))))))))))))))))))
(check-sat)
