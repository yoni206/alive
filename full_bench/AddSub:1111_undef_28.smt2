...
(assert
 ...
 (let (($x3643 (bvult ?x5104 (_ bv34 34))))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 34)) true) (= (bvand C2 (bvsub C2 (_ bv1 34))) (_ bv0 34))) (not (= (bvand C2 (bvshl (_ bv17179869183 34) ?x5104)) (_ bv0 34))) (not (and $x3643 $x3643)))))))))))))))))))
(check-sat)
