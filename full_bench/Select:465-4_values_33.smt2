...
(assert
 ...
 (let ((?x3639 (bvand %X C1)))
 (let ((?x2131 (bvor %Y C2)))
 (let (($x2635 (and (distinct (ite (= (ite (and (distinct ?x3639 (_ bv0 41)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y ?x2131) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x3639 ?x5782)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 41)) true) (= (bvand C1 (bvsub C1 (_ bv1 41))) (_ bv0 41))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x6120 (ite (and (distinct ((_ extract 40 21) C1) (_ bv0 20)) true) ?x3535 ?x4537)) $x2635))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
