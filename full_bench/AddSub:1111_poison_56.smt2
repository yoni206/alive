...
(assert
 ...
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 62)) true) (= (bvand C2 (bvsub C2 (_ bv1 62))) (_ bv0 62))) (not (= (bvand C2 (bvshl (_ bv4611686018427387903 62) ?x2624)) (_ bv0 62))) false))))))))))))))))))))))))
(check-sat)
