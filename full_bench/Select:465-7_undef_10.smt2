...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 18)) true) (= (bvand C1 (bvsub C1 (_ bv1 18))) (_ bv0 18))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x4119 ?x2191) (not (bvult ?x2951 (_ bv18 18))))))))))))))))))))))))))))))
(check-sat)
