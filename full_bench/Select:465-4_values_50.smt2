...
(assert
 ...
 (let ((?x24809 (bvand %X C1)))
 (let ((?x643 (bvor %Y C2)))
 (let (($x23811 (and (distinct (ite (= (ite (and (distinct ?x24809 (_ bv0 55)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y ?x643) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x24809 ?x12949)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 55)) true) (= (bvand C1 (bvsub C1 (_ bv1 55))) (_ bv0 55))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x9759 ?x3766) $x23811))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
