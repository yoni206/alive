...
(assert
 ...
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 52)) true) (= (bvand C2 (bvsub C2 (_ bv1 52))) (_ bv0 52))) (not (= (bvand C2 (bvshl (_ bv4503599627370495 52) ?x1759)) (_ bv0 52))) (and (distinct mem0 mem0) true)))))))))))))))))))))))))
(check-sat)
