...
(assert
 ...
 (let ((?x6748 (ite (and (distinct ((_ extract 2 2) ?x16073) (_ bv0 1)) true) (_ bv2 11) (ite (and (distinct ((_ extract 1 1) ?x16073) (_ bv0 1)) true) (_ bv1 11) (_ bv0 11)))))
 (let ((?x19056 (ite (and (distinct ((_ extract 5 5) ?x16073) (_ bv0 1)) true) (_ bv5 11) (ite (and (distinct ((_ extract 4 4) ?x16073) (_ bv0 1)) true) (_ bv4 11) (_ bv3 11)))))
 (let ((?x15165 (ite (and (distinct ((_ extract 8 8) ?x16073) (_ bv0 1)) true) (_ bv8 11) (ite (and (distinct ((_ extract 7 7) ?x16073) (_ bv0 1)) true) (_ bv7 11) (_ bv6 11)))))
 (let ((?x16191 (ite (and (distinct ((_ extract 10 9) ?x16073) (_ bv0 2)) true) (ite (and (distinct ((_ extract 10 10) ?x16073) (_ bv0 1)) true) (_ bv10 11) (_ bv9 11)) ?x15165)))
 (let ((?x1450 (ite (and (distinct ((_ extract 10 6) ?x16073) (_ bv0 5)) true) ?x16191 (ite (and (distinct ((_ extract 5 3) ?x16073) (_ bv0 3)) true) ?x19056 ?x6748))))
 ...
 (let ((?x3210 (bvadd (bvxor (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x8248) ?x2364) ?x16073) C3)))
 (let (($x15855 (and (distinct (ite (= (ite (= (bvand %Op C) (_ bv0 35)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3) ?x3210) true)))
 ...
 (and (and (and (distinct C (_ bv0 35)) true) (= (bvand C (bvsub C (_ bv1 35))) (_ bv0 35))) (and (and (distinct ?x16073 (_ bv0 11)) true) (= (bvand ?x16073 (bvsub ?x16073 (_ bv1 11))) (_ bv0 11))) (bvslt (ite (and (distinct ((_ extract 34 18) C) (_ bv0 17)) true) ?x534 ?x13098) (_ bv11 32)) $x15855))))))))))))))))))))))))))))))))))))))))
(check-sat)
