...
(assert
 ...
 (let ((?x1906 (bvand %X C1)))
 (let ((?x22104 (bvor %Y C2)))
 (let (($x19750 (and (distinct (ite (= (ite (and (distinct ?x1906 (_ bv0 46)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) ?x22104 %Y) (bvor ((_ extract 10 0) (bvlshr ?x1906 ?x20367)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 46)) true) (= (bvand C1 (bvsub C1 (_ bv1 46))) (_ bv0 46))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x8381 ?x9178) $x19750))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
