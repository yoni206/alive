...
(assert
 ...
 (let ((?x19940 (bvand %X C1)))
 (let (($x5029 (and (distinct (ite (= (ite (= ?x19940 (_ bv0 42)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y (bvor %Y C2)) (bvor ((_ extract 10 0) (bvlshr ?x19940 ?x18546)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 42)) true) (= (bvand C1 (bvsub C1 (_ bv1 42))) (_ bv0 42))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x1711 (ite (and (distinct ((_ extract 41 21) C1) (_ bv0 21)) true) ?x10417 ?x3075)) $x5029)))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
