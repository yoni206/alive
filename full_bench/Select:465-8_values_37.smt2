...
(assert
 ...
 (let ((?x2391 (bvand %X C1)))
 (let ((?x4825 (bvor %Y C2)))
 (let (($x2029 (and (distinct (ite (= (ite (and (distinct ?x2391 (_ bv0 38)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) ?x4825 %Y) (bvor ((_ extract 10 0) (bvlshr ?x2391 ?x4535)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 38)) true) (= (bvand C1 (bvsub C1 (_ bv1 38))) (_ bv0 38))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x6711 (ite (and (distinct ((_ extract 37 19) C1) (_ bv0 19)) true) ?x2806 ?x3547)) $x2029))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
