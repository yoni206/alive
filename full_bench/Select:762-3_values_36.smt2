...
(assert
 ...
 (let (($x6819 (and (distinct (ite (= (ite (= (bvand %Op C) (_ bv0 40)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3) (bvadd (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x1582) ?x4572) C2)) true)))
 ...
 (and (and (and (distinct C (_ bv0 40)) true) (= (bvand C (bvsub C (_ bv1 40))) (_ bv0 40))) $x1213 (bvslt (ite (and (distinct ((_ extract 39 20) C) (_ bv0 20)) true) ?x6258 ?x5970) (_ bv11 32)) $x6819)))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
