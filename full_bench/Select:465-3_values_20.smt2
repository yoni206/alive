...
(assert
 ...
 (let ((?x4567 (bvand %X C1)))
 (let (($x3332 (and (distinct (ite (= (ite (= ?x4567 (_ bv0 21)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y (bvor %Y C2)) (bvor ((_ extract 10 0) (bvlshr ?x4567 ?x2942)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 21)) true) (= (bvand C1 (bvsub C1 (_ bv1 21))) (_ bv0 21))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x2710 ?x3583) $x3332)))))))))))))))))))))))))))))))))))
(check-sat)
