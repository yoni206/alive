...
(assert
 ...
 (let (($x469891 (=> $x472207 (= (bvand %Op1 (bvshl (_ bv1 19) (bvsub (_ bv19 19) (_ bv1 19)))) (_ bv0 19)))))
 (let (($x434455 (=> $x365594 (= (bvand %Op0 (bvshl (_ bv1 19) (bvsub (_ bv19 19) (_ bv1 19)))) (_ bv0 19)))))
 (let (($x415886 (and (distinct %Op1 (_ bv0 19)) true)))
 (and $x415886 (or (and (distinct %Op0 (_ bv262144 19)) true) (and (distinct %Op1 (_ bv524287 19)) true)) $x434455 $x469891 $x365594 $x472207 (not $x415886))))))))
(check-sat)
