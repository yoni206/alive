...
(assert
 ...
 (let ((?x10942 (ite (and (distinct ((_ extract 2 2) ?x7945) (_ bv0 1)) true) (_ bv2 11) (ite (and (distinct ((_ extract 1 1) ?x7945) (_ bv0 1)) true) (_ bv1 11) (_ bv0 11)))))
 (let ((?x19800 (ite (and (distinct ((_ extract 5 5) ?x7945) (_ bv0 1)) true) (_ bv5 11) (ite (and (distinct ((_ extract 4 4) ?x7945) (_ bv0 1)) true) (_ bv4 11) (_ bv3 11)))))
 (let ((?x14577 (ite (and (distinct ((_ extract 8 8) ?x7945) (_ bv0 1)) true) (_ bv8 11) (ite (and (distinct ((_ extract 7 7) ?x7945) (_ bv0 1)) true) (_ bv7 11) (_ bv6 11)))))
 (let ((?x10893 (ite (and (distinct ((_ extract 10 9) ?x7945) (_ bv0 2)) true) (ite (and (distinct ((_ extract 10 10) ?x7945) (_ bv0 1)) true) (_ bv10 11) (_ bv9 11)) ?x14577)))
 (let ((?x17244 (ite (and (distinct ((_ extract 10 6) ?x7945) (_ bv0 5)) true) ?x10893 (ite (and (distinct ((_ extract 5 3) ?x7945) (_ bv0 3)) true) ?x19800 ?x10942))))
 ...
 (let ((?x4867 (bvadd (bvxor (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x9439) ?x2356) ?x7945) C3)))
 (let (($x19465 (and (distinct (ite (= (ite (= (bvand %Op C) (_ bv0 41)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3) ?x4867) true)))
 ...
 (and (and (and (distinct C (_ bv0 41)) true) (= (bvand C (bvsub C (_ bv1 41))) (_ bv0 41))) (and (and (distinct ?x7945 (_ bv0 11)) true) (= (bvand ?x7945 (bvsub ?x7945 (_ bv1 11))) (_ bv0 11))) (bvslt (ite (and (distinct ((_ extract 40 21) C) (_ bv0 20)) true) ?x712 ?x16399) (_ bv11 32)) $x19465))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
