...
(assert
 ...
 (let ((?x29105 (bvsub (bvsub (_ bv56 56) ?x29112) (_ bv1 56))))
 (let (($x33469 (bvult ?x29105 (_ bv56 56))))
 ...
 (let (($x36188 (=> $x7212 (= (bvand %Y (bvshl (_ bv72057594037927935 56) (bvadd ?x29112 (_ bv1 56)))) (_ bv0 56)))))
 (and $x36188 $x34625 $x29075 $x7212 (not (and $x33469 $x33469)))))))))))))))))))))))))))))))
(check-sat)
