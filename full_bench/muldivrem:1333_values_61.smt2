...
(assert
 ...
 (let (($x462040 (=> $x429777 (= (bvand %Op1 (bvshl (_ bv1 3) (bvsub (_ bv3 3) (_ bv1 3)))) (_ bv0 3)))))
 (let (($x440212 (or (and (distinct %Op0 (_ bv4 3)) true) (and (distinct %Op1 (_ bv7 3)) true))))
 (let (($x442144 (and (distinct %Op1 (_ bv0 3)) true)))
 (and $x442144 $x440212 $x462040 $x424822 $x429777 $x365594 (and (distinct (bvsrem %Op0 %Op1) (bvurem %Op0 %Op1)) true)))))))))
(check-sat)
