...
(assert
 ...
 (and (and (and (distinct C (_ bv0 54)) true) (= (bvand C (bvsub C (_ bv1 54))) (_ bv0 54))) $x2545 (bvslt ?x3732 (_ bv11 32)) (not (and (bvult ?x1513 (_ bv11 11)) (bvult ?x3966 (_ bv11 11))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
