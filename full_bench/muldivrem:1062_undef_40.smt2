...
(assert
 ...
 (let (($x447828 (=> $x472207 (= (bvand %Op1 (bvshl (_ bv1 42) (bvsub (_ bv42 42) (_ bv1 42)))) (_ bv0 42)))))
 (let (($x447769 (=> $x365594 (= (bvand %Op0 (bvshl (_ bv1 42) (bvsub (_ bv42 42) (_ bv1 42)))) (_ bv0 42)))))
 (let (($x447816 (and (distinct %Op1 (_ bv0 42)) true)))
 (and $x447816 (or (and (distinct %Op0 (_ bv2199023255552 42)) true) (and (distinct %Op1 (_ bv4398046511103 42)) true)) $x447769 $x447828 $x365594 $x472207 (not $x447816))))))))
(check-sat)
