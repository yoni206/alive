...
(assert
 ...
 (let ((?x12567 (ite (and (distinct ((_ extract 2 2) ?x12665) (_ bv0 1)) true) (_ bv2 11) (ite (and (distinct ((_ extract 1 1) ?x12665) (_ bv0 1)) true) (_ bv1 11) (_ bv0 11)))))
 (let ((?x19006 (ite (and (distinct ((_ extract 5 5) ?x12665) (_ bv0 1)) true) (_ bv5 11) (ite (and (distinct ((_ extract 4 4) ?x12665) (_ bv0 1)) true) (_ bv4 11) (_ bv3 11)))))
 (let ((?x17014 (ite (and (distinct ((_ extract 8 8) ?x12665) (_ bv0 1)) true) (_ bv8 11) (ite (and (distinct ((_ extract 7 7) ?x12665) (_ bv0 1)) true) (_ bv7 11) (_ bv6 11)))))
 (let ((?x23809 (ite (and (distinct ((_ extract 10 9) ?x12665) (_ bv0 2)) true) (ite (and (distinct ((_ extract 10 10) ?x12665) (_ bv0 1)) true) (_ bv10 11) (_ bv9 11)) ?x17014)))
 (let ((?x17289 (ite (and (distinct ((_ extract 10 6) ?x12665) (_ bv0 5)) true) ?x23809 (ite (and (distinct ((_ extract 5 3) ?x12665) (_ bv0 3)) true) ?x19006 ?x12567))))
 ...
 (let ((?x10330 (bvadd (bvxor (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x23732) ?x3368) ?x12665) C2)))
 (let ((?x14869 (ite (= (ite (and (distinct (bvand %Op C) (_ bv0 20)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3)))
 ...
 (and (and (and (distinct C (_ bv0 20)) true) (= (bvand C (bvsub C (_ bv1 20))) (_ bv0 20))) (and (and (distinct ?x12665 (_ bv0 11)) true) (= (bvand ?x12665 (bvsub ?x12665 (_ bv1 11))) (_ bv0 11))) (bvslt ?x6279 (_ bv11 32)) (and (distinct ?x14869 ?x10330) true)))))))))))))))))))))))))))))))))
(check-sat)
