...
(assert
 ...
 (let ((?x31187 (bvsub (_ bv61 61) (bvsub (bvsub (_ bv61 61) ?x31193) (_ bv1 61)))))
 (let (($x31606 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x31187) ?x31187)) true)))
 (let (($x31595 (not (= (bvand C2 (bvshl (_ bv2305843009213693951 61) ?x31187)) (_ bv0 61)))))
 (let (($x31592 (and (and (distinct C2 (_ bv0 61)) true) (= (bvand C2 (bvsub C2 (_ bv1 61))) (_ bv0 61)))))
 (let (($x31587 (= C1 (bvneg C2))))
 (and $x31587 $x31592 $x31595 $x31606))))))))))))))))))))))))))))
(check-sat)
