...
(assert
 ...
 (let (($x442140 (=> $x472207 (= (bvand %Op1 (bvshl (_ bv1 4) (bvsub (_ bv4 4) (_ bv1 4)))) (_ bv0 4)))))
 (let (($x430518 (=> $x365594 (= (bvand %Op0 (bvshl (_ bv1 4) (bvsub (_ bv4 4) (_ bv1 4)))) (_ bv0 4)))))
 (let (($x434013 (and (distinct %Op1 (_ bv0 4)) true)))
 (and $x434013 (or (and (distinct %Op0 (_ bv8 4)) true) (and (distinct %Op1 (_ bv15 4)) true)) $x430518 $x442140 $x365594 $x472207 (not $x434013))))))))
(check-sat)
