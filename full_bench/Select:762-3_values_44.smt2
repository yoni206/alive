...
(assert
 ...
 (let (($x7402 (and (distinct (ite (= (ite (= (bvand %Op C) (_ bv0 48)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3) (bvadd (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x5807) ?x4098) C2)) true)))
 ...
 (and (and (and (distinct C (_ bv0 48)) true) (= (bvand C (bvsub C (_ bv1 48))) (_ bv0 48))) $x2225 (bvslt ?x1966 (_ bv11 32)) $x7402)))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
