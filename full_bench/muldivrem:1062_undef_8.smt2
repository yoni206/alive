...
(assert
 ...
 (let (($x433880 (=> $x472207 (= (bvand %Op1 (bvshl (_ bv1 10) (bvsub (_ bv10 10) (_ bv1 10)))) (_ bv0 10)))))
 (let (($x435554 (=> $x365594 (= (bvand %Op0 (bvshl (_ bv1 10) (bvsub (_ bv10 10) (_ bv1 10)))) (_ bv0 10)))))
 (let (($x405787 (and (distinct %Op1 (_ bv0 10)) true)))
 (and $x405787 (or (and (distinct %Op0 (_ bv512 10)) true) (and (distinct %Op1 (_ bv1023 10)) true)) $x435554 $x433880 $x365594 $x472207 (not $x405787))))))))
(check-sat)
