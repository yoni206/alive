...
(assert
 ...
 (let ((?x27570 (bvsub (bvsub (_ bv9 9) (ite (and (distinct ((_ extract 8 5) C1) (_ bv0 4)) true) ?x27666 ?x27603)) (_ bv1 9))))
 ...
 (and $x3520 $x3066 $x2429 $x8887 (and (distinct ?x3105 (bvashr (bvshl %Y ?x27570) ?x27570)) true))))))))))))))
(check-sat)
