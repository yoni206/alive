...
(assert
 ...
 (and (= (bvand |ana_computeKnownZeroBits(%Y)| %Y) (_ bv0 51)) (= u_%LHS (_ bv1 8)) $x3830 (= (bvor C2 |ana_computeKnownZeroBits(%Y)|) (_ bv2251799813685247 51)) (and (distinct mem0 mem0) true))))
(check-sat)
