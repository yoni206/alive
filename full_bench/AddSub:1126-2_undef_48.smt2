...
(assert
 ...
 (let ((?x27911 (bvsub (bvsub (_ bv53 53) ?x27918) (_ bv1 53))))
 (let (($x34525 (bvult ?x27911 (_ bv53 53))))
 ...
 (let (($x23928 (=> $x7212 (= (bvand %Y (bvshl (_ bv9007199254740991 53) (bvadd ?x27918 (_ bv1 53)))) (_ bv0 53)))))
 (and $x23928 $x33915 $x27872 $x7212 (not (and $x34525 $x34525)))))))))))))))))))))))))))))))
(check-sat)
