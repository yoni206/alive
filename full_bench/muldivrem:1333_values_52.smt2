...
(assert
 ...
 (let (($x467081 (=> $x429777 (= (bvand %Op1 (bvshl (_ bv1 56) (bvsub (_ bv56 56) (_ bv1 56)))) (_ bv0 56)))))
 ...
 (and $x472033 $x384439 $x467081 $x466987 $x429777 $x365594 (and (distinct (bvsrem %Op0 %Op1) (bvurem %Op0 %Op1)) true)))))))))
(check-sat)
