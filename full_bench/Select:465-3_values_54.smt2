...
(assert
 ...
 (let ((?x5979 (bvand %X C1)))
 (let (($x4701 (and (distinct (ite (= (ite (= ?x5979 (_ bv0 55)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y (bvor %Y C2)) (bvor ((_ extract 10 0) (bvlshr ?x5979 ?x2561)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 55)) true) (= (bvand C1 (bvsub C1 (_ bv1 55))) (_ bv0 55))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x5040 ?x5146) $x4701)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
