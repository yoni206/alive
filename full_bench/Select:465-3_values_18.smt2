...
(assert
 ...
 (let ((?x18332 (bvand %X C1)))
 (let (($x12318 (and (distinct (ite (= (ite (= ?x18332 (_ bv0 20)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y (bvor %Y C2)) (bvor ((_ extract 10 0) (bvlshr ?x18332 ?x10903)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 20)) true) (= (bvand C1 (bvsub C1 (_ bv1 20))) (_ bv0 20))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x8850 ?x13430) $x12318)))))))))))))))))))))))))))))))))
(check-sat)
