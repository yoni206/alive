...
(assert
 ...
 (let ((?x12251 (bvand %X C1)))
 (let (($x13273 (and (distinct (ite (= (ite (= ?x12251 (_ bv0 40)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) (bvor %Y C2) %Y) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x12251 ?x21264)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 40)) true) (= (bvand C1 (bvsub C1 (_ bv1 40))) (_ bv0 40))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x11523 (ite (and (distinct ((_ extract 39 20) C1) (_ bv0 20)) true) ?x10681 ?x23536)) $x13273)))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
