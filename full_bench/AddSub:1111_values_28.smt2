...
(assert
 ...
 (let (($x5825 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x5104) ?x5104)) true)))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 34)) true) (= (bvand C2 (bvsub C2 (_ bv1 34))) (_ bv0 34))) (not (= (bvand C2 (bvshl (_ bv17179869183 34) ?x5104)) (_ bv0 34))) $x5825)))))))))))))))))
(check-sat)
