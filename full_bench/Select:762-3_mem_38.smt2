...
(assert
 ...
 (and (and (and (distinct C (_ bv0 42)) true) (= (bvand C (bvsub C (_ bv1 42))) (_ bv0 42))) $x5788 (bvslt (ite (and (distinct ((_ extract 41 21) C) (_ bv0 21)) true) ?x2982 ?x6933) (_ bv11 32)) (and (distinct mem0 mem0) true))))))))))))))))))))))))
(check-sat)
