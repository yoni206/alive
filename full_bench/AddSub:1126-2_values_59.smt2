...
(assert
 ...
 (let ((?x32914 (bvsub (bvsub (_ bv64 64) ?x32912) (_ bv1 64))))
 ...
 (let (($x37697 (=> $x7212 (= (bvand %Y (bvshl (_ bv18446744073709551615 64) (bvadd ?x32912 (_ bv1 64)))) (_ bv0 64)))))
 (and $x37697 $x36910 $x32929 $x7212 (and (distinct ?x32919 (bvashr (bvshl %Y ?x32914) ?x32914)) true)))))))))))))))))))))))))))))))
(check-sat)
