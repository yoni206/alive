...
(assert
 ...
 (and (= (bvand |ana_computeKnownZeroBits(%Y)| %Y) (_ bv0 56)) (= u_%LHS (_ bv1 8)) $x4529 (= (bvor C2 |ana_computeKnownZeroBits(%Y)|) (_ bv72057594037927935 56)) (and (distinct mem0 mem0) true))))
(check-sat)
