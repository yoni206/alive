...
(assert
 ...
 (let (($x19178 (and (distinct (ite (= (ite (= (bvand %Op C) (_ bv0 62)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3) (bvadd (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x10331) ?x12396) C2)) true)))
 ...
 (and (and (and (distinct C (_ bv0 62)) true) (= (bvand C (bvsub C (_ bv1 62))) (_ bv0 62))) $x3458 (bvslt ?x17233 (_ bv11 32)) $x19178)))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
