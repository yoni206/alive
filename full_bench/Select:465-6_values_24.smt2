...
(assert
 ...
 (let ((?x13657 (bvor %Y C2)))
 (let ((?x8074 (ite (= (ite (and (distinct (bvand %X C1) (_ bv0 25)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) ?x13657 %Y)))
 ...
 (and (and (and (distinct C1 (_ bv0 25)) true) (= (bvand C1 (bvsub C1 (_ bv1 25))) (_ bv0 25))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvsge ?x7994 (ite (and (distinct ((_ extract 24 13) C1) (_ bv0 12)) true) ?x3716 ?x11284)) (and (distinct ?x8074 (bvor (bvshl ((_ extract 10 0) (bvand %X C1)) ?x10876) %Y)) true))))))))))))))))))))))))))))))))))))
(check-sat)
