...
(assert
 ...
 (and (and (and (distinct C (_ bv0 62)) true) (= (bvand C (bvsub C (_ bv1 62))) (_ bv0 62))) $x2446 (bvslt ?x6638 (_ bv11 32)) (not (and (bvult ?x3338 (_ bv11 11)) (bvult ?x3800 (_ bv11 11))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
