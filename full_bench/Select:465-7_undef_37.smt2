...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 45)) true) (= (bvand C1 (bvsub C1 (_ bv1 45))) (_ bv0 45))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x3890 ?x5516) (not (bvult ?x5017 (_ bv45 45))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
