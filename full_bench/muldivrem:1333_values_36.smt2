...
(assert
 ...
 (let (($x481234 (=> $x429777 (= (bvand %Op1 (bvshl (_ bv1 40) (bvsub (_ bv40 40) (_ bv1 40)))) (_ bv0 40)))))
 ...
 (and $x455206 $x449861 $x481234 $x449686 $x429777 $x365594 (and (distinct (bvsrem %Op0 %Op1) (bvurem %Op0 %Op1)) true)))))))))
(check-sat)
