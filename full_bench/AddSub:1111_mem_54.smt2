...
(assert
 ...
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 60)) true) (= (bvand C2 (bvsub C2 (_ bv1 60))) (_ bv0 60))) (not (= (bvand C2 (bvshl (_ bv1152921504606846975 60) ?x3937)) (_ bv0 60))) (and (distinct mem0 mem0) true)))))))))))))))))))))))))
(check-sat)
