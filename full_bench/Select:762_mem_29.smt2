...
(assert
 ...
 (and (and (and (distinct C (_ bv0 33)) true) (= (bvand C (bvsub C (_ bv1 33))) (_ bv0 33))) $x14586 (bvslt (ite (and (distinct ((_ extract 32 17) C) (_ bv0 16)) true) ?x294 ?x14084) (_ bv11 32)) (and (distinct mem0 mem0) true)))))))))))))))
(check-sat)
