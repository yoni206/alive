...
(assert
 ...
 (let (($x7038 (bvult ?x3792 (_ bv40 40))))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 40)) true) (= (bvand C2 (bvsub C2 (_ bv1 40))) (_ bv0 40))) (not (= (bvand C2 (bvshl (_ bv1099511627775 40) ?x3792)) (_ bv0 40))) (not (and $x7038 $x7038)))))))))))))))))))))))))
(check-sat)
