...
(assert
 ...
 (and (and (and (distinct C (_ bv0 40)) true) (= (bvand C (bvsub C (_ bv1 40))) (_ bv0 40))) $x1213 (bvslt (ite (and (distinct ((_ extract 39 20) C) (_ bv0 20)) true) ?x6258 ?x5970) (_ bv11 32)) false)))))))))))))))))))))
(check-sat)
