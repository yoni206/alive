...
(assert
 ...
 (and (= (bvand |ana_computeKnownZeroBits(%Y)| %Y) (_ bv0 64)) (= u_%LHS (_ bv1 8)) $x1767 (= (bvor C2 |ana_computeKnownZeroBits(%Y)|) (_ bv18446744073709551615 64)) (and (distinct mem0 mem0) true))))
(check-sat)
