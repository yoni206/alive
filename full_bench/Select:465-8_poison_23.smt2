...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 24)) true) (= (bvand C1 (bvsub C1 (_ bv1 24))) (_ bv0 24))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x6727 (ite (and (distinct ((_ extract 23 12) C1) (_ bv0 12)) true) ?x3485 ?x4859)) false)))))))))))))))))
(check-sat)
