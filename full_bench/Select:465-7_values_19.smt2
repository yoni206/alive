...
(assert
 ...
 (let ((?x10185 (bvand %X C1)))
 (let (($x14374 (and (distinct (ite (= (ite (= ?x10185 (_ bv0 24)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) (bvor %Y C2) %Y) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x10185 ?x9770)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 24)) true) (= (bvand C1 (bvsub C1 (_ bv1 24))) (_ bv0 24))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x22439 (ite (and (distinct ((_ extract 23 12) C1) (_ bv0 12)) true) ?x16925 ?x12273)) $x14374)))))))))))))))))))))))))))))))))))
(check-sat)
