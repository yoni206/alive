...
(assert
 ...
 (let ((?x5988 (bvand %X C1)))
 (let (($x4568 (and (distinct (ite (= (ite (= ?x5988 (_ bv0 27)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) (bvor %Y C2) %Y) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x5988 ?x3918)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 27)) true) (= (bvand C1 (bvsub C1 (_ bv1 27))) (_ bv0 27))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x3764 (ite (and (distinct ((_ extract 26 14) C1) (_ bv0 13)) true) ?x2913 ?x4422)) $x4568)))))))))))))))))))))))))))))))))))
(check-sat)
