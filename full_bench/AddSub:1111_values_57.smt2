...
(assert
 ...
 (let ((?x32466 (bvsub (_ bv63 63) (bvsub (bvsub (_ bv63 63) ?x32463) (_ bv1 63)))))
 (let (($x32494 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x32466) ?x32466)) true)))
 (let (($x32483 (not (= (bvand C2 (bvshl (_ bv9223372036854775807 63) ?x32466)) (_ bv0 63)))))
 (let (($x32480 (and (and (distinct C2 (_ bv0 63)) true) (= (bvand C2 (bvsub C2 (_ bv1 63))) (_ bv0 63)))))
 (let (($x32475 (= C1 (bvneg C2))))
 (and $x32475 $x32480 $x32483 $x32494))))))))))))))))))))))))))))
(check-sat)
