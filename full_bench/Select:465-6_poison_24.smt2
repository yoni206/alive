...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 25)) true) (= (bvand C1 (bvsub C1 (_ bv1 25))) (_ bv0 25))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvsge ?x7994 (ite (and (distinct ((_ extract 24 13) C1) (_ bv0 12)) true) ?x3716 ?x11284)) false)))))))))))))))))
(check-sat)
