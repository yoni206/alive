...
(assert
 ...
 (let (($x2413 (bvult ?x468 (_ bv20 20))))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 20)) true) (= (bvand C2 (bvsub C2 (_ bv1 20))) (_ bv0 20))) (not (= (bvand C2 (bvshl (_ bv1048575 20) ?x468)) (_ bv0 20))) (not (and $x2413 $x2413)))))))))))))))
(check-sat)
