...
(assert
 ...
 (let ((?x5077 (bvand %X C1)))
 (let ((?x6787 (bvor %Y C2)))
 (let (($x5635 (and (distinct (ite (= (ite (and (distinct ?x5077 (_ bv0 42)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y ?x6787) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x5077 ?x4669)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 42)) true) (= (bvand C1 (bvsub C1 (_ bv1 42))) (_ bv0 42))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x2392 (ite (and (distinct ((_ extract 41 21) C1) (_ bv0 21)) true) ?x3257 ?x2672)) $x5635))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
