...
(assert
 ...
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 36)) true) (= (bvand C2 (bvsub C2 (_ bv1 36))) (_ bv0 36))) (not (= (bvand C2 (bvshl (_ bv68719476735 36) ?x4072)) (_ bv0 36))) (and (distinct mem0 mem0) true)))))))))))))))))))
(check-sat)
