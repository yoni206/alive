...
(assert
 ...
 (let ((?x18789 (ite (and (distinct ((_ extract 2 2) ?x14418) (_ bv0 1)) true) (_ bv2 11) (ite (and (distinct ((_ extract 1 1) ?x14418) (_ bv0 1)) true) (_ bv1 11) (_ bv0 11)))))
 (let ((?x5395 (ite (and (distinct ((_ extract 5 5) ?x14418) (_ bv0 1)) true) (_ bv5 11) (ite (and (distinct ((_ extract 4 4) ?x14418) (_ bv0 1)) true) (_ bv4 11) (_ bv3 11)))))
 (let ((?x9485 (ite (and (distinct ((_ extract 8 8) ?x14418) (_ bv0 1)) true) (_ bv8 11) (ite (and (distinct ((_ extract 7 7) ?x14418) (_ bv0 1)) true) (_ bv7 11) (_ bv6 11)))))
 (let ((?x13904 (ite (and (distinct ((_ extract 10 9) ?x14418) (_ bv0 2)) true) (ite (and (distinct ((_ extract 10 10) ?x14418) (_ bv0 1)) true) (_ bv10 11) (_ bv9 11)) ?x9485)))
 (let ((?x5999 (ite (and (distinct ((_ extract 10 6) ?x14418) (_ bv0 5)) true) ?x13904 (ite (and (distinct ((_ extract 5 3) ?x14418) (_ bv0 3)) true) ?x5395 ?x18789))))
 ...
 (let ((?x9645 (bvadd (bvxor (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x3295) ?x3129) ?x14418) C3)))
 (let (($x5989 (and (distinct (ite (= (ite (= (bvand %Op C) (_ bv0 61)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3) ?x9645) true)))
 ...
 (and (and (and (distinct C (_ bv0 61)) true) (= (bvand C (bvsub C (_ bv1 61))) (_ bv0 61))) (and (and (distinct ?x14418 (_ bv0 11)) true) (= (bvand ?x14418 (bvsub ?x14418 (_ bv1 11))) (_ bv0 11))) (bvslt ?x7951 (_ bv11 32)) $x5989))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
