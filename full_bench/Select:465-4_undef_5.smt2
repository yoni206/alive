...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 13)) true) (= (bvand C1 (bvsub C1 (_ bv1 13))) (_ bv0 13))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x6217 ?x6202) (not (bvult ?x3858 (_ bv13 13))))))))))))))))))))))))))
(check-sat)
