...
(assert
 ...
 (let ((?x23144 (bvsub (_ bv40 40) ?x23143)))
 (let (($x23070 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x23144) ?x23144)) true)))
 (let (($x23095 (not (= (bvand C2 (bvshl (_ bv1099511627775 40) ?x23144)) (_ bv0 40)))))
 (let (($x23104 (and (and (distinct C2 (_ bv0 40)) true) (= (bvand C2 (bvsub C2 (_ bv1 40))) (_ bv0 40)))))
 (let (($x23114 (= C1 (bvneg C2))))
 (and $x23114 $x23104 $x23095 $x23070))))))))))))))))))))))))))
(check-sat)
