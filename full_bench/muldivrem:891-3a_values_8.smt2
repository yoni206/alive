...
(assert
 ...
 (let (($x859 (and (distinct (bvudiv %x ((_ zero_extend 1) (bvshl C %N))) (bvlshr %x ?x9212)) true)))
 (let (($x11667 (bvult %N (_ bv12 12))))
 (and $x11667 (and (distinct ((_ zero_extend 1) (bvshl C %N)) (_ bv0 13)) true) (and (and (distinct C (_ bv0 12)) true) (= (bvand C (bvsub C (_ bv1 12))) (_ bv0 12))) $x859))))))))))
(check-sat)
