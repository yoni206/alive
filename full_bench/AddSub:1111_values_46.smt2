...
(assert
 ...
 (let (($x9209 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x1759) ?x1759)) true)))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 52)) true) (= (bvand C2 (bvsub C2 (_ bv1 52))) (_ bv0 52))) (not (= (bvand C2 (bvshl (_ bv4503599627370495 52) ?x1759)) (_ bv0 52))) $x9209)))))))))))))))))))))))))
(check-sat)
