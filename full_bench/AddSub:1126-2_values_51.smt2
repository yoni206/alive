...
(assert
 ...
 (let (($x2511 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x3824) ?x3824)) true)))
 (let (($x3052 (= |ana_MaskedValueIsZero(%Y, (-1 << (log2(C2) + 1)))| (_ bv1 1))))
 (and (=> $x3052 (= (bvand %Y (bvshl (_ bv72057594037927935 56) (bvadd ?x10111 (_ bv1 56)))) (_ bv0 56))) (= C2 (bvneg C1)) (and (and (distinct C2 (_ bv0 56)) true) (= (bvand C2 (bvsub C2 (_ bv1 56))) (_ bv0 56))) $x3052 $x2511))))))))))))))))))))))))))
(check-sat)
