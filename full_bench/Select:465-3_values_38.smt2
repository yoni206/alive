...
(assert
 ...
 (let ((?x5114 (bvand %X C1)))
 (let (($x5573 (and (distinct (ite (= (ite (= ?x5114 (_ bv0 39)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y (bvor %Y C2)) (bvor ((_ extract 10 0) (bvlshr ?x5114 ?x4476)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 39)) true) (= (bvand C1 (bvsub C1 (_ bv1 39))) (_ bv0 39))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x1861 (ite (and (distinct ((_ extract 38 20) C1) (_ bv0 19)) true) ?x1241 ?x4331)) $x5573)))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
