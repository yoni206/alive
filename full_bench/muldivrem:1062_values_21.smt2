...
(assert
 ...
 (let (($x466576 (=> $x472207 (= (bvand %Op1 (bvshl (_ bv1 23) (bvsub (_ bv23 23) (_ bv1 23)))) (_ bv0 23)))))
 (let (($x470875 (=> $x365594 (= (bvand %Op0 (bvshl (_ bv1 23) (bvsub (_ bv23 23) (_ bv1 23)))) (_ bv0 23)))))
 (let (($x430932 (or (and (distinct %Op0 (_ bv4194304 23)) true) (and (distinct %Op1 (_ bv8388607 23)) true))))
 (let (($x466722 (and (distinct %Op1 (_ bv0 23)) true)))
 (and $x466722 $x430932 $x470875 $x466576 $x365594 $x472207 (and (distinct (bvsdiv %Op0 %Op1) (bvudiv %Op0 %Op1)) true)))))))))
(check-sat)
