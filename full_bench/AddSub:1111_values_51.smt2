...
(assert
 ...
 (let ((?x29516 (bvsub (_ bv57 57) (bvsub (bvsub (_ bv57 57) ?x29519) (_ bv1 57)))))
 (let (($x29878 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x29516) ?x29516)) true)))
 (let (($x29467 (not (= (bvand C2 (bvshl (_ bv144115188075855871 57) ?x29516)) (_ bv0 57)))))
 (let (($x29482 (and (and (distinct C2 (_ bv0 57)) true) (= (bvand C2 (bvsub C2 (_ bv1 57))) (_ bv0 57)))))
 (let (($x29492 (= C1 (bvneg C2))))
 (and $x29492 $x29482 $x29467 $x29878))))))))))))))))))))))))))))
(check-sat)
