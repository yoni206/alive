...
(assert
 ...
 (let (($x1293 (bvult ?x8771 (_ bv59 59))))
 (let (($x7651 (= |ana_MaskedValueIsZero(%Y, (-1 << (log2(C2) + 1)))| (_ bv1 1))))
 (and (=> $x7651 (= (bvand %Y (bvshl (_ bv576460752303423487 59) (bvadd ?x11553 (_ bv1 59)))) (_ bv0 59))) (= C2 (bvneg C1)) (and (and (distinct C2 (_ bv0 59)) true) (= (bvand C2 (bvsub C2 (_ bv1 59))) (_ bv0 59))) $x7651 (not (and $x1293 $x1293))))))))))))))))))))))))))))
(check-sat)
