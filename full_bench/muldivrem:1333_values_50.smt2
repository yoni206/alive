...
(assert
 ...
 (let (($x465335 (=> $x429777 (= (bvand %Op1 (bvshl (_ bv1 54) (bvsub (_ bv54 54) (_ bv1 54)))) (_ bv0 54)))))
 ...
 (and $x427991 $x420433 $x465335 $x426924 $x429777 $x365594 (and (distinct (bvsrem %Op0 %Op1) (bvurem %Op0 %Op1)) true)))))))))
(check-sat)
