...
(assert
 ...
 (let ((?x4341 (ite (and (distinct ((_ extract 2 2) ?x6302) (_ bv0 1)) true) (_ bv2 11) (ite (and (distinct ((_ extract 1 1) ?x6302) (_ bv0 1)) true) (_ bv1 11) (_ bv0 11)))))
 (let ((?x1466 (ite (and (distinct ((_ extract 5 5) ?x6302) (_ bv0 1)) true) (_ bv5 11) (ite (and (distinct ((_ extract 4 4) ?x6302) (_ bv0 1)) true) (_ bv4 11) (_ bv3 11)))))
 (let ((?x2691 (ite (and (distinct ((_ extract 8 8) ?x6302) (_ bv0 1)) true) (_ bv8 11) (ite (and (distinct ((_ extract 7 7) ?x6302) (_ bv0 1)) true) (_ bv7 11) (_ bv6 11)))))
 (let ((?x1395 (ite (and (distinct ((_ extract 10 9) ?x6302) (_ bv0 2)) true) (ite (and (distinct ((_ extract 10 10) ?x6302) (_ bv0 1)) true) (_ bv10 11) (_ bv9 11)) ?x2691)))
 (let ((?x1190 (ite (and (distinct ((_ extract 10 6) ?x6302) (_ bv0 5)) true) ?x1395 (ite (and (distinct ((_ extract 5 3) ?x6302) (_ bv0 3)) true) ?x1466 ?x4341))))
 ...
 (let ((?x4622 (bvadd (bvxor (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x6741) ?x4613) ?x6302) C2)))
 (let ((?x1693 (ite (= (ite (and (distinct (bvand %Op C) (_ bv0 37)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3)))
 ...
 (and (and (and (distinct C (_ bv0 37)) true) (= (bvand C (bvsub C (_ bv1 37))) (_ bv0 37))) (and (and (distinct ?x6302 (_ bv0 11)) true) (= (bvand ?x6302 (bvsub ?x6302 (_ bv1 11))) (_ bv0 11))) (bvslt (ite (and (distinct ((_ extract 36 19) C) (_ bv0 18)) true) ?x7828 ?x6394) (_ bv11 32)) (and (distinct ?x1693 ?x4622) true)))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
