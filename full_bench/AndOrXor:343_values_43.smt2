...
(assert
 (let (($x15813 (and (distinct (bvand (bvadd (bvand %A C1) %B) C2) (bvand (bvadd %A %B) C2)) true)))
 ...
 (and (=> $x2686 (= (bvand %B (bvsub (bvshl (_ bv1 49) ?x6118) (_ bv1 49))) (_ bv0 49))) (= (bvand C1 C2) C2) $x8418 $x15813))))))))))))))))))))))))))))))))
(check-sat)
