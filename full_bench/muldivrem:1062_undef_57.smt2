...
(assert
 ...
 (let (($x450015 (=> $x472207 (= (bvand %Op1 (bvshl (_ bv1 59) (bvsub (_ bv59 59) (_ bv1 59)))) (_ bv0 59)))))
 (let (($x459219 (=> $x365594 (= (bvand %Op0 (bvshl (_ bv1 59) (bvsub (_ bv59 59) (_ bv1 59)))) (_ bv0 59)))))
 (let (($x436488 (and (distinct %Op1 (_ bv0 59)) true)))
 (and $x436488 (or (and (distinct %Op0 (_ bv288230376151711744 59)) true) (and (distinct %Op1 (_ bv576460752303423487 59)) true)) $x459219 $x450015 $x365594 $x472207 (not $x436488))))))))
(check-sat)
