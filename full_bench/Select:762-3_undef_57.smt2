...
(assert
 ...
 (and (and (and (distinct C (_ bv0 61)) true) (= (bvand C (bvsub C (_ bv1 61))) (_ bv0 61))) $x15773 (bvslt ?x9495 (_ bv11 32)) (not (and (bvult ?x14642 (_ bv11 11)) (bvult ?x5867 (_ bv11 11))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
