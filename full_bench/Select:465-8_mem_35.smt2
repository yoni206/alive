...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 36)) true) (= (bvand C1 (bvsub C1 (_ bv1 36))) (_ bv0 36))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x3085 (ite (and (distinct ((_ extract 35 18) C1) (_ bv0 18)) true) ?x3450 ?x6319)) (and (distinct mem0 mem0) true))))))))))))))))))))))
(check-sat)
