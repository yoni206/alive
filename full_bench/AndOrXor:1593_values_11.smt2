...
(assert
 (let ((?x260754 (ite (and (distinct (bvand %A (bvor %K1 %K2)) (bvor %K1 %K2)) true) (_ bv1 1) (_ bv0 1))))
 (let ((?x200702 (ite (= (bvand %A %K2) (_ bv0 19)) (_ bv1 1) (_ bv0 1))))
 (let ((?x272980 (ite (= (bvand %A %K1) (_ bv0 19)) (_ bv1 1) (_ bv0 1))))
 ...
 (and $x260595 $x259401 $x244068 $x207635 (and (distinct (bvor ?x272980 ?x200702) ?x260754) true))))))))))
(check-sat)
