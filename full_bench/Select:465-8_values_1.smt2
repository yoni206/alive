...
(assert
 ...
 (let ((?x1354 (bvand %X C1)))
 (let ((?x3598 (bvor %Y C2)))
 (let (($x3954 (and (distinct (ite (= (ite (and (distinct ?x1354 (_ bv0 8)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) ?x3598 %Y) (bvor ((_ zero_extend 3) (bvlshr ?x1354 ?x2310)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 8)) true) (= (bvand C1 (bvsub C1 (_ bv1 8))) (_ bv0 8))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x3632 (ite (and (distinct ((_ extract 7 4) C1) (_ bv0 4)) true) ?x5253 ?x1174)) $x3954))))))))))))))))))))
(check-sat)
