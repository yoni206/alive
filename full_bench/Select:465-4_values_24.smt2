...
(assert
 ...
 (let ((?x13544 (bvand %X C1)))
 (let ((?x755 (bvor %Y C2)))
 (let (($x16971 (and (distinct (ite (= (ite (and (distinct ?x13544 (_ bv0 29)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y ?x755) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x13544 ?x2271)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 29)) true) (= (bvand C1 (bvsub C1 (_ bv1 29))) (_ bv0 29))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x2724 (ite (and (distinct ((_ extract 28 15) C1) (_ bv0 14)) true) ?x8537 ?x7224)) $x16971))))))))))))))))))))))))))))))))))))
(check-sat)
