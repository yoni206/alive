...
(assert
 ...
 (let ((?x27131 (bvsub (_ bv51 51) (bvsub (bvsub (_ bv51 51) ?x27137) (_ bv1 51)))))
 (let (($x27057 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x27131) ?x27131)) true)))
 (let (($x27082 (not (= (bvand C2 (bvshl (_ bv2251799813685247 51) ?x27131)) (_ bv0 51)))))
 (let (($x27097 (and (and (distinct C2 (_ bv0 51)) true) (= (bvand C2 (bvsub C2 (_ bv1 51))) (_ bv0 51)))))
 (let (($x27107 (= C1 (bvneg C2))))
 (and $x27107 $x27097 $x27082 $x27057))))))))))))))))))))))))))))
(check-sat)
