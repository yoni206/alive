...
(assert
 ...
 (let ((?x2066 (bvand %X C1)))
 (let ((?x5229 (bvor %Y C2)))
 (let (($x2131 (and (distinct (ite (= (ite (and (distinct ?x2066 (_ bv0 52)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y ?x5229) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x2066 ?x2852)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 52)) true) (= (bvand C1 (bvsub C1 (_ bv1 52))) (_ bv0 52))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x4489 ?x2700) $x2131))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
