...
(assert
 ...
 (let ((?x26374 (bvsub (bvsub (_ bv49 49) ?x26378) (_ bv1 49))))
 (let (($x28808 (bvult ?x26374 (_ bv49 49))))
 ...
 (let (($x9283 (=> $x7212 (= (bvand %Y (bvshl (_ bv562949953421311 49) (bvadd ?x26378 (_ bv1 49)))) (_ bv0 49)))))
 (and $x9283 $x25392 $x26335 $x7212 (not (and $x28808 $x28808)))))))))))))))))))))))))))))))
(check-sat)
