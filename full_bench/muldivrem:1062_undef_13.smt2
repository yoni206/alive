...
(assert
 ...
 (let (($x432492 (=> $x472207 (= (bvand %Op1 (bvshl (_ bv1 15) (bvsub (_ bv15 15) (_ bv1 15)))) (_ bv0 15)))))
 (let (($x431044 (=> $x365594 (= (bvand %Op0 (bvshl (_ bv1 15) (bvsub (_ bv15 15) (_ bv1 15)))) (_ bv0 15)))))
 (let (($x434779 (and (distinct %Op1 (_ bv0 15)) true)))
 (and $x434779 (or (and (distinct %Op0 (_ bv16384 15)) true) (and (distinct %Op1 (_ bv32767 15)) true)) $x431044 $x432492 $x365594 $x472207 (not $x434779))))))))
(check-sat)
