...
(assert
 (let ((?x264301 (ite (and (distinct (bvand %A (bvor %K1 %K2)) (bvor %K1 %K2)) true) (_ bv1 1) (_ bv0 1))))
 (let ((?x264050 (ite (= (bvand %A %K2) (_ bv0 42)) (_ bv1 1) (_ bv0 1))))
 (let ((?x201233 (ite (= (bvand %A %K1) (_ bv0 42)) (_ bv1 1) (_ bv0 1))))
 ...
 (and $x266804 $x262827 $x244068 $x207635 (and (distinct (bvor ?x201233 ?x264050) ?x264301) true))))))))))
(check-sat)
