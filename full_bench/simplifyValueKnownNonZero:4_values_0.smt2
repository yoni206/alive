...
(assert
 (let (($x431988 (and (distinct (bvsdiv %X (bvlshr (bvshl (_ bv1 33) %A) %B)) (bvsdiv %X (bvshl (_ bv1 33) (bvsub %A %B)))) true)))
 ...
 (and $x126102 $x123723 $x127864 $x430378 $x126102 $x123723 $x126099 $x431988))))))))))
(check-sat)
