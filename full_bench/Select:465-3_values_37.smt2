...
(assert
 ...
 (let ((?x4407 (bvand %X C1)))
 (let (($x4930 (and (distinct (ite (= (ite (= ?x4407 (_ bv0 38)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y (bvor %Y C2)) (bvor ((_ extract 10 0) (bvlshr ?x4407 ?x2375)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 38)) true) (= (bvand C1 (bvsub C1 (_ bv1 38))) (_ bv0 38))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x4439 (ite (and (distinct ((_ extract 37 19) C1) (_ bv0 19)) true) ?x3545 ?x5334)) $x4930)))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
