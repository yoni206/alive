...
(assert
 ...
 (and (=> $x7651 (= (bvand %Y (bvshl (_ bv576460752303423487 59) (bvadd ?x11553 (_ bv1 59)))) (_ bv0 59))) (= C2 (bvneg C1)) (and (and (distinct C2 (_ bv0 59)) true) (= (bvand C2 (bvsub C2 (_ bv1 59))) (_ bv0 59))) $x7651 false))))))))))))))))))))))))
(check-sat)
