...
(assert
 ...
 (let ((?x14633 (bvlshr %x ?x18505)))
 (let ((?x2150 (bvshl C %N)))
 (let ((?x12451 ((_ zero_extend 2) ?x2150)))
 (let ((?x10294 (bvudiv %x ?x12451)))
 (let (($x13351 (bvult %N (_ bv11 11))))
 (and $x13351 (and (distinct ?x12451 (_ bv0 13)) true) (= (bvmul ?x10294 ?x12451) %x) (and (and (distinct C (_ bv0 11)) true) (= (bvand C (bvsub C (_ bv1 11))) (_ bv0 11))) (and (distinct ?x10294 ?x14633) true))))))))))))))
(check-sat)
