...
(assert
 ...
 (and (and (and (distinct C (_ bv0 7)) true) (= (bvand C (bvsub C (_ bv1 7))) (_ bv0 7))) $x11542 (bvslt (ite (and (distinct ((_ extract 6 4) C) (_ bv0 3)) true) ?x13840 ?x4659) (_ bv11 32)) (and (distinct mem0 mem0) true))))))
(check-sat)
