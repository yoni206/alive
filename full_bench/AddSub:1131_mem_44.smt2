...
(assert
 ...
 (and (= (bvand |ana_computeKnownZeroBits(%Y)| %Y) (_ bv0 46)) (= u_%LHS (_ bv1 8)) $x2857 (= (bvor C2 |ana_computeKnownZeroBits(%Y)|) (_ bv70368744177663 46)) (and (distinct mem0 mem0) true))))
(check-sat)
