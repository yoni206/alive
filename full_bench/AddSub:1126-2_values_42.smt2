...
(assert
 ...
 (let ((?x25631 (bvsub (bvsub (_ bv47 47) ?x25635) (_ bv1 47))))
 ...
 (let (($x37738 (=> $x7212 (= (bvand %Y (bvshl (_ bv140737488355327 47) (bvadd ?x25635 (_ bv1 47)))) (_ bv0 47)))))
 (and $x37738 $x21514 $x25586 $x7212 (and (distinct ?x25618 (bvashr (bvshl %Y ?x25631) ?x25631)) true)))))))))))))))))))))))))))))))
(check-sat)
