...
(assert
 ...
 (let ((?x16512 (ite (and (distinct ((_ extract 2 2) ?x7829) (_ bv0 1)) true) (_ bv2 11) (ite (and (distinct ((_ extract 1 1) ?x7829) (_ bv0 1)) true) (_ bv1 11) (_ bv0 11)))))
 (let ((?x8004 (ite (and (distinct ((_ extract 5 5) ?x7829) (_ bv0 1)) true) (_ bv5 11) (ite (and (distinct ((_ extract 4 4) ?x7829) (_ bv0 1)) true) (_ bv4 11) (_ bv3 11)))))
 (let ((?x14345 (ite (and (distinct ((_ extract 8 8) ?x7829) (_ bv0 1)) true) (_ bv8 11) (ite (and (distinct ((_ extract 7 7) ?x7829) (_ bv0 1)) true) (_ bv7 11) (_ bv6 11)))))
 (let ((?x16488 (ite (and (distinct ((_ extract 10 9) ?x7829) (_ bv0 2)) true) (ite (and (distinct ((_ extract 10 10) ?x7829) (_ bv0 1)) true) (_ bv10 11) (_ bv9 11)) ?x14345)))
 (let ((?x18173 (ite (and (distinct ((_ extract 10 6) ?x7829) (_ bv0 5)) true) ?x16488 (ite (and (distinct ((_ extract 5 3) ?x7829) (_ bv0 3)) true) ?x8004 ?x16512))))
 ...
 (let ((?x11280 (bvadd (bvxor (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x23011) ?x10722) ?x7829) C2)))
 (let ((?x21685 (ite (= (ite (and (distinct (bvand %Op C) (_ bv0 14)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3)))
 ...
 (and (and (and (distinct C (_ bv0 14)) true) (= (bvand C (bvsub C (_ bv1 14))) (_ bv0 14))) (and (and (distinct ?x7829 (_ bv0 11)) true) (= (bvand ?x7829 (bvsub ?x7829 (_ bv1 11))) (_ bv0 11))) (bvslt ?x14096 (_ bv11 32)) (and (distinct ?x21685 ?x11280) true)))))))))))))))))))))))))
(check-sat)
