...
(assert
 ...
 (and (= (bvand |ana_computeKnownZeroBits(%Y)| %Y) (_ bv0 63)) (= u_%LHS (_ bv1 8)) $x2375 (= (bvor C2 |ana_computeKnownZeroBits(%Y)|) (_ bv9223372036854775807 63)) (and (distinct mem0 mem0) true))))
(check-sat)
