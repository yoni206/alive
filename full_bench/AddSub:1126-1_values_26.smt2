...
(assert
 ...
 (let ((?x32413 (bvsub (bvsub (_ bv31 31) (ite (and (distinct ((_ extract 30 16) C1) (_ bv0 15)) true) ?x17873 ?x31133)) (_ bv1 31))))
 ...
 (and $x21913 $x21902 $x21891 $x8887 (and (distinct ?x20040 (bvashr (bvshl %Y ?x32413) ?x32413)) true)))))))))))))))))))))
(check-sat)
