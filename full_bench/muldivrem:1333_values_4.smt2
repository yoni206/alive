...
(assert
 ...
 (let (($x446435 (=> $x429777 (= (bvand %Op1 (bvshl (_ bv1 5) (bvsub (_ bv5 5) (_ bv1 5)))) (_ bv0 5)))))
 (let (($x432357 (or (and (distinct %Op0 (_ bv16 5)) true) (and (distinct %Op1 (_ bv31 5)) true))))
 (let (($x414258 (and (distinct %Op1 (_ bv0 5)) true)))
 (and $x414258 $x432357 $x446435 $x430462 $x429777 $x365594 (and (distinct (bvsrem %Op0 %Op1) (bvurem %Op0 %Op1)) true)))))))))
(check-sat)
