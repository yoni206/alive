...
(assert
 ...
 (let ((?x25999 (bvsub (bvsub (_ bv48 48) ?x26006) (_ bv1 48))))
 ...
 (let (($x19073 (=> $x7212 (= (bvand %Y (bvshl (_ bv281474976710655 48) (bvadd ?x26006 (_ bv1 48)))) (_ bv0 48)))))
 (and $x19073 $x23584 $x25957 $x7212 (and (distinct ?x25989 (bvashr (bvshl %Y ?x25999) ?x25999)) true)))))))))))))))))))))))))))))))
(check-sat)
