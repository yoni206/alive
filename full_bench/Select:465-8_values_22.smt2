...
(assert
 ...
 (let ((?x6649 (bvand %X C1)))
 (let ((?x4211 (bvor %Y C2)))
 (let (($x4690 (and (distinct (ite (= (ite (and (distinct ?x6649 (_ bv0 23)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) ?x4211 %Y) (bvor ((_ extract 10 0) (bvlshr ?x6649 ?x1724)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 23)) true) (= (bvand C1 (bvsub C1 (_ bv1 23))) (_ bv0 23))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x1985 (ite (and (distinct ((_ extract 22 12) C1) (_ bv0 11)) true) ?x1806 ?x3567)) $x4690))))))))))))))))))))))))))))))))))))
(check-sat)
