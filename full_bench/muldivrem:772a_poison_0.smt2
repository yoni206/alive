...
(assert
 (let ((?x393966 (bvmul ((_ sign_extend 9) %X) ((_ sign_extend 9) (bvsdiv (bvshl (_ bv1 9) C1) C2)))))
 (let (($x381255 (not (= ?x393966 ((_ sign_extend 9) (bvmul %X (bvsdiv (bvshl (_ bv1 9) C1) C2)))))))
 (let ((?x110734 (bvsub (_ bv9 9) (_ bv1 9))))
 (let (($x403260 (and (distinct C1 ?x110734) true)))
 (let (($x409401 (= (bvsrem (bvshl (_ bv1 9) C1) C2) (_ bv0 9))))
 ...
 (and $x134084 $x3477 $x389622 $x405667 $x409401 $x403260 $x381255)))))))))))
(check-sat)
