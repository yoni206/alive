...
(assert
 ...
 (let (($x426280 (=> $x429777 (= (bvand %Op1 (bvshl (_ bv1 8) (bvsub (_ bv8 8) (_ bv1 8)))) (_ bv0 8)))))
 (let (($x353627 (or (and (distinct %Op0 (_ bv128 8)) true) (and (distinct %Op1 (_ bv255 8)) true))))
 (let (($x434387 (and (distinct %Op1 (_ bv0 8)) true)))
 (and $x434387 $x353627 $x426280 $x434506 $x429777 $x365594 (and (distinct (bvsrem %Op0 %Op1) (bvurem %Op0 %Op1)) true)))))))))
(check-sat)
