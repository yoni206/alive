...
(assert
 ...
 (let ((?x28706 (bvsub (_ bv55 55) (bvsub (bvsub (_ bv55 55) ?x28712) (_ bv1 55)))))
 (let (($x28632 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x28706) ?x28706)) true)))
 (let (($x28660 (not (= (bvand C2 (bvshl (_ bv36028797018963967 55) ?x28706)) (_ bv0 55)))))
 (let (($x28669 (and (and (distinct C2 (_ bv0 55)) true) (= (bvand C2 (bvsub C2 (_ bv1 55))) (_ bv0 55)))))
 (let (($x28679 (= C1 (bvneg C2))))
 (and $x28679 $x28669 $x28660 $x28632))))))))))))))))))))))))))))
(check-sat)
