...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 34)) true) (= (bvand C1 (bvsub C1 (_ bv1 34))) (_ bv0 34))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x9159 (ite (and (distinct ((_ extract 33 17) C1) (_ bv0 17)) true) ?x7405 ?x5840)) (not (bvult ?x13289 (_ bv34 34))))))))))))))))))))))))))))))))))))))))
(check-sat)
