...
(assert
 ...
 (and (= (bvand |ana_computeKnownZeroBits(%Y)| %Y) (_ bv0 57)) (= u_%LHS (_ bv1 8)) $x3954 (= (bvor C2 |ana_computeKnownZeroBits(%Y)|) (_ bv144115188075855871 57)) (and (distinct mem0 mem0) true))))
(check-sat)
