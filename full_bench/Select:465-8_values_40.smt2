...
(assert
 ...
 (let ((?x1675 (bvand %X C1)))
 (let ((?x1234 (bvor %Y C2)))
 (let (($x5921 (and (distinct (ite (= (ite (and (distinct ?x1675 (_ bv0 41)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) ?x1234 %Y) (bvor ((_ extract 10 0) (bvlshr ?x1675 ?x4039)) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 41)) true) (= (bvand C1 (bvsub C1 (_ bv1 41))) (_ bv0 41))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x6413 (ite (and (distinct ((_ extract 40 21) C1) (_ bv0 20)) true) ?x4178 ?x3612)) $x5921))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
