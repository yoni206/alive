...
(assert
 ...
 (and (= (bvand |ana_computeKnownZeroBits(%Y)| %Y) (_ bv0 42)) (= u_%LHS (_ bv1 8)) $x8783 (= (bvor C2 |ana_computeKnownZeroBits(%Y)|) (_ bv4398046511103 42)) (and (distinct mem0 mem0) true))))
(check-sat)
