...
(assert
 ...
 (let (($x457703 (=> $x472207 (= (bvand %Op1 (bvshl (_ bv1 32) (bvsub (_ bv32 32) (_ bv1 32)))) (_ bv0 32)))))
 (let (($x457668 (=> $x365594 (= (bvand %Op0 (bvshl (_ bv1 32) (bvsub (_ bv32 32) (_ bv1 32)))) (_ bv0 32)))))
 (let (($x457899 (and (distinct %Op1 (_ bv0 32)) true)))
 (and $x457899 (or (and (distinct %Op0 (_ bv2147483648 32)) true) (and (distinct %Op1 (_ bv4294967295 32)) true)) $x457668 $x457703 $x365594 $x472207 (not $x457899))))))))
(check-sat)
