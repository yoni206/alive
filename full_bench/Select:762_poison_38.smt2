...
(assert
 ...
 (and (and (and (distinct C (_ bv0 42)) true) (= (bvand C (bvsub C (_ bv1 42))) (_ bv0 42))) $x1522 (bvslt (ite (and (distinct ((_ extract 41 21) C) (_ bv0 21)) true) ?x3013 ?x5818) (_ bv11 32)) false)))))))))))))))))))))))
(check-sat)
