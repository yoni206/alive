...
(assert
 ...
 (and (and (and (distinct C (_ bv0 23)) true) (= (bvand C (bvsub C (_ bv1 23))) (_ bv0 23))) $x4641 (bvslt (ite (and (distinct ((_ extract 22 12) C) (_ bv0 11)) true) ?x2593 ?x5396) (_ bv11 32)) false)))))))))))))
(check-sat)
