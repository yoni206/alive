...
(assert
 ...
 (let ((?x11983 (bvand %X C1)))
 (let ((?x8998 (bvor %Y C2)))
 (let (($x19263 (and (distinct (ite (= (ite (and (distinct ?x11983 (_ bv0 42)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y ?x8998) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x11983 ?x25134)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 42)) true) (= (bvand C1 (bvsub C1 (_ bv1 42))) (_ bv0 42))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x12719 (ite (and (distinct ((_ extract 41 21) C1) (_ bv0 21)) true) ?x2676 ?x19292)) $x19263))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
