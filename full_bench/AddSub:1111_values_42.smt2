...
(assert
 ...
 (let (($x8528 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x5240) ?x5240)) true)))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 48)) true) (= (bvand C2 (bvsub C2 (_ bv1 48))) (_ bv0 48))) (not (= (bvand C2 (bvshl (_ bv281474976710655 48) ?x5240)) (_ bv0 48))) $x8528)))))))))))))))))))))))))
(check-sat)
