...
(assert
 ...
 (and (and (and (distinct C (_ bv0 41)) true) (= (bvand C (bvsub C (_ bv1 41))) (_ bv0 41))) $x18890 (bvslt (ite (and (distinct ((_ extract 40 21) C) (_ bv0 20)) true) ?x712 ?x16399) (_ bv11 32)) false))))))))))))))))))))))
(check-sat)
