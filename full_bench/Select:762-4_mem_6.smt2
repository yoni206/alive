...
(assert
 ...
 (and (and (and (distinct C (_ bv0 10)) true) (= (bvand C (bvsub C (_ bv1 10))) (_ bv0 10))) $x17018 (bvslt (ite (and (distinct ((_ extract 9 5) C) (_ bv0 5)) true) ?x2546 ?x869) (_ bv11 32)) (and (distinct mem0 mem0) true))))))))
(check-sat)
