...
(assert
 ...
 (let ((?x1966 (bvand %X C1)))
 (let (($x4312 (and (distinct (ite (= (ite (= ?x1966 (_ bv0 47)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) (bvor %Y C2) %Y) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x1966 ?x5841)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 47)) true) (= (bvand C1 (bvsub C1 (_ bv1 47))) (_ bv0 47))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x5541 ?x4037) $x4312)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
