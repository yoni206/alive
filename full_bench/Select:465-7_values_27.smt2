...
(assert
 ...
 (let ((?x6141 (bvand %X C1)))
 (let (($x6598 (and (distinct (ite (= (ite (= ?x6141 (_ bv0 35)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) (bvor %Y C2) %Y) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x6141 ?x6526)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 35)) true) (= (bvand C1 (bvsub C1 (_ bv1 35))) (_ bv0 35))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x3304 (ite (and (distinct ((_ extract 34 18) C1) (_ bv0 17)) true) ?x3820 ?x6279)) $x6598)))))))))))))))))))))))))))))))))))))))))
(check-sat)
