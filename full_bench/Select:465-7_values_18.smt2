...
(assert
 ...
 (let ((?x19720 (bvand %X C1)))
 (let (($x9946 (and (distinct (ite (= (ite (= ?x19720 (_ bv0 23)) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) (bvor %Y C2) %Y) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x19720 ?x12343)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 23)) true) (= (bvand C1 (bvsub C1 (_ bv1 23))) (_ bv0 23))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x13544 (ite (and (distinct ((_ extract 22 12) C1) (_ bv0 11)) true) ?x6507 ?x5996)) $x9946)))))))))))))))))))))))))))))))))))
(check-sat)
