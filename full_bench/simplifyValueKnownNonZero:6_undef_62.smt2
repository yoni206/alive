...
(assert
 (let (($x417109 (or (and (distinct %X (_ bv2 2)) true) (and (distinct (bvshl %A %B) (_ bv3 2)) true))))
 ...
 (and $x374613 $x427131 $x417109 $x372569 $x374613 $x124585 $x126099 (not (and $x374613 $x427131 $x417109)))))))))))
(check-sat)
