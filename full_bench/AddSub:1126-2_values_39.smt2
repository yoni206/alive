...
(assert
 ...
 (let ((?x24539 (bvsub (bvsub (_ bv44 44) ?x24543) (_ bv1 44))))
 ...
 (let (($x29638 (=> $x7212 (= (bvand %Y (bvshl (_ bv17592186044415 44) (bvadd ?x24543 (_ bv1 44)))) (_ bv0 44)))))
 (and $x29638 $x10538 $x24503 $x7212 (and (distinct ?x24529 (bvashr (bvshl %Y ?x24539) ?x24539)) true)))))))))))))))))))))))))))))))
(check-sat)
