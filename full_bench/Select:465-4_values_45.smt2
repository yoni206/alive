...
(assert
 ...
 (let ((?x3296 (bvand %X C1)))
 (let ((?x3526 (bvor %Y C2)))
 (let (($x6266 (and (distinct (ite (= (ite (and (distinct ?x3296 (_ bv0 53)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) %Y ?x3526) (bvor (bvxor ((_ extract 10 0) (bvlshr ?x3296 ?x3774)) C2) %Y)) true)))
 ...
 (and (and (and (distinct C1 (_ bv0 53)) true) (= (bvand C1 (bvsub C1 (_ bv1 53))) (_ bv0 53))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x4326 ?x1971) $x6266))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
