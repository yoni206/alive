...
(assert
 ...
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 4)) true) (= (bvand C2 (bvsub C2 (_ bv1 4))) (_ bv0 4))) (not (= (bvand C2 (bvshl (_ bv15 4) ?x1497)) (_ bv0 4))) (and (distinct mem0 mem0) true)))))
(check-sat)
