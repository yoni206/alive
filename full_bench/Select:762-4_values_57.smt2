...
(assert
 ...
 (let ((?x7291 (ite (and (distinct ((_ extract 2 2) ?x2185) (_ bv0 1)) true) (_ bv2 11) (ite (and (distinct ((_ extract 1 1) ?x2185) (_ bv0 1)) true) (_ bv1 11) (_ bv0 11)))))
 (let ((?x2422 (ite (and (distinct ((_ extract 5 5) ?x2185) (_ bv0 1)) true) (_ bv5 11) (ite (and (distinct ((_ extract 4 4) ?x2185) (_ bv0 1)) true) (_ bv4 11) (_ bv3 11)))))
 (let ((?x6402 (ite (and (distinct ((_ extract 8 8) ?x2185) (_ bv0 1)) true) (_ bv8 11) (ite (and (distinct ((_ extract 7 7) ?x2185) (_ bv0 1)) true) (_ bv7 11) (_ bv6 11)))))
 (let ((?x2503 (ite (and (distinct ((_ extract 10 9) ?x2185) (_ bv0 2)) true) (ite (and (distinct ((_ extract 10 10) ?x2185) (_ bv0 1)) true) (_ bv10 11) (_ bv9 11)) ?x6402)))
 (let ((?x6112 (ite (and (distinct ((_ extract 10 6) ?x2185) (_ bv0 5)) true) ?x2503 (ite (and (distinct ((_ extract 5 3) ?x2185) (_ bv0 3)) true) ?x2422 ?x7291))))
 ...
 (let ((?x2445 (bvadd (bvxor (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x1126) ?x6370) ?x2185) C2)))
 (let ((?x6771 (ite (= (ite (and (distinct (bvand %Op C) (_ bv0 62)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3)))
 ...
 (and (and (and (distinct C (_ bv0 62)) true) (= (bvand C (bvsub C (_ bv1 62))) (_ bv0 62))) (and (and (distinct ?x2185 (_ bv0 11)) true) (= (bvand ?x2185 (bvsub ?x2185 (_ bv1 11))) (_ bv0 11))) (bvslt ?x1256 (_ bv11 32)) (and (distinct ?x6771 ?x2445) true)))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
