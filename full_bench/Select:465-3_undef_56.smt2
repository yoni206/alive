...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 58)) true) (= (bvand C1 (bvsub C1 (_ bv1 58))) (_ bv0 58))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x24480 ?x23208) (not (bvult ?x3057 (_ bv58 58))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
(check-sat)
