...
(assert
 ...
 (and (= (bvand |ana_computeKnownZeroBits(%Y)| %Y) (_ bv0 39)) (= u_%LHS (_ bv1 8)) $x7249 (= (bvor C2 |ana_computeKnownZeroBits(%Y)|) (_ bv549755813887 39)) (and (distinct mem0 mem0) true))))
(check-sat)
