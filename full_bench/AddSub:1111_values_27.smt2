...
(assert
 ...
 (let (($x5821 (and (distinct (bvadd (bvxor %Y C2) C1) (bvashr (bvshl %Y ?x4201) ?x4201)) true)))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 33)) true) (= (bvand C2 (bvsub C2 (_ bv1 33))) (_ bv0 33))) (not (= (bvand C2 (bvshl (_ bv8589934591 33) ?x4201)) (_ bv0 33))) $x5821))))))))))))))))
(check-sat)
