...
(assert
 ...
 (let (($x3017 (bvult ?x9193 (_ bv64 64))))
 (let (($x5588 (= |ana_MaskedValueIsZero(%Y, (-1 << (log2(C2) + 1)))| (_ bv1 1))))
 (and (=> $x5588 (= (bvand %Y (bvshl (_ bv18446744073709551615 64) (bvadd ?x8596 (_ bv1 64)))) (_ bv0 64))) (= C2 (bvneg C1)) (and (and (distinct C2 (_ bv0 64)) true) (= (bvand C2 (bvsub C2 (_ bv1 64))) (_ bv0 64))) $x5588 (not (and $x3017 $x3017))))))))))))))))))))))))))))
(check-sat)
