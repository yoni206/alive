...
(assert
 ...
 (let ((?x1851 (ite (= (ite (and (distinct (bvand %Op C) (_ bv0 22)) true) (_ bv1 1) (_ bv0 1)) (_ bv1 1)) C2 C3)))
 (let (($x3823 (and (distinct ?x1851 (bvadd (bvlshr (bvshl ((_ extract 10 0) (bvand %Op C)) ?x6353) ?x8022) C3)) true)))
 ...
 (and (and (and (distinct C (_ bv0 22)) true) (= (bvand C (bvsub C (_ bv1 22))) (_ bv0 22))) $x6130 (bvslt (ite (and (distinct ((_ extract 21 11) C) (_ bv0 11)) true) ?x3450 ?x3715) (_ bv11 32)) $x3823))))))))))))))))))))))))))))))))))
(check-sat)
