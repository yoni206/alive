...
(assert
 ...
 (and (= (bvand |ana_computeKnownZeroBits(%Y)| %Y) (_ bv0 40)) (= u_%LHS (_ bv1 8)) $x4907 (= (bvor C2 |ana_computeKnownZeroBits(%Y)|) (_ bv1099511627775 40)) (and (distinct mem0 mem0) true))))
(check-sat)
