...
(assert
 ...
 (and (and (and (distinct C (_ bv0 22)) true) (= (bvand C (bvsub C (_ bv1 22))) (_ bv0 22))) $x1161 (bvslt (ite (and (distinct ((_ extract 21 11) C) (_ bv0 11)) true) ?x3299 ?x2266) (_ bv11 32)) (and (distinct mem0 mem0) true))))))))))))))
(check-sat)
