...
(assert
 ...
 (let (($x436301 (=> $x429777 (= (bvand %Op1 (bvshl (_ bv1 63) (bvsub (_ bv63 63) (_ bv1 63)))) (_ bv0 63)))))
 ...
 (and $x449066 $x439227 $x436301 $x467994 $x429777 $x365594 (and (distinct (bvsrem %Op0 %Op1) (bvurem %Op0 %Op1)) true)))))))))
(check-sat)
