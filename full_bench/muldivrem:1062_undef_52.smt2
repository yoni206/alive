...
(assert
 ...
 (and $x427991 (or (and (distinct %Op0 (_ bv9007199254740992 54)) true) (and (distinct %Op1 (_ bv18014398509481983 54)) true)) $x426924 $x428382 $x365594 $x472207 (not $x427991))))))))
(check-sat)
