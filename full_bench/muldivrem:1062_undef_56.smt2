...
(assert
 ...
 (let (($x462346 (=> $x472207 (= (bvand %Op1 (bvshl (_ bv1 58) (bvsub (_ bv58 58) (_ bv1 58)))) (_ bv0 58)))))
 (let (($x438869 (=> $x365594 (= (bvand %Op0 (bvshl (_ bv1 58) (bvsub (_ bv58 58) (_ bv1 58)))) (_ bv0 58)))))
 (let (($x442162 (and (distinct %Op1 (_ bv0 58)) true)))
 (and $x442162 (or (and (distinct %Op0 (_ bv144115188075855872 58)) true) (and (distinct %Op1 (_ bv288230376151711743 58)) true)) $x438869 $x462346 $x365594 $x472207 (not $x442162))))))))
(check-sat)
