...
(assert
 ...
 (let ((?x28306 (bvsub (bvsub (_ bv54 54) ?x28313) (_ bv1 54))))
 ...
 (let (($x33365 (=> $x7212 (= (bvand %Y (bvshl (_ bv18014398509481983 54) (bvadd ?x28313 (_ bv1 54)))) (_ bv0 54)))))
 (and $x33365 $x34085 $x28270 $x7212 (and (distinct ?x28296 (bvashr (bvshl %Y ?x28306) ?x28306)) true)))))))))))))))))))))))))))))))
(check-sat)
