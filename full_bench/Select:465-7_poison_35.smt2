...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 40)) true) (= (bvand C1 (bvsub C1 (_ bv1 40))) (_ bv0 40))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x11523 (ite (and (distinct ((_ extract 39 20) C1) (_ bv0 20)) true) ?x10681 ?x23536)) false)))))))))))))))))))))))))
(check-sat)
