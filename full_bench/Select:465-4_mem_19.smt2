...
(assert
 ...
 (and (and (and (distinct C1 (_ bv0 27)) true) (= (bvand C1 (bvsub C1 (_ bv1 27))) (_ bv0 27))) (and (and (distinct C2 (_ bv0 11)) true) (= (bvand C2 (bvsub C2 (_ bv1 11))) (_ bv0 11))) (bvslt ?x4858 (ite (and (distinct ((_ extract 26 14) C1) (_ bv0 13)) true) ?x3705 ?x3710)) (and (distinct mem0 mem0) true))))))))))))))))))
(check-sat)
