...
(assert
 ...
 (and (and (and (distinct C (_ bv0 34)) true) (= (bvand C (bvsub C (_ bv1 34))) (_ bv0 34))) $x6447 (bvslt (ite (and (distinct ((_ extract 33 17) C) (_ bv0 17)) true) ?x13143 ?x6961) (_ bv11 32)) (and (distinct mem0 mem0) true))))))))))))))))
(check-sat)
