...
(assert
 ...
 (let (($x442245 (or (and (distinct %Op0 (_ bv70368744177664 47)) true) (and (distinct %Op1 (_ bv140737488355327 47)) true))))
 (let (($x441770 (and (distinct %Op1 (_ bv0 47)) true)))
 (and $x441770 $x442245 $x416773 $x455285 $x429777 $x365594 (and (distinct (bvsrem %Op0 %Op1) (bvurem %Op0 %Op1)) true)))))))))
(check-sat)
