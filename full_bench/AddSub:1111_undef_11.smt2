...
(assert
 ...
 (let (($x3394 (bvult ?x2618 (_ bv17 17))))
 (and (= C1 (bvneg C2)) (and (and (distinct C2 (_ bv0 17)) true) (= (bvand C2 (bvsub C2 (_ bv1 17))) (_ bv0 17))) (not (= (bvand C2 (bvshl (_ bv131071 17) ?x2618)) (_ bv0 17))) (not (and $x3394 $x3394))))))))))))
(check-sat)
