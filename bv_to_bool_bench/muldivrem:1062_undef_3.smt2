...
(assert (let ((_let_0 (= |ana_MaskedValueIsZero(%Op1, (1 << (width(%Op0) - 1)))| (_ bv1 1)))) (let ((_let_1 (= |ana_MaskedValueIsZero(%Op0, (1 << (width(%Op0) - 1)))| (_ bv1 1)))) (let ((_let_2 (bvshl (_ bv1 9) (bvsub (_ bv9 9) (_ bv1 9))))) (let ((_let_3 (= %Op1 (_ bv0 9)))) (and (or (not (= %Op0 (_ bv256 9))) (not (= %Op1 (_ bv511 9)))) (=> _let_1 (= (bvand %Op0 _let_2) (_ bv0 9))) (=> _let_0 (= (bvand %Op1 _let_2) (_ bv0 9))) _let_1 _let_0 _let_3 (not _let_3)))))))
(assert true)
(check-sat)