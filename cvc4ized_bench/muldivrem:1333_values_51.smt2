...
(assert (let ((_let_0 (= |ana_MaskedValueIsZero(%Op0, (1 << (width(%Op0) - 1)))| (_ bv1 1)))) (let ((_let_1 (= |ana_MaskedValueIsZero(%Op1, (1 << (width(%Op1) - 1)))| (_ bv1 1)))) (let ((_let_2 (bvshl (_ bv1 55) (bvsub (_ bv55 55) (_ bv1 55))))) (let ((_let_3 (bvurem (ite (= ((_ extract 54 54) %Op0) (_ bv1 1)) (bvneg %Op0) %Op0) (ite (= ((_ extract 54 54) %Op1) (_ bv1 1)) (bvneg %Op1) %Op1)))) (and (or (not (= %Op0 (_ bv18014398509481984 55))) (not (= %Op1 (_ bv36028797018963967 55)))) (=> _let_1 (= (bvand %Op1 _let_2) (_ bv0 55))) (=> _let_0 (= (bvand %Op0 _let_2) (_ bv0 55))) _let_1 _let_0 (not (= %Op1 (_ bv0 55))) (not (= (ite (= ((_ extract 54 54) %Op0) (_ bv1 1)) (bvneg _let_3) _let_3) (bvurem %Op0 %Op1)))))))))
(assert true)
(check-sat)