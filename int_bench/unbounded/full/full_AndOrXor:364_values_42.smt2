...
(assert (let ((_let_0 (intneg k %B))) (not (= (intand k C2 (intadd k _let_0 (intxor k %A C1))) (intand k C2 (intadd k _let_0 %A))))))
(assert (and (= (intand k C2 (intadd k C2 1)) 0) (= (intand k C2 C1) 0)))
(check-sat)