...
(assert (let ((_let_0 (intslt k %X C2))) (and (not (intslt k C2 C2)) (not (or _let_0 (not _let_0))))))
(assert (let ((_let_0 (intslt k %X C2))) (and (not (intslt k C2 C2)) (not _let_0) _let_0)))
(check-sat)